import { W as _t, r as ce, C as L, K as ot, X as Wo, w as C, B as j, H as q, d as pt } from "./index-AwIeKOgS.js";
/**
 * @license
          ...
          for (const d of o.getAttributeNames())
            if (d.endsWith(sr) || d.startsWith(rt)) {
              ...
              if (b.push(d), v !== void 0) {
                ...
                s.push({ type: 1, index: i, name: g[2], strings: p, ctor: g[1] === "." ? Ko : g[1] === "?" ? Qo : g[1] === "@" ? Jo : ve });
              } else
...
class Qt {
  ...
  T(e) {
    ...
    let n, o = 0;
    for (const i of e)
      o === r.length ? r.push(n = new Qt(this.k(Ft()), this.k(Ft()), this, this.options)) : n = r[o], n._$AI(i), o++;
...
const Yo = kt ? kt.emptyScript : "";
let Qo = class extends ve {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== D ? this.element.setAttribute(this.name, Yo) : this.element.removeAttribute(this.name);
  }
};
class Jo extends ve {
  constructor(e, r, n, o, i) {
...
const Go = (t, e, r) => {
  ...
  if (a === void 0) {
    ...
    i._$litPart$ = a = new Qt(e.insertBefore(Ft(), l), l, void 0, r ?? {});
  }
  return a._$AI(t), a;
};
/**
...
yn.forEach((t) => {
  bn.forEach((e) => {
    ge.push(t + e), Kt.set(yr(t + e), xn[t]);
  });
});
...
function Nn(t, e, r, n = {}, o) {
  ...
  let y = Ct.waapi();
  f && En(t, e);
  const E = ur(e), I = vn(w.values, E), S = Kt.get(E);
  return xo(I.animation, !(cr(d) && I.generator) && n.record !== !1), () => {
    const U = () => {
      var P, Y;
      return (Y = (P = Gt.get(t, E)) !== null && P !== void 0 ? P : S == null ? void 0 : S.initialValue) !== null && Y !== void 0 ? Y : 0;
    };
    let R = Tn(Pn(r), U);
    const z = Rn(R, S);
    if (cr(d)) {
...
K.NUMERIC = new RegExp(To, "g");
K.ALPHANUMERIC = new RegExp(Xn, "g");
const ti = new RegExp("^" + Yt + "$"), ei = new RegExp("^" + To + "$"), ri = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
var gi = No.exports;
(function(t) {
  const e = lt, r = ii, n = li, o = hi, i = pi, a = K, l = Z, s = gi;
  function c(h) {
...
const $e = Z, Se = be, fi = Kn, wi = Yn, vi = Ao, bi = _o, pr = ko, gr = ye, yi = Jn, we = Mo, xi = Po, $i = lt, Ne = So;
function Ci(t, e) {
...
Jt.create = fr.create;
Jt.toCanvas = Ar.bind(null, Bo.render);
Jt.toDataURL = Ar.bind(null, Bo.renderToDataURL);
Jt.toString = Ar.bind(null, function(t, e, r) {
  return Si.render(t, r);
});
var Ni = Object.defineProperty, qr = Object.getOwnPropertySymbols, Li = Object.prototype.hasOwnProperty, Di = Object.prototype.propertyIsEnumerable, Kr = (t, e, r) => e in t ? Ni(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, Be = (t, e) => {
  for (var r in e || (e = {}))
    Li.call(e, r) && Kr(t, r, e[r]);
  if (qr)
    for (var r of qr(e))
      Di.call(e, r) && Kr(t, r, e[r]);
  return t;
};
function Bi() {
  var t;
...
let Nt = class extends A {
  ...
  render() {
    ...
    return u`<button ?disabled="${this.disabled}" class="${J(t)}"><slot></slot></button>`;
  }
};
...
var Vi = Object.defineProperty, qi = Object.getOwnPropertyDescriptor, Ki = (t, e, r, n) => {
...
je.styles = [_.globalCss, Yi], je = Xi([O("wcm-modal-backcard")], je);
...
let ct = class extends A {
  ...
  render() {
    ...
    return u`<header class="${J(t)}">${e ? this.backBtnTemplate() : null} ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
...
var pa = Object.defineProperty, ga = Object.getOwnPropertyDescriptor, Qr = (t, e, r, n) => {
...
const fa = 0.1, Jr = 2.5, Q = 7;
function Fe(t, e, r) {
  return t === e ? !1 : (t - e < 0 ? e - t : t - e) <= r + fa;
}
function wa(t, e) {
  const r = Array.prototype.slice.call(Jt.create(t, { errorCorrectionLevel: e }).modules.data, 0), n = Math.sqrt(r.length);
...
const va = { generate(t, e, r) {
  ...
  s.forEach(({ x: p, y: g }) => {
    const k = (a.length - Q) * l * p, h = (a.length - Q) * l * g, w = 0.45;
  ...
  a.forEach((p, g) => {
    p.forEach((k, h) => {
      if (a[g][h] && !(g < Q && h < Q || g > a.length - (Q + 1) && h < Q || g < Q && h > a.length - (Q + 1)) && !(g > m && g < b && h > m && h < b)) {
  ...
  return d.forEach(([p, g]) => {
    ...
    g.forEach((k) => {
      i.push(N`<circle cx="${p}" cy="${k}" fill="${n}" r="${l / Jr}">`);
    });
    ...
    g.forEach(([k, h]) => {
      i.push(N`<line x1="${p}" x2="${p}" y1="${k}" y2="${h}" stroke="${n}" stroke-width="${l / (Jr / 2)}" stroke-linecap="round">`);
    });
  }), i;
...
let Bt = class extends A {
  ...
  render() {
    ...
    return u`<span><slot class="${J(t)}"></slot></span>`;
  }
};
...
Gr([H()], Ke.prototype, "preload", 2), Ke = Gr([O("wcm-explorer-context")], Ke);
...
Ye.styles = [_.globalCss, za], Ye = Va([O("wcm-android-wallet-selection")], Ye);
...
var Ka = Object.defineProperty, Ya = Object.getOwnPropertyDescriptor, yt = (t, e, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Ya(e, r) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (n ? a(e, r, o) : a(o)) || o);
  return n && o && Ka(e, r, o), o;
};
let et = class extends A {
  ...
  render() {
    ...
    return u`<div class="${J(t)}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${W(this.walletId)}" imageId="${W(this.imageId)}"></wcm-wallet-image></div><wcm-text variant="medium-regular" color="${this.isError ? "error" : "primary"}">${this.isError ? "Connection declined" : this.label}</wcm-text>`;
  }
};
...
Je.styles = [_.globalCss, tl], Je = ol([O("wcm-legal-notice")], Je);
...
let ht = class extends A {
  ...
  render() {
    ...
    return u`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${J(s)}"><div class="wcm-grid">${n ? null : i} ${n ? null : a} ${n ? null : r.map((c) => u`${c ? u`<wcm-wallet-button imageId="${c.image_id}" name="${c.name}" walletId="${c.id}" .onClick="${() => this.onConnect(c)}"></wcm-wallet-button>` : null}`)}</div><div class="wcm-placeholder-block">${l ? u`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!l && this.loading ? u`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
