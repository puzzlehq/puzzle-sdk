...
import React__default, { useEffect, useState, useMemo } from "react";
...
let d$1 = class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-yQ9f56Pa-DgLDLJIm.js");
...
const web3modal_puzzle_props_android$1 = {
  ...
  enableExplorer: true,
  explorerRecommendedWalletIds: [projectId$1]
};
...
async function configureConnection$1(options) {
  ...
  console.log("web3modal_puzzle_props", web3modal_puzzle_props$1);
...
export {
  ...
  EventType as D,
  EventStatus as E,
  aleoAddressRegex as F,
  aleoFieldRegex as G,
  aleoPrivateKeyRegex as H,
  aleoTransactionIdRegex as I,
  aleoU32 as J,
  aleoU64 as K,
  aleoViewKeyRegex as L,
  zodAddress as M,
  Network as N,
  zodEventStatus as O,
  ...
  getBalance as a2,
  connect as a3,
  requestCreateEvent as a4,
  createSharedState as a5,
  decrypt as a6,
  disconnect as a7,
  getEvent as a8,
  getEvents as a9,
  importSharedState as aa,
  getRecords as ab,
  requestSignature as ac,
  wc_aleo_methods as ad,
  wc_aleo_chains as ae,
  wc_events as af,
  projectId as ag,
  web3modal_puzzle_props_android as ah,
  web3modal_puzzle_props_default as ai,
  web3modal_puzzle_props as aj,
  signClient_puzzleProps as ak,
  log_sdk as al,
  checkForDesktopConnection as am,
  hasInjectedConnection as an,
  emitter as ao,
  configureConnection as ap,
  getWalletConnectModalSignClient as aq,
  shortenAddress as b,
  useBalance as c,
  useConnect as d,
