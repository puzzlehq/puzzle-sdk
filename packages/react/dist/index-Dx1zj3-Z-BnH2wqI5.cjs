...
const index = require("./index-B999TH7P.cjs");
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$3 = window, e$5 = t$3.ShadowRoot && (void 0 === t$3.ShadyCSS || t$3.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, s$4 = Symbol(), n$5 = /* @__PURE__ */ new WeakMap();
let o$4 = class o {
...
let u$1 = class u extends HTMLElement {
  ...
  static finalizeStyles(i2) {
    ...
    if (Array.isArray(i2)) {
      ...
      for (const i3 of e2) s3.unshift(c$1(i3));
    } else void 0 !== i2 && s3.push(c$1(i2));
    return s3;
  }
  static _$Ep(t2, i2) {
 ...
 */
var t$2;
const i$2 = window, s$2 = i$2.trustedTypes, e$3 = s$2 ? s$2.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, o$2 = "$lit$", n$3 = `lit$${(Math.random() + "").slice(9)}$`, l$2 = "?" + n$3, h$1 = `<${l$2}>`, r = document, u2 = () => r.createComment(""), d = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, c = Array.isArray, v = (t2) => c(t2) || "function" == typeof (null == t2 ? void 0 : t2[Symbol.iterator]), a = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _$1 = /-->/g, m = />/g, p = RegExp(`>|${a}(?:([^\\s"'>=/]+)(${a}*=${a}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), g = /'/g, $ = /"/g, y = /^(?:script|style|textarea|title)$/i, w = (t2) => (i2, ...s3) => ({ _$litType$: t2, strings: i2, values: s3 }), x = w(1), b$1 = w(2), T = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), E = /* @__PURE__ */ new WeakMap(), C = r.createTreeWalker(r, 129, null, false);
function P$1(t2, i2) {
...
const V = (t2, i2) => {
  ...
  return [P$1(t2, r2 + (t2[s3] || "<?>") + (2 === i2 ? "</svg>" : "")), e2];
};
let N$1 = class N {
        ...
        if (h2.hasAttributes()) {
          ...
          for (const i3 of h2.getAttributeNames()) if (i3.endsWith(o$2) || i3.startsWith(n$3)) {
            ...
            if (t3.push(i3), void 0 !== s3) {
              ...
              v2.push({ type: 1, index: r2, name: i4[2], strings: t4, ctor: "." === i4[1] ? H$1 : "?" === i4[1] ? L$1 : "@" === i4[1] ? z : k });
...
function S$1(t2, i2, s3 = t2, e2) {
  var o3, n2, l2, h2;
  if (i2 === T) return i2;
  let r2 = void 0 !== e2 ? null === (o3 = s3._$Co) || void 0 === o3 ? void 0 : o3[e2] : s3._$Cl;
  const u3 = d(i2) ? void 0 : i2._$litDirective$;
  return (null == r2 ? void 0 : r2.constructor) !== u3 && (null === (n2 = null == r2 ? void 0 : r2._$AO) || void 0 === n2 || n2.call(r2, false), void 0 === u3 ? r2 = void 0 : (r2 = new u3(t2), r2._$AT(t2, s3, e2)), void 0 !== e2 ? (null !== (l2 = (h2 = s3)._$Co) && void 0 !== l2 ? l2 : h2._$Co = [])[e2] = r2 : s3._$Cl = r2), void 0 !== r2 && (i2 = S$1(t2, r2._$AS(t2, i2.values), r2, e2)), i2;
}
class M {
  constructor(t2, i2) {
  ...
  u(t2) {
    var i2;
    const { el: { content: s3 }, parts: e2 } = this._$AD, o3 = (null !== (i2 = null == t2 ? void 0 : t2.creationScope) && void 0 !== i2 ? i2 : r).importNode(s3, true);
    C.currentNode = o3;
...
class R {
  ...
  _$AI(t2, i2 = this) {
    t2 = S$1(this, t2, i2), d(t2) ? t2 === A || null == t2 || "" === t2 ? (this._$AH !== A && this._$AR(), this._$AH = A) : t2 !== this._$AH && t2 !== T && this._(t2) : void 0 !== t2._$litType$ ? this.g(t2) : void 0 !== t2.nodeType ? this.$(t2) : v(t2) ? this.T(t2) : this._(t2);
  }
  k(t2) {
  ...
  _$AC(t2) {
    ...
    return void 0 === i2 && E.set(t2.strings, i2 = new N$1(t2)), i2;
  }
  T(t2) {
...
class k {
  ...
  _$AI(t2, i2 = this, s3, e2) {
    ...
    let n2 = false;
    if (void 0 === o3) t2 = S$1(this, t2, i2, 0), n2 = !d(t2) || t2 !== this._$AH && t2 !== T, n2 && (this._$AH = t2);
    else {
      const e3 = t2;
      let l2, h2;
      for (t2 = o3[0], l2 = 0; l2 < o3.length - 1; l2++) h2 = S$1(this, e3[s3 + l2], i2, l2), h2 === T && (h2 = this._$AH[l2]), n2 || (n2 = !d(h2) || h2 !== this._$AH[l2]), h2 === A ? t2 = A : t2 !== A && (t2 += (null != h2 ? h2 : "") + o3[l2 + 1]), this._$AH[l2] = h2;
    }
    n2 && !e2 && this.j(t2);
  }
  j(t2) {
...
class z extends k {
  ...
  _$AI(t2, i2 = this) {
    var s3;
    if ((t2 = null !== (s3 = S$1(this, t2, i2, 0)) && void 0 !== s3 ? s3 : A) === T) return;
...
null == B$1 || B$1(N$1, R), (null !== (t$2 = i$2.litHtmlVersions) && void 0 !== t$2 ? t$2 : i$2.litHtmlVersions = []).push("2.8.0");
const D$1 = (t2, i2, s3) => {
  var e2, o3;
...
var et = Object.defineProperty, Se = Object.getOwnPropertySymbols, tt = Object.prototype.hasOwnProperty, ot = Object.prototype.propertyIsEnumerable, Be = (e2, o3, r2) => o3 in e2 ? et(e2, o3, { enumerable: true, configurable: true, writable: true, value: r2 }) : e2[o3] = r2, fe = (e2, o3) => {
  for (var r2 in o3 || (o3 = {})) tt.call(o3, r2) && Be(e2, r2, o3[r2]);
  if (Se) for (var r2 of Se(o3)) ot.call(o3, r2) && Be(e2, r2, o3[r2]);
  return e2;
};
function rt() {
  var e2;
  const o3 = (e2 = index.ne$3.state.themeMode) != null ? e2 : "dark", r2 = { light: { foreground: { 1: "rgb(20,20,20)", 2: "rgb(121,134,134)", 3: "rgb(158,169,169)" }, background: { 1: "rgb(255,255,255)", 2: "rgb(241,243,243)", 3: "rgb(228,231,231)" }, overlay: "rgba(0,0,0,0.1)" }, dark: { foreground: { 1: "rgb(228,231,231)", 2: "rgb(148,158,158)", 3: "rgb(110,119,119)" }, background: { 1: "rgb(20,20,20)", 2: "rgb(39,42,42)", 3: "rgb(59,64,64)" }, overlay: "rgba(255,255,255,0.1)" } }[o3];
...
const h = { getPreset(e2) {
  ...
  const e2 = document.querySelector(":root"), { themeVariables: o3 } = index.ne$3.state;
  if (e2) {
    const r2 = fe(fe(fe({}, rt()), Ue()), o3);
...
var lt = Object.defineProperty, it = Object.getOwnPropertyDescriptor, K = (e2, o3, r2, a2) => {
...
_.styles = [h.globalCss, at], K([n$1({ type: Boolean })], _.prototype, "disabled", 2), K([n$1()], _.prototype, "iconLeft", 2), K([n$1()], _.prototype, "iconRight", 2), K([n$1()], _.prototype, "onClick", 2), K([n$1()], _.prototype, "variant", 2), _ = K([e$2("wcm-button")], _);
...
var ct = Object.defineProperty, st = Object.getOwnPropertyDescriptor, xe = (e2, o3, r2, a2) => {
...
re.styles = [h.globalCss, nt], xe([n$1({ type: Boolean })], re.prototype, "disabled", 2), xe([n$1()], re.prototype, "variant", 2), re = xe([e$2("wcm-button-big")], re);
...
Ce.styles = [h.globalCss, bt], Ce = yt([e$2("wcm-modal-content")], Ce);
...
let ke = class extends s$1 {
  render() {
    return x`<footer><slot></slot></footer>`;
  }
};
ke.styles = [h.globalCss, $t], ke = Ot([e$2("wcm-modal-footer")], ke);
const It = i$3`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
var Wt = Object.defineProperty, Et = Object.getOwnPropertyDescriptor, ae = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Et(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
  return a2 && t2 && Wt(o3, r2, t2), t2;
};
let B = class extends s$1 {
  ...
  backBtnTemplate() {
    return x`<button class="wcm-back-btn" @click="${index.T$2.goBack}">${b.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
    return x`<button class="wcm-action-btn" @click="${this.onAction}">${this.actionIcon}</button>`;
  }
  render() {
    const e2 = { "wcm-border": this.border }, o$12 = index.T$2.state.history.length > 1, r2 = this.title ? x`<wcm-text variant="big-bold">${this.title}</wcm-text>` : x`<slot></slot>`;
    return x`<header class="${o2(e2)}">${o$12 ? this.backBtnTemplate() : null} ${r2} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
B.styles = [h.globalCss, It], ae([n$1()], B.prototype, "title", 2), ae([n$1()], B.prototype, "onAction", 2), ae([n$1()], B.prototype, "actionIcon", 2), ae([n$1({ type: Boolean })], B.prototype, "border", 2), B = ae([e$2("wcm-modal-header")], B);
const s2 = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e2, o3) {
  const r2 = e2.renderRoot.querySelector(o3);
  if (!r2) throw new Error(`${o3} not found`);
  return r2;
}, getWalletIcon({ id: e2, image_id: o3 }) {
  const { walletImages: r2 } = index.y$4.state;
  return r2 != null && r2[e2] ? r2[e2] : o3 ? index.te$1.getWalletImageUrl(o3) : "";
}, getWalletName(e2, o3 = false) {
  return o3 && e2.length > 8 ? `${e2.substring(0, 8)}..` : e2;
}, isMobileAnimation() {
  return window.innerWidth <= s2.MOBILE_BREAKPOINT;
}, async preloadImage(e2) {
  const o3 = new Promise((r2, a2) => {
    const t2 = new Image();
    t2.onload = r2, t2.onerror = a2, t2.crossOrigin = "anonymous", t2.src = e2;
  });
  return Promise.race([o3, index.i$1.wait(3e3)]);
}, getErrorMessage(e2) {
  ...
  const { walletConnectUri: o3 } = index.p$2.state, { mobile: r2, name: a2 } = e2, t2 = r2 == null ? void 0 : r2.native, l2 = r2 == null ? void 0 : r2.universal;
  s2.setRecentWallet(e2);
  function i2(c2) {
    let u3 = "";
    t2 ? u3 = index.i$1.formatUniversalUrl(t2, c2, a2) : l2 && (u3 = index.i$1.formatNativeUrl(l2, c2, a2)), index.i$1.openHref(u3, "_self");
  }
  o3 && i2(o3);
}, async handleUriCopy() {
  const { walletConnectUri: e2 } = index.p$2.state;
  if (e2) try {
    await navigator.clipboard.writeText(e2), index.oe$2.openToast("Link copied", "success");
  } catch {
    index.oe$2.openToast("Failed to copy", "error");
  }
}, getCustomImageUrls() {
  const { walletImages: e2 } = index.y$4.state, o3 = Object.values(e2 ?? {});
  return Object.values(o3);
}, truncate(e2, o3 = 8) {
  return e2.length <= o3 ? e2 : `${e2.substring(0, 4)}...${e2.substring(e2.length - 4)}`;
}, setRecentWallet(e2) {
  try {
    localStorage.setItem(s2.WCM_RECENT_WALLET_DATA, JSON.stringify(e2));
  } catch {
    console.info("Unable to set recent wallet");
  }
}, getRecentWallet() {
  try {
    const e2 = localStorage.getItem(s2.WCM_RECENT_WALLET_DATA);
  ...
  index.i$1.openHref(s2.EXPLORER_WALLET_URL, "_blank");
}, getCachedRouterWalletPlatforms() {
  const { desktop: e2, mobile: o3 } = index.i$1.getWalletRouterData(), r2 = Boolean(e2 == null ? void 0 : e2.native), a2 = Boolean(e2 == null ? void 0 : e2.universal), t2 = Boolean(o3 == null ? void 0 : o3.native) || Boolean(o3 == null ? void 0 : o3.universal);
  return { isDesktop: r2, isMobile: t2, isWeb: a2 };
}, goToConnectingView(e2) {
  index.T$2.setData({ Wallet: e2 });
  const o3 = index.i$1.isMobile(), { isDesktop: r2, isWeb: a2, isMobile: t2 } = s2.getCachedRouterWalletPlatforms();
  o3 ? t2 ? index.T$2.push("MobileConnecting") : a2 ? index.T$2.push("WebConnecting") : index.T$2.push("InstallWallet") : r2 ? index.T$2.push("DesktopConnecting") : a2 ? index.T$2.push("WebConnecting") : t2 ? index.T$2.push("MobileQrcodeConnecting") : index.T$2.push("InstallWallet");
} }, Mt = i$3`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
var Pt = Object.defineProperty, Lt = Object.getOwnPropertyDescriptor, Oe = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Lt(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
  return a2 && t2 && Pt(o3, r2, t2), t2;
};
let le = class extends s$1 {
  constructor() {
    super(), this.view = index.T$2.state.view, this.prevView = index.T$2.state.view, this.unsubscribe = void 0, this.oldHeight = "0px", this.resizeObserver = void 0, this.unsubscribe = index.T$2.subscribe((e2) => {
  ...
  get routerEl() {
    return s2.getShadowRootElement(this, ".wcm-router");
  }
  get contentEl() {
    return s2.getShadowRootElement(this, ".wcm-content");
  }
  viewTemplate() {
    switch (this.view) {
      case "ConnectWallet":
  ...
  async onChangeRoute() {
    await animate(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished, this.view = index.T$2.state.view, animate(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 });
  }
  render() {
    return x`<div class="wcm-router"><div class="wcm-content">${this.viewTemplate()}</div></div>`;
  }
};
le.styles = [h.globalCss, Mt], Oe([t$1()], le.prototype, "view", 2), Oe([t$1()], le.prototype, "prevView", 2), le = Oe([e$2("wcm-modal-router")], le);
const Rt = i$3`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
var At = Object.defineProperty, Tt = Object.getOwnPropertyDescriptor, He = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Tt(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
  return a2 && t2 && At(o3, r2, t2), t2;
};
let de = class extends s$1 {
  constructor() {
    super(), this.open = false, this.unsubscribe = void 0, this.timeout = void 0, this.unsubscribe = index.oe$2.subscribe((e2) => {
      e2.open ? (this.open = true, this.timeout = setTimeout(() => index.oe$2.closeToast(), 2200)) : (this.open = false, clearTimeout(this.timeout));
    });
  }
  disconnectedCallback() {
    var e2;
    (e2 = this.unsubscribe) == null || e2.call(this), clearTimeout(this.timeout), index.oe$2.closeToast();
  }
  render() {
    const { message: e2, variant: o$12 } = index.oe$2.state, r2 = { "wcm-success": o$12 === "success", "wcm-error": o$12 === "error" };
    return this.open ? x`<div class="${o2(r2)}">${o$12 === "success" ? b.CHECKMARK_ICON : null} ${o$12 === "error" ? b.CROSS_ICON : null}<wcm-text variant="small-regular">${e2}</wcm-text></div>` : null;
  }
};
de.styles = [h.globalCss, Rt], He([t$1()], de.prototype, "open", 2), de = He([e$2("wcm-modal-toast")], de);
const jt = 0.1, Ve = 2.5, L2 = 7;
function Ie(e2, o3, r2) {
...
const Dt = { generate(e2, o3, r2) {
  const a2 = "#141414", t2 = "#ffffff", l2 = [], i2 = _t(e2, "Q"), c2 = o3 / i2.length, u3 = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  u3.forEach(({ x: $2, y: f2 }) => {
    const O = (i2.length - L2) * c2 * $2, x2 = (i2.length - L2) * c2 * f2, E2 = 0.45;
    for (let M2 = 0; M2 < u3.length; M2 += 1) {
      const Q = c2 * (L2 - M2 * 2);
      l2.push(b$1`<rect fill="${M2 % 2 === 0 ? a2 : t2}" height="${Q}" rx="${Q * E2}" ry="${Q * E2}" width="${Q}" x="${O + c2 * M2}" y="${x2 + c2 * M2}">`);
    }
  });
  const w2 = Math.floor((r2 + 25) / c2), F = i2.length / 2 - w2 / 2, T2 = i2.length / 2 + w2 / 2 - 1, j = [];
  i2.forEach(($2, f2) => {
    $2.forEach((O, x2) => {
      if (i2[f2][x2] && !(f2 < L2 && x2 < L2 || f2 > i2.length - (L2 + 1) && x2 < L2 || f2 < L2 && x2 > i2.length - (L2 + 1)) && !(f2 > F && f2 < T2 && x2 > F && x2 < T2)) {
        const E2 = f2 * c2 + c2 / 2, M2 = x2 * c2 + c2 / 2;
        j.push([E2, M2]);
      }
    });
  });
  const oe2 = {};
  return j.forEach(([$2, f2]) => {
    oe2[$2] ? oe2[$2].push(f2) : oe2[$2] = [f2];
  }), Object.entries(oe2).map(([$2, f2]) => {
    const O = f2.filter((x2) => f2.every((E2) => !Ie(x2, E2, c2)));
    return [Number($2), O];
  }).forEach(([$2, f2]) => {
    f2.forEach((O) => {
      l2.push(b$1`<circle cx="${$2}" cy="${O}" fill="${a2}" r="${c2 / Ve}">`);
    });
  }), Object.entries(oe2).filter(([$2, f2]) => f2.length > 1).map(([$2, f2]) => {
    const O = f2.filter((x2) => f2.some((E2) => Ie(x2, E2, c2)));
    return [Number($2), O];
  }).map(([$2, f2]) => {
    f2.sort((x2, E2) => x2 < E2 ? -1 : 1);
    const O = [];
    for (const x2 of f2) {
      const E2 = O.find((M2) => M2.some((Q) => Ie(x2, Q, c2)));
      E2 ? E2.push(x2) : O.push([x2]);
    }
    return [$2, O.map((x2) => [x2[0], x2[x2.length - 1]])];
  }).forEach(([$2, f2]) => {
    f2.forEach(([O, x2]) => {
      l2.push(b$1`<line x1="${$2}" x2="${$2}" y1="${O}" y2="${x2}" stroke="${a2}" stroke-width="${c2 / (Ve / 2)}" stroke-linecap="round">`);
    });
  }), l2;
...
var Zt = Object.defineProperty, zt = Object.getOwnPropertyDescriptor, Y = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? zt(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
  return a2 && t2 && Zt(o3, r2, t2), t2;
};
exports.WcmQrCode = class D extends s$1 {
  constructor() {
    super(...arguments), this.uri = "", this.size = 0, this.imageId = void 0, this.walletId = void 0, this.imageUrl = void 0;
  }
  svgTemplate() {
    const e2 = index.ne$3.state.themeMode === "light" ? this.size : this.size - 36;
    return b$1`<svg height="${e2}" width="${e2}">${Dt.generate(this.uri, e2, e2 / 4)}</svg>`;
  }
  render() {
    const e2 = { "wcm-dark": index.ne$3.state.themeMode === "dark" };
    return x`<div style="${`width: ${this.size}px`}" class="${o2(e2)}">${this.walletId || this.imageUrl ? x`<wcm-wallet-image walletId="${l(this.walletId)}" imageId="${l(this.imageId)}" imageUrl="${l(this.imageUrl)}"></wcm-wallet-image>` : b.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`;
  }
};
exports.WcmQrCode.styles = [h.globalCss, Nt], Y([n$1()], exports.WcmQrCode.prototype, "uri", 2), Y([n$1({ type: Number })], exports.WcmQrCode.prototype, "size", 2), Y([n$1()], exports.WcmQrCode.prototype, "imageId", 2), Y([n$1()], exports.WcmQrCode.prototype, "walletId", 2), Y([n$1()], exports.WcmQrCode.prototype, "imageUrl", 2), exports.WcmQrCode = Y([e$2("wcm-qrcode")], exports.WcmQrCode);
const St = i$3`:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}`;
var Bt = Object.defineProperty, Ut = Object.getOwnPropertyDescriptor, qe = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Ut(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
  return a2 && t2 && Bt(o3, r2, t2), t2;
};
let me = class extends s$1 {
  constructor() {
    super(...arguments), this.onChange = () => null;
  }
  render() {
    return x`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${b.SEARCH_ICON}`;
  }
};
me.styles = [h.globalCss, St], qe([n$1()], me.prototype, "onChange", 2), me = qe([e$2("wcm-search-input")], me);
const Ht = i$3`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var Ft = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
We.styles = [h.globalCss, Ht], We = Ft([e$2("wcm-spinner")], We);
...
var Kt = Object.defineProperty, Yt = Object.getOwnPropertyDescriptor, Ee = (e2, o3, r2, a2) => {
...
ie.styles = [h.globalCss, Qt], Ee([n$1()], ie.prototype, "variant", 2), Ee([n$1()], ie.prototype, "color", 2), ie = Ee([e$2("wcm-text")], ie);
const Gt = i$3`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
var Xt = Object.defineProperty, Jt = Object.getOwnPropertyDescriptor, N2 = (e2, o3, r2, a2) => {
...
let P = class extends s$1 {
  ...
  handleClick() {
    index.R$1.click({ name: "WALLET_BUTTON", walletId: this.walletId }), this.onClick();
  }
  render() {
    var e2;
    return x`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${l(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${(e2 = this.label) != null ? e2 : s2.getWalletName(this.name, true)}</wcm-text>${this.sublabelTemplate()}</div></button>`;
  }
};
P.styles = [h.globalCss, Gt], N2([n$1()], P.prototype, "onClick", 2), N2([n$1()], P.prototype, "name", 2), N2([n$1()], P.prototype, "walletId", 2), N2([n$1()], P.prototype, "label", 2), N2([n$1()], P.prototype, "imageId", 2), N2([n$1({ type: Boolean })], P.prototype, "installed", 2), N2([n$1({ type: Boolean })], P.prototype, "recent", 2), P = N2([e$2("wcm-wallet-button")], P);
...
var to = Object.defineProperty, oo = Object.getOwnPropertyDescriptor, we = (e2, o3, r2, a2) => {
...
let G = class extends s$1 {
  ...
  render() {
    var e2;
    const o3 = (e2 = this.imageUrl) != null && e2.length ? this.imageUrl : s2.getWalletIcon({ id: this.walletId, image_id: this.imageId });
    return x`${o3.length ? x`<div><img crossorigin="anonymous" src="${o3}" alt="${this.id}"></div>` : b.WALLET_PLACEHOLDER}`;
  }
};
G.styles = [h.globalCss, eo], we([n$1()], G.prototype, "walletId", 2), we([n$1()], G.prototype, "imageId", 2), we([n$1()], G.prototype, "imageUrl", 2), G = we([e$2("wcm-wallet-image")], G);
var ro = Object.defineProperty, ao = Object.getOwnPropertyDescriptor, Fe = (e2, o3, r2, a2) => {
...
let Me = class extends s$1 {
  ...
  async loadImages(e2) {
    try {
      e2 != null && e2.length && await Promise.all(e2.map(async (o3) => s2.preloadImage(o3)));
    } catch {
      console.info("Unsuccessful attempt at preloading some images", e2);
    }
  }
  async preloadListings() {
    if (index.y$4.state.enableExplorer) {
      await index.te$1.getRecomendedWallets(), index.p$2.setIsDataLoaded(true);
      const { recomendedWallets: e2 } = index.te$1.state, o3 = e2.map((r2) => s2.getWalletIcon(r2));
      await this.loadImages(o3);
    } else index.p$2.setIsDataLoaded(true);
  }
  async preloadCustomImages() {
    const e2 = s2.getCustomImageUrls();
  ...
  async preloadData() {
    try {
      ...
      console.error(e2), index.oe$2.openToast("Failed preloading", "error");
    }
  }
};
Fe([t$1()], Me.prototype, "preload", 2), Me = Fe([e$2("wcm-explorer-context")], Me);
var no = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
let Qe = class extends s$1 {
  constructor() {
    super(), this.unsubscribeTheme = void 0, h.setTheme(), this.unsubscribeTheme = index.ne$3.subscribe(h.setTheme);
  }
  disconnectedCallback() {
    var e2;
...
let Pe = class extends s$1 {
  onConnect(e2) {
    index.i$1.isAndroid() ? s2.handleMobileLinking(e2) : s2.goToConnectingView(e2);
  }
  onGoToQrcode() {
    index.T$2.push("Qrcode");
  }
  render() {
    const { recomendedWallets: e2 } = index.te$1.state, o3 = [...e2, ...e2], r2 = index.i$1.RECOMMENDED_WALLET_AMOUNT * 2;
    return x`<wcm-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${b.QRCODE_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-title">${b.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">WalletConnect</wcm-text></div><div class="wcm-slider"><div class="wcm-track">${[...Array(r2)].map((a2, t2) => {
      const l2 = o3[t2 % o3.length];
      return l2 ? x`<wcm-wallet-image walletId="${l2.id}" imageId="${l2.image_id}"></wcm-wallet-image>` : b.WALLET_PLACEHOLDER;
...
Pe.styles = [h.globalCss, co], Pe = wo([e$2("wcm-android-wallet-selection")], Pe);
...
var po = Object.defineProperty, go = Object.getOwnPropertyDescriptor, X = (e2, o3, r2, a2) => {
...
let Z2 = class extends s$1 {
  constructor() {
    super(...arguments), this.walletId = void 0, this.imageId = void 0, this.isError = false, this.isStale = false, this.label = "";
  }
  svgLoaderTemplate() {
    var e2, o3;
    const r2 = (o3 = (e2 = index.ne$3.state.themeVariables) == null ? void 0 : e2["--wcm-wallet-icon-large-border-radius"]) != null ? o3 : h.getPreset("--wcm-wallet-icon-large-border-radius");
    let a2 = 0;
...
Z2.styles = [h.globalCss, ho], X([n$1()], Z2.prototype, "walletId", 2), X([n$1()], Z2.prototype, "imageId", 2), X([n$1({ type: Boolean })], Z2.prototype, "isError", 2), X([n$1({ type: Boolean })], Z2.prototype, "isStale", 2), X([n$1()], Z2.prototype, "label", 2), Z2 = X([e$2("wcm-connector-waiting")], Z2);
const ee = { manualWallets() {
  var e2, o3;
  const { mobileWallets: r2, desktopWallets: a2 } = index.y$4.state, t2 = (e2 = ee.recentWallet()) == null ? void 0 : e2.id, l2 = index.i$1.isMobile() ? r2 : a2, i2 = l2 == null ? void 0 : l2.filter((c2) => t2 !== c2.id);
  return (o3 = index.i$1.isMobile() ? i2 == null ? void 0 : i2.map(({ id: c2, name: u3, links: w2 }) => ({ id: c2, name: u3, mobile: w2, links: w2 })) : i2 == null ? void 0 : i2.map(({ id: c2, name: u3, links: w2 }) => ({ id: c2, name: u3, desktop: w2, links: w2 }))) != null ? o3 : [];
}, recentWallet() {
  return s2.getRecentWallet();
}, recomendedWallets(e2 = false) {
  var o3;
  const r2 = e2 || (o3 = ee.recentWallet()) == null ? void 0 : o3.id, { recomendedWallets: a2 } = index.te$1.state;
  return a2.filter((t2) => r2 !== t2.id);
} }, S = { onConnecting(e2) {
  s2.goToConnectingView(e2);
}, manualWalletsTemplate() {
  return ee.manualWallets().map((e2) => x`<wcm-wallet-button walletId="${e2.id}" name="${e2.name}" .onClick="${() => this.onConnecting(e2)}"></wcm-wallet-button>`);
}, recomendedWalletsTemplate(e2 = false) {
  return ee.recomendedWallets(e2).map((o3) => x`<wcm-wallet-button name="${o3.name}" walletId="${o3.id}" imageId="${o3.image_id}" .onClick="${() => this.onConnecting(o3)}"></wcm-wallet-button>`);
}, recentWalletTemplate() {
  const e2 = ee.recentWallet();
...
let Le = class extends s$1 {
  render() {
    const { explorerExcludedWalletIds: e2, enableExplorer: o3 } = index.y$4.state, r2 = e2 !== "ALL" && o3, a2 = S.manualWalletsTemplate(), t2 = S.recomendedWalletsTemplate();
    let l2 = [S.recentWalletTemplate(), ...a2, ...t2];
    l2 = l2.filter(Boolean);
    const i2 = l2.length > 4 || r2;
    let c2 = [];
    i2 ? c2 = l2.slice(0, 3) : c2 = l2;
    const u3 = Boolean(c2.length);
    return x`<wcm-modal-header .border="${true}" title="Connect your wallet" .onAction="${s2.handleUriCopy}" .actionIcon="${b.COPY_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">${b.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">${b.SCAN_ICON}<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>${u3 ? x`<wcm-modal-footer><div class="wcm-desktop-title">${b.DESKTOP_ICON}<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${c2} ${i2 ? x`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-footer>` : null}`;
  }
};
Le.styles = [h.globalCss, vo], Le = fo([e$2("wcm-desktop-wallet-selection")], Le);
...
let Re = class extends s$1 {
  render() {
    const { termsOfServiceUrl: e2, privacyPolicyUrl: o3 } = index.y$4.state;
...
Re.styles = [h.globalCss, xo], Re = Co([e$2("wcm-legal-notice")], Re);
...
let Ae = class extends s$1 {
  ...
  render() {
    ...
    let c2 = [];
    i2 ? c2 = l2.slice(0, 7) : c2 = l2;
    const u3 = Boolean(c2.length);
    return x`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${b.QRCODE_ICON}"></wcm-modal-header>${u3 ? x`<wcm-modal-content><div>${c2} ${i2 ? x`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
  }
};
Ae.styles = [h.globalCss, ko], Ae = Wo([e$2("wcm-mobile-wallet-selection")], Ae);
...
var Mo = Object.defineProperty, Po = Object.getOwnPropertyDescriptor, Te = (e2, o3, r2, a2) => {
...
exports.WcmModal = class ne extends s$1 {
  constructor() {
    super(), this.open = false, this.active = false, this.unsubscribeModal = void 0, this.abortController = void 0, this.unsubscribeModal = index.se$3.subscribe((e2) => {
  ...
  get overlayEl() {
    return s2.getShadowRootElement(this, ".wcm-overlay");
  }
  get containerEl() {
    return s2.getShadowRootElement(this, ".wcm-container");
  }
  toggleBodyScroll(e2) {
  ...
  onCloseModal(e2) {
    e2.target === e2.currentTarget && index.se$3.close();
  }
  onOpenModalEvent() {
    this.toggleBodyScroll(false), this.addKeyboardEvents(), this.open = true, setTimeout(async () => {
      const e2 = s2.isMobileAnimation() ? { y: ["50vh", "0vh"] } : { scale: [0.98, 1] }, o3 = 0.1, r2 = 0.2;
  ...
  async onCloseModalEvent() {
    ...
    const e2 = s2.isMobileAnimation() ? { y: ["0vh", "50vh"] } : { scale: [1, 0.98] }, o3 = 0.2;
  ...
  addKeyboardEvents() {
    this.abortController = new AbortController(), window.addEventListener("keydown", (e2) => {
      var o3;
      e2.key === "Escape" ? index.se$3.close() : e2.key === "Tab" && ((o3 = e2.target) != null && o3.tagName.includes("wcm-") || this.containerEl.focus());
...
exports.WcmModal.styles = [h.globalCss, Eo], Te([t$1()], exports.WcmModal.prototype, "open", 2), Te([t$1()], exports.WcmModal.prototype, "active", 2), exports.WcmModal = Te([e$2("wcm-modal")], exports.WcmModal);
const Lo = i$3`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var Ro = Object.defineProperty, Ao = Object.getOwnPropertyDescriptor, ce = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? Ao(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
  return a2 && t2 && Ro(o3, r2, t2), t2;
};
let U = class extends s$1 {
  ...
  onMobile() {
    index.i$1.isMobile() ? index.T$2.replace("MobileConnecting") : index.T$2.replace("MobileQrcodeConnecting");
  }
  onDesktop() {
    index.T$2.replace("DesktopConnecting");
  }
  onWeb() {
    index.T$2.replace("WebConnecting");
  }
  render() {
    return x`<div>${this.isRetry ? x`<slot></slot>` : null} ${this.isMobile ? x`<wcm-button .onClick="${this.onMobile}" .iconLeft="${b.MOBILE_ICON}" variant="outline">Mobile</wcm-button>` : null} ${this.isDesktop ? x`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${b.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>` : null} ${this.isWeb ? x`<wcm-button .onClick="${this.onWeb}" .iconLeft="${b.GLOBE_ICON}" variant="outline">Web</wcm-button>` : null}</div>`;
  }
};
U.styles = [h.globalCss, Lo], ce([n$1({ type: Boolean })], U.prototype, "isMobile", 2), ce([n$1({ type: Boolean })], U.prototype, "isDesktop", 2), ce([n$1({ type: Boolean })], U.prototype, "isWeb", 2), ce([n$1({ type: Boolean })], U.prototype, "isRetry", 2), U = ce([e$2("wcm-platform-selection")], U);
...
let je = class extends s$1 {
  onClick() {
    index.T$2.push("WalletExplorer");
  }
  render() {
    const { recomendedWallets: e2 } = index.te$1.state, o3 = ee.manualWallets(), r2 = [...e2, ...o3].reverse().slice(0, 4);
    return x`<button @click="${this.onClick}"><div class="wcm-icons">${r2.map((a2) => {
      const t2 = s2.getWalletIcon(a2);
      if (t2) return x`<img crossorigin="anonymous" src="${t2}">`;
      const l2 = s2.getWalletIcon({ id: a2.id });
      return l2 ? x`<img crossorigin="anonymous" src="${l2}">` : b.WALLET_PLACEHOLDER;
    })} ${[...Array(4 - r2.length)].map(() => b.WALLET_PLACEHOLDER)}</div><wcm-text variant="xsmall-regular">View All</wcm-text></button>`;
  }
};
je.styles = [h.globalCss, To], je = Do([e$2("wcm-view-all-wallets-button")], je);
const No = i$3`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var Zo = Object.defineProperty, zo = Object.getOwnPropertyDescriptor, he = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? zo(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
...
let J = class extends s$1 {
  ...
  get overlayEl() {
    return s2.getShadowRootElement(this, ".wcm-qr-container");
  }
  render() {
...
J.styles = [h.globalCss, No], he([n$1()], J.prototype, "walletId", 2), he([n$1()], J.prototype, "imageId", 2), he([t$1()], J.prototype, "uri", 2), J = he([e$2("wcm-walletconnect-qr")], J);
var Uo = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
let _e = class extends s$1 {
  viewTemplate() {
    return index.i$1.isAndroid() ? x`<wcm-android-wallet-selection></wcm-android-wallet-selection>` : index.i$1.isMobile() ? x`<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>` : x`<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>`;
  }
  render() {
    return x`${this.viewTemplate()}<wcm-legal-notice></wcm-legal-notice>`;
  }
};
_e.styles = [h.globalCss], _e = Uo([e$2("wcm-connect-wallet-view")], _e);
const Ho = i$3`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Vo = Object.defineProperty, qo = Object.getOwnPropertyDescriptor, Ke = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? qo(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
...
let pe = class extends s$1 {
  ...
  onFormatAndRedirect(e2) {
    var o3;
    const { desktop: r2, name: a2 } = index.i$1.getWalletRouterData(), t2 = r2 == null ? void 0 : r2.native;
    if (t2) {
      const l2 = index.i$1.formatNativeUrl(t2, e2, a2);
      if (a2 === "Puzzle Wallet" && (o3 = window == null ? void 0 : window.aleo) != null && o3.connectPuzzle) {
        const i2 = new URL(l2).searchParams, c2 = i2.get("uri"), u3 = i2.get("requestId"), w2 = i2.get("sessionTopic");
        window.aleo.connectPuzzle({ wc: { uri: c2, requestId: u3 ?? void 0, sessionTopic: w2 ?? void 0 } });
      } else index.i$1.openHref(l2, "_self");
    }
  }
  openDesktopApp() {
    const { walletConnectUri: e2 } = index.p$2.state, o3 = index.i$1.getWalletRouterData();
    s2.setRecentWallet(o3), e2 && this.onFormatAndRedirect(e2);
  }
  render() {
    const { name: e2, id: o3, image_id: r2 } = index.i$1.getWalletRouterData(), { isMobile: a2, isWeb: t2 } = s2.getCachedRouterWalletPlatforms();
    return x`<wcm-modal-header title="${e2}" .onAction="${s2.handleUriCopy}" .actionIcon="${b.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${o3}" imageId="${l(r2)}" label="${`Continue in ${e2}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${e2} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${a2}" .isWeb="${t2}" .isRetry="${true}"><wcm-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${b.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
pe.styles = [h.globalCss, Ho], Ke([t$1()], pe.prototype, "isError", 2), pe = Ke([e$2("wcm-desktop-connecting-view")], pe);
const Fo = i$3`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var Yo = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
...
let ge = class extends s$1 {
  ...
  onFormatAndRedirect(e2, o3 = false) {
    var r2, a2;
    const { mobile: t2, name: l2 } = index.i$1.getWalletRouterData(), i2 = t2 == null ? void 0 : t2.native, c2 = t2 == null ? void 0 : t2.universal;
    if (i2 && !o3) {
      const u3 = index.i$1.formatNativeUrl(i2, e2, l2);
      if (l2 === "Puzzle Wallet" && (r2 = window == null ? void 0 : window.aleo) != null && r2.connectPuzzle) {
        const w2 = new URL(u3).searchParams, F = w2.get("uri"), T2 = w2.get("requestId"), j = w2.get("sessionTopic");
        window.aleo.connectPuzzle({ wc: { uri: F, requestId: T2 ?? void 0, sessionTopic: j ?? void 0 } });
      } else index.i$1.openHref(u3, "_self");
    } else if (c2) {
      const u3 = index.i$1.formatUniversalUrl(c2, e2, l2);
      if (l2 === "Puzzle Wallet" && (a2 = window == null ? void 0 : window.aleo) != null && a2.connectPuzzle) {
        const w2 = new URL(u3).searchParams, F = w2.get("uri"), T2 = w2.get("requestId"), j = w2.get("sessionTopic");
        window.aleo.connectPuzzle({ wc: { uri: F, requestId: T2 ?? void 0, sessionTopic: j ?? void 0 } });
      } else index.i$1.openHref(u3, "_self");
    }
  ...
  openMobileApp(e2 = false) {
    const { walletConnectUri: o3 } = index.p$2.state, r2 = index.i$1.getWalletRouterData();
    s2.setRecentWallet(r2), o3 && this.onFormatAndRedirect(o3, e2);
  }
  onGoToAppStore(e2) {
    e2 && index.i$1.openHref(e2, "_blank");
  }
  render() {
    const { name: e2, id: o3, image_id: r2, app: a2, mobile: t2 } = index.i$1.getWalletRouterData(), { isWeb: l$12 } = s2.getCachedRouterWalletPlatforms(), i2 = a2 == null ? void 0 : a2.ios, c2 = t2 == null ? void 0 : t2.universal;
    return x`<wcm-modal-header title="${e2}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${o3}" imageId="${l(r2)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${l$12}" .isRetry="${true}"><wcm-button .onClick="${() => this.openMobileApp(false)}" .iconRight="${b.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${c2 ? x`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(true)}">Try this alternate link</span></wcm-text>` : null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${o3}" imageId="${l(r2)}"></wcm-wallet-image><wcm-text>${`Get ${e2}`}</wcm-text></div><wcm-button .iconRight="${b.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(i2)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
  }
};
ge.styles = [h.globalCss, Go], Ye([t$1()], ge.prototype, "isError", 2), ge = Ye([e$2("wcm-mobile-connecting-view")], ge);
...
let Ne = class extends s$1 {
  render() {
    const { name: e2, id: o3, image_id: r2 } = index.i$1.getWalletRouterData(), { isDesktop: a2, isWeb: t2 } = s2.getCachedRouterWalletPlatforms();
    return x`<wcm-modal-header title="${e2}" .onAction="${s2.handleUriCopy}" .actionIcon="${b.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${o3}" imageId="${l(r2)}"></wcm-walletconnect-qr></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${e2} app`}</wcm-text><wcm-platform-selection .isDesktop="${a2}" .isWeb="${t2}"></wcm-platform-selection></wcm-info-footer>`;
  }
};
Ne.styles = [h.globalCss, er], Ne = rr([e$2("wcm-mobile-qr-connecting-view")], Ne);
var ir = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = i2(t2) || t2);
  return t2;
};
let Ze = class extends s$1 {
  render() {
    return x`<wcm-modal-header title="Scan the code" .onAction="${s2.handleUriCopy}" .actionIcon="${b.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
  }
};
Ze.styles = [h.globalCss], Ze = ir([e$2("wcm-qrcode-view")], Ze);
...
var cr = Object.defineProperty, sr = Object.getOwnPropertyDescriptor, se = (e2, o3, r2, a2) => {
...
let H2 = class extends s$1 {
  constructor() {
    super(...arguments), this.loading = !index.te$1.state.wallets.listings.length, this.firstFetch = !index.te$1.state.wallets.listings.length, this.search = "", this.endReached = false, this.intersectionObserver = void 0, this.searchDebounce = s2.debounce((e2) => {
      e2.length >= 1 ? (this.firstFetch = true, this.endReached = false, this.search = e2, index.te$1.resetSearch(), this.fetchWallets()) : this.search && (this.search = "", this.endReached = this.isLastPage(), index.te$1.resetSearch());
    });
  }
  firstUpdated() {
  ...
  get placeholderEl() {
    return s2.getShadowRootElement(this, ".wcm-placeholder-block");
  }
  ...
  isLastPage() {
    const { wallets: e2, search: o3 } = index.te$1.state, { listings: r2, total: a2 } = this.search ? o3 : e2;
    return a2 <= ze || r2.length >= a2;
  }
  async fetchWallets() {
    var e2;
    const { wallets: o3, search: r2 } = index.te$1.state, { listings: a2, total: t2, page: l2 } = this.search ? r2 : o3;
    if (!this.endReached && (this.firstFetch || t2 > ze && a2.length < t2)) try {
      this.loading = true;
      const i2 = (e2 = index.p$2.state.chains) == null ? void 0 : e2.join(","), { listings: c2 } = await index.te$1.getWallets({ page: this.firstFetch ? 1 : l2 + 1, entries: ze, search: this.search, version: 2, chains: i2 }), u3 = c2.map((w2) => s2.getWalletIcon(w2));
      await Promise.all([...u3.map(async (w2) => s2.preloadImage(w2)), index.i$1.wait(300)]), this.endReached = this.isLastPage();
    } catch (i2) {
      console.error(i2), index.oe$2.openToast(s2.getErrorMessage(i2), "error");
    } finally {
  ...
  render() {
    const { wallets: e2, search: o$12 } = index.te$1.state, { listings: r2 } = this.search ? o$12 : e2, a2 = this.loading && !r2.length, t2 = this.search.length >= 3;
    let l2 = S.manualWalletsTemplate(), i2 = S.recomendedWalletsTemplate(true);
    t2 && (l2 = l2.filter(({ values: w2 }) => s2.caseSafeIncludes(w2[0], this.search)), i2 = i2.filter(({ values: w2 }) => s2.caseSafeIncludes(w2[0], this.search)));
    const c2 = !this.loading && !r2.length && !i2.length, u3 = { "wcm-loading": a2, "wcm-end-reached": this.endReached || !this.loading, "wcm-empty": c2 };
    return x`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${o2(u3)}"><div class="wcm-grid">${a2 ? null : l2} ${a2 ? null : i2} ${a2 ? null : r2.map((w2) => x`${w2 ? x`<wcm-wallet-button imageId="${w2.image_id}" name="${w2.name}" walletId="${w2.id}" .onClick="${() => this.onConnect(w2)}"></wcm-wallet-button>` : null}`)}</div><div class="wcm-placeholder-block">${c2 ? x`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!c2 && this.loading ? x`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
H2.styles = [h.globalCss, nr], se([t$1()], H2.prototype, "loading", 2), se([t$1()], H2.prototype, "firstFetch", 2), se([t$1()], H2.prototype, "search", 2), se([t$1()], H2.prototype, "endReached", 2), H2 = se([e$2("wcm-wallet-explorer-view")], H2);
...
var mr = Object.defineProperty, wr = Object.getOwnPropertyDescriptor, Ge = (e2, o3, r2, a2) => {
  for (var t2 = a2 > 1 ? void 0 : a2 ? wr(o3, r2) : o3, l2 = e2.length - 1, i2; l2 >= 0; l2--) (i2 = e2[l2]) && (t2 = (a2 ? i2(o3, r2, t2) : i2(t2)) || t2);
...
let ve = class extends s$1 {
  ...
  onFormatAndRedirect(e2) {
    var o3;
    const { desktop: r2, name: a2 } = index.i$1.getWalletRouterData(), t2 = r2 == null ? void 0 : r2.universal;
    if (t2) {
      const l2 = index.i$1.formatUniversalUrl(t2, e2, a2);
      if (a2 === "Puzzle Wallet" && (o3 = window == null ? void 0 : window.aleo) != null && o3.connectPuzzle) {
        const i2 = new URL(l2).searchParams, c2 = i2.get("uri"), u3 = i2.get("requestId"), w2 = i2.get("sessionTopic");
        window.aleo.connectPuzzle({ wc: { uri: c2, requestId: u3 ?? void 0, sessionTopic: w2 ?? void 0 } });
      } else index.i$1.openHref(l2, "_blank");
    }
  }
  openWebWallet() {
    const { walletConnectUri: e2 } = index.p$2.state, o3 = index.i$1.getWalletRouterData();
  ...
  render() {
    const { name: e2, id: o3, image_id: r2 } = index.i$1.getWalletRouterData(), { isMobile: a2, isDesktop: t2 } = s2.getCachedRouterWalletPlatforms(), l$12 = index.i$1.isMobile();
    return x`<wcm-modal-header title="${e2}" .onAction="${s2.handleUriCopy}" .actionIcon="${b.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${o3}" imageId="${l(r2)}" label="${`Continue in ${e2}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`${e2} web app has opened in a new tab. Go there, accept the connection, and come back`}</wcm-text><wcm-platform-selection .isMobile="${a2}" .isDesktop="${l$12 ? false : t2}" .isRetry="${true}"><wcm-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${b.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
