...
let d$1 = class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-D2EZNQoQ-DooOYVYO.js");
...
export {
  ...
  log_sdk as an,
  checkForDesktopConnection as ao,
  hasInjectedConnection as ap,
  emitter as aq,
  connection as ar,
  configureConnection as as,
  getWalletConnectModalSignClient as at,
  shortenAddress as b,
  useBalance as c,
  useConnect as d,
