import { n as ne$1, s as se$1, T as T$1$1, o as oe$1, R as R$4, a as a$3, t as te$2, p as p$3, y as y$3 } from "./index-Dkp_Mrzw.js";
/**
 * @license
...
const c = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e2, o3) {
  ...
  e2 && (a$3.setWalletConnectAndroidDeepLink(e2), a$3.openHref(e2, "_self"));
}, async handleUriCopy() {
  const { walletConnectUri: e2 } = p$3.state;
  if (e2)
    try {
  ...
  const o3 = a$3.isMobile(), { isDesktop: r2, isWeb: a2, isMobile: t2 } = c.getCachedRouterWalletPlatforms();
...
let oe = class extends s {
  ...
  async onChangeRoute() {
    await animate(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished, this.view = T$1$1.state.view, animate(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 });
  }
  render() {
...
const G = { manualWallets() {
  ...
  return (o3 = a$3.isMobile() ? i2 == null ? void 0 : i2.map(({ id: s2, name: $2, links: f2 }) => ({ id: s2, name: $2, mobile: f2, links: f2 })) : i2 == null ? void 0 : i2.map(({ id: s2, name: $2, links: f2 }) => ({ id: s2, name: $2, desktop: f2, links: f2 }))) != null ? o3 : [];
}, recentWallet() {
...
let Te = class extends s {
  ...
  render() {
    const { name: e2, id: o3, image_id: r2, homepage: a2 } = a$3.getWalletRouterData();
...
let he = class extends s {
  ...
  render() {
    const { name: e2, id: o3, image_id: r2, app: a2, mobile: t2 } = a$3.getWalletRouterData(), { isWeb: l$12 } = c.getCachedRouterWalletPlatforms(), i2 = a2 == null ? void 0 : a2.ios, s2 = t2 == null ? void 0 : t2.universal;
...
let U = class extends s {
  ...
  async fetchWallets() {
    ...
    if (!this.endReached && (this.firstFetch || t2 > De && a2.length < t2))
      try {
        this.loading = true;
        const i2 = (e2 = p$3.state.chains) == null ? void 0 : e2.join(","), { listings: s2 } = await te$2.getWallets({ page: this.firstFetch ? 1 : l2 + 1, entries: De, search: this.search, version: 2, chains: i2 }), $2 = s2.map((f2) => c.getWalletIcon(f2));
        await Promise.all([...$2.map(async (f2) => c.preloadImage(f2)), a$3.wait(300)]), this.endReached = this.isLastPage();
      } catch (i2) {
