import { n as ne$1, s as se$1, T as T$2, o as oe$1, R as R$1, a as a$2, t as te$1, p as p$1, y as y$1 } from "./index-Dcemry6k.js";
/**
 * @license
...
let oe = class extends s {
  ...
  async onChangeRoute() {
    ...
    ).finished, this.view = T$2.state.view, animate(
      this.routerEl,
...
let Ie = class extends s {
  onConnect(e2) {
    a$2.isAndroid() && window.aleo === void 0 && window.aleo.puzzleWalletClient === void 0 ? c.handleMobileLinking(e2) : c.goToConnectingView(e2);
  }
  onGoToQrcode() {
    T$2.push("Qrcode");
  }
...
const G = {
  manualWallets() {
    ...
    return (o3 = a$2.isMobile() ? i2 == null ? void 0 : i2.map(({ id: s2, name: $2, links: f2 }) => ({
      id: s2,
      name: $2,
      mobile: f2,
      links: f2
...
let he = class extends s {
  ...
  render() {
    const {
      ...
      app: a2,
      mobile: t2
    } = a$2.getWalletRouterData(), { isWeb: l$12 } = c.getCachedRouterWalletPlatforms(), i2 = a2 == null ? void 0 : a2.ios, s2 = t2 == null ? void 0 : t2.universal;
...
let U = class extends s {
  ...
  async fetchWallets() {
    ...
    if (!this.endReached && (this.firstFetch || t2 > De && a2.length < t2))
      try {
        this.loading = true;
        const i2 = (e2 = p$1.state.chains) == null ? void 0 : e2.join(","), { listings: s2 } = await te$1.getWallets({
