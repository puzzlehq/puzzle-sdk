(function(global2, factory) {
  ...
  const o$6 = proxy({ history: ["ConnectWallet"], view: "ConnectWallet", data: void 0 }), T$3 = { state: o$6, subscribe(e2) {
    ...
    o$6.data = e2;
  } }, a$5 = { WALLETCONNECT_DEEPLINK_CHOICE: "WALLETCONNECT_DEEPLINK_CHOICE", WCM_VERSION: "WCM_VERSION", RECOMMENDED_WALLET_AMOUNT: 9, isMobile() {
    ...
    try {
      localStorage.setItem(a$5.WALLETCONNECT_DEEPLINK_CHOICE, JSON.stringify({ href: e2, name: t2 }));
    } catch {
    ...
    try {
      const [t2] = e2.split("?");
      localStorage.setItem(a$5.WALLETCONNECT_DEEPLINK_CHOICE, JSON.stringify({ href: t2, name: "Android" }));
    } catch {
    ...
    return t2;
  } }, _$5 = typeof location < "u" && (location.hostname.includes("localhost") || location.protocol.includes("https")), r$4 = proxy({ enabled: _$5, userSessionId: "", events: [], connectedWalletId: void 0 }), R$5 = { state: r$4, subscribe(e2) {
    ...
    if (r$4.enabled) {
      const t2 = { type: "CLICK", name: e2.name, userSessionId: r$4.userSessionId, timestamp: Date.now(), data: e2 };
      r$4.events.push(t2);
    }
  }, track(e2) {
    if (r$4.enabled) {
      const t2 = { type: "TRACK", name: e2.name, userSessionId: r$4.userSessionId, timestamp: Date.now(), data: e2 };
      r$4.events.push(t2);
    }
  }, view(e2) {
    if (r$4.enabled) {
      const t2 = { type: "VIEW", name: e2.name, userSessionId: r$4.userSessionId, timestamp: Date.now(), data: e2 };
      r$4.events.push(t2);
    }
  } }, c$4 = proxy({ chains: void 0, walletConnectUri: void 0, isAuth: false, isCustomDesktop: false, isCustomMobile: false, isDataLoaded: false, isUiLoaded: false }), p$4 = { state: c$4, subscribe(e2) {
    ...
    c$4.isAuth = e2;
  } }, W$2 = proxy({ projectId: "", mobileWallets: void 0, desktopWallets: void 0, walletImages: void 0, chains: void 0, enableAuthMode: false, enableExplorer: true, explorerExcludedWalletIds: void 0, explorerRecommendedWalletIds: void 0, termsOfServiceUrl: void 0, privacyPolicyUrl: void 0 }), y$4 = { state: W$2, subscribe(e2) {
    return subscribe(W$2, () => e2(W$2));
  }, setConfig(e2) {
    var t2, s2;
    R$5.initialize(), p$4.setChains(e2.chains), p$4.setIsAuth(Boolean(e2.enableAuthMode)), p$4.setIsCustomMobile(Boolean((t2 = e2.mobileWallets) == null ? void 0 : t2.length)), p$4.setIsCustomDesktop(Boolean((s2 = e2.desktopWallets) == null ? void 0 : s2.length)), a$5.setModalVersionInStorage(), Object.assign(W$2, e2);
  } };
  ...
  const m$3 = { async getDesktopListings(e2) {
  ...
  const N$4 = a$5.isMobile(), d$4 = proxy({ wallets: { listings: [], total: 0, page: 1 }, search: { listings: [], total: 0, page: 1 }, recomendedWallets: [] }), te$3 = { state: d$4, async getRecomendedWallets() {
    ...
    if (a$5.isArray(e2)) {
      ...
      const { chains: s2, isAuth: n2 } = p$4.state, i2 = s2 == null ? void 0 : s2.join(","), l2 = a$5.isArray(t2), v2 = { page: 1, sdks: n2 ? "auth_v1" : void 0, entries: a$5.RECOMMENDED_WALLET_AMOUNT, chains: i2, version: 2, excludedIds: l2 ? t2.join(",") : void 0 }, { listings: b2 } = N$4 ? await m$3.getMobileListings(v2) : await m$3.getDesktopListings(v2);
  ...
  } }, I$2 = proxy({ open: false }), se$1 = { state: I$2, subscribe(e2) {
  ...
  const C$1 = proxy({ themeMode: Z$4() ? "dark" : "light" }), ne$1 = { state: C$1, subscribe(e2) {
    return subscribe(C$1, () => e2(C$1));
  }, setThemeConfig(e2) {
    const { themeMode: t2, themeVariables: s2 } = e2;
    t2 && (C$1.themeMode = t2), s2 && (C$1.themeVariables = Y$1({}, s2));
  } }, g$6 = proxy({ open: false, message: "", variant: "success" }), oe$2 = { state: g$6, subscribe(e2) {
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), g = /'/g, $ = /"/g, y = /^(?:script|style|textarea|title)$/i, w = (t2) => (i2, ...s2) => ({ _$litType$: t2, strings: i2, values: s2 }), x = w(1), b = w(2), T$1 = Symbol.for("lit-noChange"), A$1 = Symbol.for("lit-nothing"), E = /* @__PURE__ */ new WeakMap(), C = r.createTreeWalker(r, 129, null, false);
  ...
  function rt() {
    var e2;
    const o2 = (e2 = ne$1.state.themeMode) != null ? e2 : "dark", r2 = { light: { foreground: { 1: "rgb(20,20,20)", 2: "rgb(121,134,134)", 3: "rgb(158,169,169)" }, background: { 1: "rgb(255,255,255)", 2: "rgb(241,243,243)", 3: "rgb(228,231,231)" }, overlay: "rgba(0,0,0,0.1)" }, dark: { foreground: { 1: "rgb(228,231,231)", 2: "rgb(148,158,158)", 3: "rgb(110,119,119)" }, background: { 1: "rgb(20,20,20)", 2: "rgb(39,42,42)", 3: "rgb(59,64,64)" }, overlay: "rgba(255,255,255,0.1)" } }[o2];
  ...
  const c = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e2, o2) {
    ...
    e2 && (a$5.setWalletConnectAndroidDeepLink(e2), a$5.openHref(e2, "_self"));
  }, async handleUriCopy() {
    const { walletConnectUri: e2 } = p$4.state;
    if (e2)
      try {
    ...
    const o2 = a$5.isMobile(), { isDesktop: r2, isWeb: a2, isMobile: t2 } = c.getCachedRouterWalletPlatforms();
  ...
  let oe = class extends s {
    ...
    async onChangeRoute() {
      await animate(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished, this.view = T$3.state.view, animate(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 });
    }
    render() {
  ...
  function _t(e2, o2) {
    const r2 = Array.prototype.slice.call(browser.create(e2, { errorCorrectionLevel: o2 }).modules.data, 0), a2 = Math.sqrt(r2.length);
    return r2.reduce((t2, l2, i2) => (i2 % a2 === 0 ? t2.push([l2]) : t2[t2.length - 1].push(l2)) && t2, []);
  }
  const Dt = { generate(e2, o2, r2) {
    const a2 = "#141414", t2 = "#ffffff", l2 = [], i2 = _t(e2, "Q"), s2 = o2 / i2.length, $2 = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
    $2.forEach(({ x: y2, y: u2 }) => {
      const O2 = (i2.length - A) * s2 * y2, b$12 = (i2.length - A) * s2 * u2, E2 = 0.45;
      for (let M2 = 0; M2 < $2.length; M2 += 1) {
        const V2 = s2 * (A - M2 * 2);
        l2.push(b`<rect fill="${M2 % 2 === 0 ? a2 : t2}" height="${V2}" rx="${V2 * E2}" ry="${V2 * E2}" width="${V2}" x="${O2 + s2 * M2}" y="${b$12 + s2 * M2}">`);
      }
    });
    ...
    return Se.forEach(([y2, u2]) => {
      ...
      u2.forEach((O2) => {
        l2.push(b`<circle cx="${y2}" cy="${O2}" fill="${a2}" r="${s2 / Ve}">`);
      });
      ...
      u2.forEach(([O2, b$12]) => {
        l2.push(b`<line x1="${y2}" x2="${y2}" y1="${O2}" y2="${b$12}" stroke="${a2}" stroke-width="${s2 / (Ve / 2)}" stroke-linecap="round">`);
      });
    }), l2;
  ...
  const G = { manualWallets() {
    ...
    return (o2 = a$5.isMobile() ? i2 == null ? void 0 : i2.map(({ id: s2, name: $2, links: f2 }) => ({ id: s2, name: $2, mobile: f2, links: f2 })) : i2 == null ? void 0 : i2.map(({ id: s2, name: $2, links: f2 }) => ({ id: s2, name: $2, desktop: f2, links: f2 }))) != null ? o2 : [];
  }, recentWallet() {
  ...
  let ae = class extends s {
    ...
    onOpenModalEvent() {
      this.toggleBodyScroll(false), this.addKeyboardEvents(), this.open = true, setTimeout(async () => {
        ...
        await Promise.all([animate(this.overlayEl, { opacity: [0, 1] }, { delay: o2, duration: r2 }).finished, animate(this.containerEl, e2, { delay: o2, duration: r2 }).finished]), this.active = true;
      }, 0);
    }
  ...
  let Te = class extends s {
    ...
    render() {
      const { name: e2, id: o2, image_id: r2, homepage: a2 } = a$5.getWalletRouterData();
  ...
  let he = class extends s {
    ...
    render() {
      const { name: e2, id: o2, image_id: r2, app: a2, mobile: t2 } = a$5.getWalletRouterData(), { isWeb: l$12 } = c.getCachedRouterWalletPlatforms(), i2 = a2 == null ? void 0 : a2.ios, s2 = t2 == null ? void 0 : t2.universal;
  ...
  let U = class extends s {
    ...
    async fetchWallets() {
      ...
      if (!this.endReached && (this.firstFetch || t2 > De && a2.length < t2))
        try {
          this.loading = true;
          const i2 = (e2 = p$4.state.chains) == null ? void 0 : e2.join(","), { listings: s2 } = await te$3.getWallets({ page: this.firstFetch ? 1 : l2 + 1, entries: De, search: this.search, version: 2, chains: i2 }), $2 = s2.map((f2) => c.getWalletIcon(f2));
          await Promise.all([...$2.map(async (f2) => c.preloadImage(f2)), a$5.wait(300)]), this.endReached = this.isLastPage();
        } catch (i2) {
