...
const wu = "@puzzlehq/sdk", mu = "Puzzle SDK", vu = "0.1.16", _u = "Your portal to privacy", Eu = "./dist/puzzle.umd.js", Du = "./dist/puzzle.es.js", Su = "./dist/types/index.d.ts", Iu = {
  ".": {
...
}, Uu = "https://github.com/puzzlehq/puzzle-sdk#readme", Fu = {
  name: wu,
  displayName: mu,
  version: vu,
  description: _u,
  ...
  bugs: Lu,
  homepage: Uu
}, Mu = Symbol(), wn = Object.getPrototypeOf, ds = /* @__PURE__ */ new WeakMap(), $u = (t) => t && (ds.has(t) ? ds.get(t) : wn(t) === Object.prototype || wn(t) === Array.prototype), ju = (t) => $u(t) && t[Mu] || null, mn = (t, e = !0) => {
  ds.set(t, e);
}, Yi = (t) => typeof t == "object" && t !== null, Xt = /* @__PURE__ */ new WeakMap(), mi = /* @__PURE__ */ new WeakSet(), qu = (t = Object.is, e = (l, p) => new Proxy(l, p), r = (l) => Yi(l) && !mi.has(l) && (Array.isArray(l) || !(Symbol.iterator in l)) && !(l instanceof WeakMap) && !(l instanceof WeakSet) && !(l instanceof Error) && !(l instanceof Number) && !(l instanceof Date) && !(l instanceof String) && !(l instanceof RegExp) && !(l instanceof ArrayBuffer), i = (l) => {
  switch (l.status) {
    case "fulfilled":
      return l.value;
    case "rejected":
...
const Ze = tr({ history: ["ConnectWallet"], view: "ConnectWallet", data: void 0 }), na = { state: Ze, subscribe(t) {
  ...
  return e;
} }, Ku = typeof location < "u" && (location.hostname.includes("localhost") || location.protocol.includes("https")), ot = tr({ enabled: Ku, userSessionId: "", events: [], connectedWalletId: void 0 }), Hu = { state: ot, subscribe(t) {
  return wr(ot.events, () => t(Bu(ot.events[ot.events.length - 1])));
}, initialize() {
  ...
  var e, r;
  Hu.initialize(), Rt.setChains(t.chains), Rt.setIsAuth(!!t.enableAuthMode), Rt.setIsCustomMobile(!!((e = t.mobileWallets) != null && e.length)), Rt.setIsCustomDesktop(!!((r = t.desktopWallets) != null && r.length)), ht.setModalVersionInStorage(), Object.assign(vi, t);
} };
var Vu = Object.defineProperty, vn = Object.getOwnPropertySymbols, Wu = Object.prototype.hasOwnProperty, ku = Object.prototype.propertyIsEnumerable, _n = (t, e, r) => e in t ? Vu(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, Gu = (t, e) => {
  for (var r in e || (e = {}))
    Wu.call(e, r) && _n(t, r, e[r]);
  if (vn)
    for (var r of vn(e))
...
async function _i(t, e) {
  const r = Gu({ sdkType: gs, sdkVersion: ys }, e), i = new URL(t, ps);
...
var Yu = Object.defineProperty, En = Object.getOwnPropertySymbols, Ju = Object.prototype.hasOwnProperty, Qu = Object.prototype.propertyIsEnumerable, Dn = (t, e, r) => e in t ? Yu(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, Xu = (t, e) => {
  for (var r in e || (e = {}))
    Ju.call(e, r) && Dn(t, r, e[r]);
  if (En)
    for (var r of En(e))
...
const Sn = ht.isMobile(), Mt = tr({ wallets: { listings: [], total: 0, page: 1 }, search: { listings: [], total: 0, page: 1 }, recomendedWallets: [] }), R1 = { state: Mt, async getRecomendedWallets() {
  ...
  const e = Xu({}, t), { explorerRecommendedWalletIds: r, explorerExcludedWalletIds: i } = Nr.state, { recomendedWallets: s } = Mt;
  if (i === "ALL")
    return Mt.wallets;
...
var Zu = Object.defineProperty, In = Object.getOwnPropertySymbols, eh = Object.prototype.hasOwnProperty, th = Object.prototype.propertyIsEnumerable, xn = (t, e, r) => e in t ? Zu(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, rh = (t, e) => {
  for (var r in e || (e = {}))
    eh.call(e, r) && xn(t, r, e[r]);
  if (In)
    for (var r of In(e))
...
const $r = tr({ themeMode: ih() ? "dark" : "light" }), On = { state: $r, subscribe(t) {
  return wr($r, () => t($r));
}, setThemeConfig(t) {
  const { themeMode: e, themeVariables: r } = t;
  e && ($r.themeMode = e), r && ($r.themeVariables = rh({}, r));
...
let sh = class {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-27d21d3d.js");
...
function ua(t, e, r, i) {
  ...
  if (Fi(r), n = t._events, n === void 0 ? (n = t._events = /* @__PURE__ */ Object.create(null), t._eventsCount = 0) : (n.newListener !== void 0 && (t.emit(
    ...
    c.name = "MaxListenersExceededWarning", c.emitter = t, c.type = e, c.count = u.length, nh(c);
  }
  return t;
}
...
function ha(t, e, r) {
  var i = { fired: !1, wrapFn: void 0, target: t, type: e, listener: r }, s = oh.bind(i);
...
Ie.prototype.removeListener = function(e, r) {
  ...
  if (i === r || i.listener === r)
    ...
    if (n < 0)
      return this;
    n === 0 ? i.shift() : ah(i, n), i.length === 1 && (s[e] = i[0]), s.removeListener !== void 0 && this.emit("removeListener", e, c || r);
  }
  return this;
};
...
function la(t, e, r) {
  ...
  if (i === void 0)
    return [];
  var s = i[e];
  return s === void 0 ? [] : typeof s == "function" ? r ? [s.listener || s] : [s] : r ? ch(s) : da(s, s.length);
}
...
function uh(t, e) {
  return new Promise(function(r, i) {
    ...
    pa(t, e, n, { once: !0 }), e !== "error" && hh(t, s, { once: !0 });
  });
}
function hh(t, e, r) {
...
const Nh = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  __spreadArrays: _h,
  __values: ms
}, Symbol.toStringTag, { value: "Module" })), At = /* @__PURE__ */ Us(Nh);
var si = {};
...
function Fh() {
  return Rn || (Rn = 1, function(t) {
    ...
    const e = At;
    e.__exportStar(Lh(), t), e.__exportStar(Uh(), t);
  }(Qi)), Qi;
}
Object.defineProperty(Mi, "__esModule", { value: !0 });
Mi.KeyValueStorage = void 0;
const Ir = At, Ln = si, Mh = Ir.__importDefault(Rh()), $h = Fh();
class ba {
  constructor() {
    this.localStorage = Mh.default;
  }
  getKeys() {
  ...
  getEntries() {
    return Ir.__awaiter(this, void 0, void 0, function* () {
      return Object.entries(this.localStorage).map($h.parseEntry);
    });
  }
  getItem(e) {
    return Ir.__awaiter(this, void 0, void 0, function* () {
...
var jh = Mi.default = ba, Tr = {}, Br = {}, X = {}, Xi = {}, Kr = {}, Un;
function qh() {
  if (Un)
    return Kr;
...
function wa() {
  return $n || ($n = 1, function(t) {
    Object.defineProperty(t, "__esModule", { value: !0 });
    const e = At;
    e.__exportStar(zh(), t), e.__exportStar(Bh(), t);
  }(Zi)), Zi;
}
var jn;
function Kh() {
...
function Hh() {
  return qn || (qn = 1, function(t) {
    Object.defineProperty(t, "__esModule", { value: !0 });
    const e = At;
    e.__exportStar(qh(), t), e.__exportStar(Kh(), t);
  }(Xi)), Xi;
}
var Sr = {}, zn;
function Vh() {
...
(function(t) {
  Object.defineProperty(t, "__esModule", { value: !0 });
  const e = At;
  e.__exportStar(Hh(), t), e.__exportStar(Vh(), t), e.__exportStar(kh(), t), e.__exportStar(wa(), t);
})(X);
var rs = {}, Vr = {};
let mr = class {
};
const Gh = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  IEvents: mr
}, Symbol.toStringTag, { value: "Module" })), Yh = /* @__PURE__ */ Us(Gh);
var Hn;
function Jh() {
  if (Hn)
    return Vr;
...
function ma() {
  return Vn || (Vn = 1, function(t) {
    Object.defineProperty(t, "__esModule", { value: !0 }), At.__exportStar(Jh(), t);
  }(rs)), rs;
}
var is = {}, lr = {}, Wn;
function Qh() {
...
(function(t) {
  Object.defineProperty(t, "__esModule", { value: !0 });
  const e = At;
  e.__exportStar(Xh(), t), e.__exportStar(ma(), t), e.__exportStar(va(), t);
})(Tr);
var me = {}, ss, Yn;
function Zh() {
  if (Yn)
...
(function(t) {
  ...
  const e = At, r = e.__importDefault(el());
  Object.defineProperty(t, "pino", { enumerable: !0, get: function() {
    return r.default;
  } }), e.__exportStar(_a(), t), e.__exportStar(tl(), t);
})(me);
let rl = class extends mr {
  constructor(e) {
...
const dl = (t) => JSON.stringify(t, (e, r) => typeof r == "bigint" ? r.toString() + "n" : r), pl = (t) => {
...
St.wipe = bl;
const wl = {}, ml = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: wl
}, Symbol.toStringTag, { value: "Module" })), vl = /* @__PURE__ */ Us(ml);
Object.defineProperty(qi, "__esModule", { value: !0 });
qi.NodeRandomSource = void 0;
const _l = St;
class El {
  constructor() {
    if (this.isAvailable = !1, this.isInstantiated = !1, typeof yl < "u") {
      const e = vl;
  ...
  randomBytes(e) {
    ...
    for (let s = 0; s < i.length; s++)
      i[s] = r[s];
    return (0, _l.wipe)(r), i;
  }
}
qi.NodeRandomSource = El;
Object.defineProperty($i, "__esModule", { value: !0 });
$i.SystemRandomSource = void 0;
const Dl = ji, Sl = qi;
class Il {
  constructor() {
    if (this.isAvailable = !1, this.name = "", this._source = new Dl.BrowserRandomSource(), this._source.isAvailable) {
      this.isAvailable = !0, this.name = "Browser";
      return;
    }
    if (this._source = new Sl.NodeRandomSource(), this._source.isAvailable) {
...
const Wl = "EdDSA", kl = "JWT", Na = ".", Ta = "base64url", Gl = "utf8", Yl = "utf8", Jl = ":", Ql = "did", Xl = "key", eo = "base58btc", Zl = "z", ef = "K36", tf = 32;
function js(t) {
...
}, af = (t) => new TextEncoder().encode(t), cf = (t) => new TextDecoder().decode(t);
class uf {
  constructor(e, r, i) {
...
class ff {
  constructor(e, r, i, s) {
    this.name = e, this.prefix = r, this.baseEncode = i, this.baseDecode = s, this.encoder = new uf(e, r, i), this.decoder = new hf(e, r, s);
  }
  encode(e) {
...
const zi = ({ name: t, prefix: e, encode: r, decode: i }) => new ff(t, e, r, i), ni = ({ prefix: t, name: e, alphabet: r }) => {
  const { encode: i, decode: s } = nf(r, e);
  return zi({
    prefix: t,
    name: e,
    encode: i,
  ...
  __proto__: null,
  base8: mf
}, Symbol.toStringTag, { value: "Module" })), _f = ni({
  prefix: "9",
  name: "base10",
  alphabet: "0123456789"
  ...
  base16: Df,
  base16upper: Sf
}, Symbol.toStringTag, { value: "Module" })), xf = it({
  prefix: "b",
  name: "base32",
  ...
  base32hex: Nf,
  base32hexpad: Pf,
  base32hexpadupper: Rf,
  base32hexupper: Tf,
  base32pad: Af,
  base32padupper: Cf,
  base32upper: Of,
  base32z: Lf
}, Symbol.toStringTag, { value: "Module" })), Ff = ni({
  prefix: "k",
  name: "base36",
  ...
  base36: Ff,
  base36upper: Mf
}, Symbol.toStringTag, { value: "Module" })), jf = ni({
  name: "base58btc",
  prefix: "z",
  ...
  base64url: Hf,
  base64urlpad: Vf
}, Symbol.toStringTag, { value: "Module" })), La = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂"), kf = La.reduce((t, e, r) => (t[r] = e, t), []), Gf = La.reduce((t, e, r) => (t[e.codePointAt(0)] = r, t), []);
function Yf(t) {
  return t.reduce((e, r) => (e += kf[r], e), "");
}
function Jf(t) {
  const e = [];
  for (const r of t) {
    const i = Gf[r.codePointAt(0)];
    if (i === void 0)
...
function Ni(t) {
  return yt(mt(Ms(t), Gl), Ta);
}
function Ma(t) {
  const e = mt(ef, eo), r = Zl + yt(Ss([e, t]), eo);
  return [Ql, Xl, r].join(Jl);
}
function Zf(t) {
  return yt(t, Ta);
}
function ed(t) {
  return mt([Ni(t.header), Ni(t.payload)].join(Na), Yl);
}
function td(t) {
  return [
    Ni(t.header),
...
zs.isSerializableHash = hd;
Object.defineProperty(oi, "__esModule", { value: !0 });
var $t = zs, ld = rr, fd = St, Ba = (
  /** @class */
  function() {
    function t(e, r) {
      ...
      for (var s = 0; s < i.length; s++)
        i[s] ^= 106;
      this._outer.update(i), $t.isSerializableHash(this._inner) && $t.isSerializableHash(this._outer) && (this._innerKeyedState = this._inner.saveState(), this._outerKeyedState = this._outer.saveState()), fd.wipe(i);
    }
...
), _d = /alexa|bot|crawl(er|ing)|facebookexternalhit|feedburner|google web preview|nagios|postrank|pingdom|slurp|spider|yahoo!|yandex/, Ed = /(nuhk|curl|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask\ Jeeves\/Teoma|ia_archiver)/, ao = 3, Dd = [
  ["aol", /AOLShield\/([0-9\._]+)/],
  ["edge", /Edge\/([0-9\._]+)/],
...
function Sd(t) {
  return t ? uo(t) : typeof document > "u" && typeof navigator < "u" && navigator.product === "ReactNative" ? new vd() : typeof navigator < "u" ? uo(navigator.userAgent) : Od();
}
function Id(t) {
  return t !== "" && Dd.reduce(function(e, r) {
    var i = r[0], s = r[1];
    if (e)
      return e;
    var n = s.exec(t);
...
function uo(t) {
  ...
  s ? s.length < ao && (s = oo(oo([], s, !0), Ad(ao - s.length), !0)) : s = [];
  var n = s.join("."), u = xd(t), c = Ed.exec(t);
  return c && c[1] ? new wd(r, n, u, c[1]) : new yd(r, n, u);
}
function xd(t) {
...
function Od() {
  ...
  return t ? new bd(process.version.slice(1)) : null;
}
function Ad(t) {
  for (var e = [], r = 0; r < t; r++)
    e.push("0");
...
xe.getDocumentOrThrow = Cd;
function Nd() {
  return vr("document");
}
var Ka = xe.getDocument = Nd;
function Td() {
  return Rr("navigator");
}
xe.getNavigatorOrThrow = Td;
function Pd() {
  return vr("navigator");
}
var Ks = xe.getNavigator = Pd;
function Rd() {
  return Rr("location");
}
xe.getLocationOrThrow = Rd;
function Ld() {
  return vr("location");
}
var Ha = xe.getLocation = Ld;
function Ud() {
  return Rr("crypto");
}
xe.getCryptoOrThrow = Ud;
function Fd() {
  return vr("crypto");
}
xe.getCrypto = Fd;
...
xe.getLocalStorageOrThrow = Md;
function $d() {
  return vr("localStorage");
}
xe.getLocalStorage = $d;
var Hs = {};
...
Va = Hs.getWindowMetadata = jd;
var ti = {}, qd = (t) => encodeURIComponent(t).replace(/[!'()*]/g, (e) => `%${e.charCodeAt(0).toString(16).toUpperCase()}`), Wa = "%[a-f0-9]{2}", lo = new RegExp("(" + Wa + ")|([^%]+?)", "gi"), fo = new RegExp("(" + Wa + ")+", "gi");
function xs(t, e) {
  try {
...
(function(t) {
  const e = qd, r = Kd, i = Hd, s = Vd, n = (v) => v == null, u = Symbol("encodeFragmentIdentifier");
  function c(v) {
...
const Ga = "base10", gt = "base16", Os = "base64pad", Vs = "utf8", Ya = 0, _r = 1, kd = 0, po = 1, As = 12, Ws = 32;
function Gd() {
...
function Yd(t, e) {
  const r = Bs.sharedKey(mt(t, gt), mt(e, gt)), i = new gd(Ki.SHA256, r).expand(Ws);
  return yt(i, gt);
}
function Jd(t) {
...
function Xd(t) {
  const e = Qd(typeof t.type < "u" ? t.type : Ya);
  ...
  return ep({ type: e, sealed: s, iv: i, senderPublicKey: r });
}
function Zd(t) {
...
function Ti(t) {
  const e = mt(t, Os), r = e.slice(kd, po), i = po;
  if (ai(r) === _r) {
...
var rp = Object.defineProperty, yo = Object.getOwnPropertySymbols, ip = Object.prototype.hasOwnProperty, sp = Object.prototype.propertyIsEnumerable, bo = (t, e, r) => e in t ? rp(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, wo = (t, e) => {
  for (var r in e || (e = {}))
    ip.call(e, r) && bo(t, r, e[r]);
  if (yo)
    for (var r of yo(e))
      sp.call(e, r) && bo(t, r, e[r]);
  return t;
};
const np = "ReactNative", Dt = { reactNative: "react-native", node: "node", browser: "browser", unknown: "unknown" }, op = "js";
function ks() {
  return typeof process < "u" && typeof process.versions < "u" && typeof process.versions.node < "u";
}
function Hi() {
  return !Ka() && !!Ks() && navigator.product === np;
}
function ci() {
  return !ks() && !!Ks();
}
...
function lp(t, e, r) {
  const i = up(), s = hp();
  return [[t, e].join("-"), [op, r].join("-"), i, s].join("/");
}
function fp({ protocol: t, version: e, relayUrl: r, sdkVersion: i, auth: s, projectId: n, useOnCloseEvent: u }) {
  const c = r.split("?"), h = lp(t, e, i), l = { auth: s, ua: h, projectId: n, useOnCloseEvent: u || void 0 }, p = ap(c[1] || "", l);
  return c[0] + "?" + p;
}
function gr(t, e) {
...
async function gp({ id: t, topic: e, wcDeepLink: r }) {
  try {
    if (!r)
      return;
...
const yp = "irn";
function Ns(t) {
  return (t == null ? void 0 : t.relay) || { protocol: yp };
}
function Ii(t) {
  const e = Wd[t];
  if (typeof e > "u")
...
var bp = Object.defineProperty, mo = Object.getOwnPropertySymbols, wp = Object.prototype.hasOwnProperty, mp = Object.prototype.propertyIsEnumerable, vo = (t, e, r) => e in t ? bp(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, vp = (t, e) => {
  for (var r in e || (e = {}))
    wp.call(e, r) && vo(t, r, e[r]);
  if (mo)
    for (var r of mo(e))
...
function Ep(t) {
  ...
  return { protocol: i, topic: Dp(s[0]), version: parseInt(s[1], 10), symKey: u.symKey, relay: _p(u) };
}
function Dp(t) {
...
function Ip(t) {
  return `${t.protocol}:${t.topic}@${t.version}?` + ti.stringify(vp({ symKey: t.symKey }, Sp(t.relay)));
}
function Lr(t) {
  const e = [];
  return t.forEach((r) => {
...
function qp(t, e) {
  ...
  return hi(t) ? t.forEach((i) => {
    r || Rp(i) || (r = He("UNSUPPORTED_ACCOUNTS", `${e}, account ${i} should be a string and conform to "namespace:chainId:address" format`));
...
function zp(t, e) {
  ...
  return Object.values(t).forEach((i) => {
    if (r)
      return;
    const s = qp(i == null ? void 0 : i.accounts, `${e} namespace`);
    s && (r = s);
  }), r;
}
function Bp(t, e) {
...
function Eo(t, e) {
  return !(!Pi(e) || !xp(t).includes(e));
}
function Jp(t, e, r) {
  return tt(r, !1) ? Op(t, e).includes(r) : !1;
}
function Qp(t, e, r) {
...
function Do(t, e, r) {
  let i = null;
  const s = Xp(t), n = Zp(e), u = Object.keys(s), c = Object.keys(n), h = So(Object.keys(t)), l = So(Object.keys(e)), p = h.filter((m) => !l.includes(m));
...
const ag = "PARSE_ERROR", cg = "INVALID_REQUEST", ug = "METHOD_NOT_FOUND", hg = "INVALID_PARAMS", ic = "INTERNAL_ERROR", Ys = "SERVER_ERROR", lg = [-32700, -32600, -32601, -32602, -32603], Zr = {
  [ag]: { code: -32700, message: "Parse error" },
  [cg]: { code: -32600, message: "Invalid Request" },
  [ug]: { code: -32601, message: "Method not found" },
  [hg]: { code: -32602, message: "Invalid params" },
...
(function(t) {
  Object.defineProperty(t, "__esModule", { value: !0 });
  const e = At;
  e.__exportStar(gg(), t), e.__exportStar(yg(), t);
})(nc);
function Js(t = 3) {
...
function bg(t, e) {
  return typeof t > "u" ? xo(ic) : (typeof t == "string" && (t = Object.assign(Object.assign({}, xo(Ys)), { message: t })), typeof e < "u" && (t.data = e), fg(t.code) && (t = dg(t.code)), t);
}
class wg {
}
class mg extends wg {
...
const xg = () => typeof WebSocket < "u" ? WebSocket : typeof global < "u" && typeof global.WebSocket < "u" ? global.WebSocket : typeof window < "u" && typeof window.WebSocket < "u" ? window.WebSocket : typeof self < "u" && typeof self.WebSocket < "u" ? self.WebSocket : require("ws"), Og = () => typeof WebSocket < "u" || typeof global < "u" && typeof global.WebSocket < "u" || typeof window < "u" && typeof window.WebSocket < "u" || typeof self < "u" && typeof self.WebSocket < "u", No = (t) => t.split("?")[0], To = 10, Ag = xg();
class Cg {
  constructor(e) {
  ...
  register(e = this.url) {
    ...
    return this.url = e, this.registering = !0, new Promise((r, i) => {
      const s = nc.isReactNative() ? void 0 : { rejectUnauthorized: !Sg(e) }, n = new Ag(e, [], s);
      Og() ? n.onerror = (u) => {
        const c = u;
...
(function(t, e) {
  ...
  zt.prototype.clear = Lc, zt.prototype.delete = Uc, zt.prototype.get = Fc, zt.prototype.has = Mc, zt.prototype.set = $c;
  function sr(g) {
    var I = -1, $ = g == null ? 0 : g.length;
    for (this.clear(); ++I < $; ) {
      var Q = g[I];
  ...
  sr.prototype.clear = jc, sr.prototype.delete = qc, sr.prototype.get = zc, sr.prototype.has = Bc, sr.prototype.set = Kc;
  function di(g) {
    var I = -1, $ = g == null ? 0 : g.length;
...
const cc = (t) => {
  ...
  if (ArrayBuffer.isView(t))
    return new Uint8Array(t.buffer, t.byteOffset, t.byteLength);
  throw new Error("Unknown type, must be binary type");
}, Ug = (t) => new TextEncoder().encode(t), Fg = (t) => new TextDecoder().decode(t);
class Mg {
  constructor(e, r, i) {
    this.name = e, this.prefix = r, this.baseEncode = i;
  }
...
const uc = (t, e) => new jg({ ...t.decoders || { [t.prefix]: t }, ...e.decoders || { [e.prefix]: e } });
class qg {
  constructor(e, r, i, s) {
    this.name = e, this.prefix = r, this.baseEncode = i, this.baseDecode = s, this.encoder = new Mg(e, r, i), this.decoder = new $g(e, r, s);
  }
  encode(e) {
    return this.encoder.encode(e);
  }
...
const Wi = ({ name: t, prefix: e, encode: r, decode: i }) => new qg(t, e, r, i), li = ({ prefix: t, name: e, alphabet: r }) => {
  const { encode: i, decode: s } = Lg(r, e);
  ...
  return zg(s, i, r, t);
} }), Kg = Wi({ prefix: "\0", name: "identity", encode: (t) => Fg(t), decode: (t) => Ug(t) });
var Hg = Object.freeze({ __proto__: null, identity: Kg });
const Vg = st({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var Wg = Object.freeze({ __proto__: null, base2: Vg });
const kg = st({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
var Gg = Object.freeze({ __proto__: null, base8: kg });
const Yg = li({ prefix: "9", name: "base10", alphabet: "0123456789" });
var Jg = Object.freeze({ __proto__: null, base10: Yg });
const Qg = st({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 }), Xg = st({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var Zg = Object.freeze({ __proto__: null, base16: Qg, base16upper: Xg });
const e0 = st({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 }), t0 = st({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 }), r0 = st({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 }), i0 = st({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 }), s0 = st({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 }), n0 = st({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 }), o0 = st({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 }), a0 = st({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 }), c0 = st({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
var u0 = Object.freeze({ __proto__: null, base32: e0, base32upper: t0, base32pad: r0, base32padupper: i0, base32hex: s0, base32hexupper: n0, base32hexpad: o0, base32hexpadupper: a0, base32z: c0 });
const h0 = li({ prefix: "k", name: "base36", alphabet: "0123456789abcdefghijklmnopqrstuvwxyz" }), l0 = li({ prefix: "K", name: "base36upper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" });
var f0 = Object.freeze({ __proto__: null, base36: h0, base36upper: l0 });
const d0 = li({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" }), p0 = li({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
var g0 = Object.freeze({ __proto__: null, base58btc: d0, base58flickr: p0 });
const y0 = st({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 }), b0 = st({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 }), w0 = st({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 }), m0 = st({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
var v0 = Object.freeze({ __proto__: null, base64: y0, base64pad: b0, base64url: w0, base64urlpad: m0 });
const hc = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂"), _0 = hc.reduce((t, e, r) => (t[r] = e, t), []), E0 = hc.reduce((t, e, r) => (t[e.codePointAt(0)] = r, t), []);
function D0(t) {
  return t.reduce((e, r) => (e += _0[r], e), "");
}
function S0(t) {
  const e = [];
  for (const r of t) {
...
const I0 = Wi({ prefix: "🚀", name: "base256emoji", encode: D0, decode: S0 });
var x0 = Object.freeze({ __proto__: null, base256emoji: I0 }), O0 = lc, Po = 128, A0 = 127, C0 = ~A0, N0 = Math.pow(2, 31);
function lc(t, e, r) {
  e = e || [], r = r || 0;
  for (var i = r; t >= N0; )
    e[r++] = t & 255 | Po, t /= 128;
...
var R0 = Math.pow(2, 7), L0 = Math.pow(2, 14), U0 = Math.pow(2, 21), F0 = Math.pow(2, 28), M0 = Math.pow(2, 35), $0 = Math.pow(2, 42), j0 = Math.pow(2, 49), q0 = Math.pow(2, 56), z0 = Math.pow(2, 63), B0 = function(t) {
  return t < R0 ? 1 : t < L0 ? 2 : t < U0 ? 3 : t < F0 ? 4 : t < M0 ? 5 : t < $0 ? 6 : t < j0 ? 7 : t < q0 ? 8 : t < z0 ? 9 : 10;
}, K0 = { encode: O0, decode: T0, encodingLength: B0 }, fc = K0;
const Lo = (t, e, r = 0) => (fc.encode(t, e, r), e), Uo = (t) => fc.encodingLength(t), Ps = (t, e) => {
  ...
  return Lo(t, n, 0), Lo(r, n, i), n.set(e, s), new H0(t, r, e, n);
};
class H0 {
  constructor(e, r, i, s) {
...
const dc = ({ name: t, code: e, encode: r }) => new V0(t, e, r);
class V0 {
  constructor(e, r, i) {
...
const pc = (t) => async (e) => new Uint8Array(await crypto.subtle.digest(t, e)), W0 = dc({ name: "sha2-256", code: 18, encode: pc("SHA-256") }), k0 = dc({ name: "sha2-512", code: 19, encode: pc("SHA-512") });
var G0 = Object.freeze({ __proto__: null, sha256: W0, sha512: k0 });
const gc = 0, Y0 = "identity", yc = cc, J0 = (t) => Ps(gc, yc(t)), Q0 = { code: gc, name: Y0, encode: yc, digest: J0 };
var X0 = Object.freeze({ __proto__: null, identity: Q0 });
new TextEncoder(), new TextDecoder();
const Fo = { ...Hg, ...Wg, ...Gg, ...Jg, ...Zg, ...u0, ...f0, ...g0, ...v0, ...x0 };
({ ...G0, ...X0 });
function bc(t) {
  return globalThis.Buffer != null ? new Uint8Array(t.buffer, t.byteOffset, t.byteLength) : t;
}
...
const Mo = wc("utf8", "u", (t) => "u" + new TextDecoder("utf8").decode(t), (t) => new TextEncoder().encode(t.substring(1))), cs = wc("ascii", "a", (t) => {
  ...
  for (let r = 0; r < t.length; r++)
    e[r] = t.charCodeAt(r);
  return e;
}), ey = { utf8: Mo, "utf-8": Mo, hex: Fo.base16, latin1: cs, ascii: cs, binary: cs, ...Fo };
...
const mc = "wc", ry = 2, en = "core", er = `${mc}@2:${en}:`, iy = { name: en, logger: "error" }, sy = { database: ":memory:" }, ny = "crypto", $o = "client_ed25519_seed", oy = X.ONE_DAY, ay = "keychain", cy = "0.3", uy = "messages", hy = "0.3", ly = X.SIX_HOURS, fy = "publisher", vc = "irn", dy = "error", _c = "wss://relay.walletconnect.com", jo = "wss://relay.walletconnect.org", py = "relayer", lt = { message: "relayer_message", message_ack: "relayer_message_ack", connect: "relayer_connect", disconnect: "relayer_disconnect", error: "relayer_error", connection_stalled: "relayer_connection_stalled", transport_closed: "relayer_transport_closed", publish: "relayer_publish" }, gy = "_subscription", Vt = { payload: "payload", connect: "connect", disconnect: "disconnect", error: "error" }, yy = X.ONE_SECOND, by = "2.10.0", wy = 1e4, my = "0.3", vy = "WALLETCONNECT_CLIENT_ID", qt = { created: "subscription_created", deleted: "subscription_deleted", expired: "subscription_expired", disabled: "subscription_disabled", sync: "subscription_sync", resubscribed: "subscription_resubscribed" }, _y = "subscription", Ey = "0.3", Dy = X.FIVE_SECONDS * 1e3, Sy = "pairing", Iy = "0.3", Wr = { wc_pairingDelete: { req: { ttl: X.ONE_DAY, prompt: !1, tag: 1e3 }, res: { ttl: X.ONE_DAY, prompt: !1, tag: 1001 } }, wc_pairingPing: { req: { ttl: X.THIRTY_SECONDS, prompt: !1, tag: 1002 }, res: { ttl: X.THIRTY_SECONDS, prompt: !1, tag: 1003 } }, unregistered_method: { req: { ttl: X.ONE_DAY, prompt: !1, tag: 0 }, res: { ttl: X.ONE_DAY, prompt: !1, tag: 0 } } }, jt = { created: "history_created", updated: "history_updated", deleted: "history_deleted", sync: "history_sync" }, xy = "history", Oy = "0.3", Ay = "expirer", Ot = { created: "expirer_created", deleted: "expirer_deleted", expired: "expirer_expired", sync: "expirer_sync" }, Cy = "0.3", us = "verify-api", Oi = "https://verify.walletconnect.com", qo = "https://verify.walletconnect.org";
class Ny {
  constructor(e, r) {
    this.core = e, this.logger = r, this.keychain = /* @__PURE__ */ new Map(), this.name = ay, this.version = cy, this.initialized = !1, this.storagePrefix = er, this.init = async () => {
      if (!this.initialized) {
...
class Ty {
  constructor(e, r, i) {
    this.core = e, this.logger = r, this.name = ny, this.initialized = !1, this.init = async () => {
      ...
      return await rd(c, s, oy, u);
    }, this.generateSharedKey = (s, n, u) => {
      this.isInitialized();
      const c = this.getPrivateKey(s), h = Yd(c, n);
      ...
      return Xd({ type: p, symKey: l, message: h, senderPublicKey: m });
      ...
      try {
        const h = this.getSymKey(s), l = Zd({ symKey: h, encoded: n });
        return Ea(l);
      } catch (h) {
    ...
    }, this.core = e, this.logger = me.generateChildLogger(r, this.name), this.keychain = i || new Ny(this.core, this.logger);
  }
  get context() {
    return me.getLoggerContext(this.logger);
  }
...
class Py extends sl {
  constructor(e, r) {
    super(e, r), this.logger = e, this.core = r, this.messages = /* @__PURE__ */ new Map(), this.name = uy, this.version = hy, this.initialized = !1, this.storagePrefix = er, this.init = async () => {
      if (!this.initialized) {
...
class Ry extends nl {
  constructor(e, r) {
    super(e, r), this.relayer = e, this.logger = r, this.events = new Lt.EventEmitter(), this.name = fy, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = X.toMiliseconds(X.TEN_SECONDS), this.needsTransportRestart = !1, this.publish = async (i, s, n) => {
      var u;
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i, message: s, opts: n } });
      try {
        const c = (n == null ? void 0 : n.ttl) || ly, h = Ns(n), l = (n == null ? void 0 : n.prompt) || !1, p = (n == null ? void 0 : n.tag) || 0, m = (n == null ? void 0 : n.id) || oc().toString(), E = { topic: i, message: s, opts: { ttl: c, relay: h, prompt: l, tag: p, id: m } }, _ = setTimeout(() => this.queue.set(m, E), this.publishTimeout);
        try {
...
var Uy = Object.defineProperty, Fy = Object.defineProperties, My = Object.getOwnPropertyDescriptors, zo = Object.getOwnPropertySymbols, $y = Object.prototype.hasOwnProperty, jy = Object.prototype.propertyIsEnumerable, Bo = (t, e, r) => e in t ? Uy(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, kr = (t, e) => {
  for (var r in e || (e = {}))
    $y.call(e, r) && Bo(t, r, e[r]);
  if (zo)
    for (var r of zo(e))
...
class qy extends cl {
  constructor(e, r) {
    super(e, r), this.relayer = e, this.logger = r, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new Ly(), this.events = new Lt.EventEmitter(), this.name = _y, this.version = Ey, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = !1, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = er, this.subscribeTimeout = 1e4, this.restartInProgress = !1, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
      ...
      const c = setInterval(() => {
        !this.pending.has(i) && this.topics.includes(i) && (clearInterval(c), u.stop(this.pendingSubscriptionWatchLabel), s(!0)), u.elapsed(this.pendingSubscriptionWatchLabel) >= Dy && (clearInterval(c), u.stop(this.pendingSubscriptionWatchLabel), n(new Error("Subscription resolution timeout")));
...
var zy = Object.defineProperty, Ko = Object.getOwnPropertySymbols, By = Object.prototype.hasOwnProperty, Ky = Object.prototype.propertyIsEnumerable, Ho = (t, e, r) => e in t ? zy(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, Hy = (t, e) => {
  for (var r in e || (e = {}))
    By.call(e, r) && Ho(t, r, e[r]);
  if (Ko)
    for (var r of Ko(e))
...
class Vy extends ol {
  constructor(e) {
    super(e), this.protocol = "wc", this.version = 2, this.events = new Lt.EventEmitter(), this.name = py, this.transportExplicitlyClosed = !1, this.initialized = !1, this.connectionAttemptInProgress = !1, this.connectionStatusPollingInterval = 20, this.staleConnectionErrors = ["socket hang up", "socket stalled"], this.hasExperiencedNetworkDisruption = !1, this.request = async (r) => {
    ...
    }, this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? me.generateChildLogger(e.logger, this.name) : me.pino(me.getDefaultLoggerOptions({ level: e.logger || dy })), this.messages = new Py(this.logger, e.core), this.subscriber = new qy(this, this.logger), this.publisher = new Ry(this, this.logger), this.relayUrl = (e == null ? void 0 : e.relayUrl) || _c, this.projectId = e.projectId, this.provider = {};
  }
  async init() {
  ...
  async createProvider() {
    ...
    this.provider = new Ig(new Cg(fp({ sdkVersion: by, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e, useOnCloseEvent: !0 }))), this.registerProviderListeners();
  }
  ...
  async onProviderPayload(e) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e }), Zs(e)) {
      if (!e.method.endsWith(gy))
        return;
      const r = e.params, { topic: i, message: s, publishedAt: n } = r.data, u = { topic: i, message: s, publishedAt: n };
      this.logger.debug("Emitting Relayer Payload"), this.logger.trace(Hy({ type: "event", event: r.id }, u)), this.events.emit(r.id, u), await this.acknowledgePayload(e), await this.onMessageEvent(u);
    } else
...
var Wy = Object.defineProperty, Vo = Object.getOwnPropertySymbols, ky = Object.prototype.hasOwnProperty, Gy = Object.prototype.propertyIsEnumerable, Wo = (t, e, r) => e in t ? Wy(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, ko = (t, e) => {
  for (var r in e || (e = {}))
    ky.call(e, r) && Wo(t, r, e[r]);
  if (Vo)
    for (var r of Vo(e))
...
class ki extends al {
  constructor(e, r, i, s = er, n = void 0) {
    super(e, r, i, s), this.core = e, this.logger = r, this.name = i, this.map = /* @__PURE__ */ new Map(), this.version = my, this.cached = [], this.initialized = !1, this.storagePrefix = er, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((u) => {
        this.getKey && u !== null && !pt(u) ? this.map.set(this.getKey(u), u) : Up(u) ? this.map.set(u.id, u) : Fp(u) && this.map.set(u.topic, u);
      }), this.cached = [], this.initialized = !0);
    }, this.set = async (u, c) => {
    ...
    }, this.get = (u) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: u }), this.getData(u)), this.getAll = (u) => (this.isInitialized(), u ? this.values.filter((c) => Object.keys(u).every((h) => Tg(c[h], u[h]))) : this.values), this.update = async (u, c) => {
...
class Yy {
  constructor(e, r) {
    this.core = e, this.logger = r, this.name = Sy, this.version = Iy, this.events = new ga(), this.initialized = !1, this.storagePrefix = er, this.ignoredPayloadTypes = [_r], this.registeredMethods = [], this.init = async () => {
      this.initialized || (await this.pairings.init(), await this.cleanup(), this.registerRelayerEvents(), this.registerExpirerEvents(), this.initialized = !0, this.logger.trace("Initialized"));
    }, this.register = ({ methods: i }) => {
      this.isInitialized(), this.registeredMethods = [.../* @__PURE__ */ new Set([...this.registeredMethods, ...i])];
    }, this.create = async () => {
      this.isInitialized();
      const i = Cs(), s = await this.core.crypto.setSymKey(i), n = Tt(X.FIVE_MINUTES), u = { protocol: vc }, c = { topic: s, expiry: n, relay: u, active: !1 }, h = Ip({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i, relay: u });
      return await this.pairings.set(s, c), await this.core.relayer.subscribe(s), this.core.expirer.set(s, n), { topic: s, uri: h };
    }, this.pair = async (i) => {
      this.isInitialized(), this.isValidPair(i);
      const { topic: s, symKey: n, relay: u } = Ep(i.uri);
...
class Jy extends il {
  constructor(e, r) {
    super(e, r), this.core = e, this.logger = r, this.records = /* @__PURE__ */ new Map(), this.events = new Lt.EventEmitter(), this.name = xy, this.version = Oy, this.cached = [], this.initialized = !1, this.storagePrefix = er, this.init = async () => {
...
class Qy extends ul {
  constructor(e, r) {
    super(e, r), this.core = e, this.logger = r, this.expirations = /* @__PURE__ */ new Map(), this.events = new Lt.EventEmitter(), this.name = Ay, this.version = Cy, this.cached = [], this.initialized = !1, this.storagePrefix = er, this.init = async () => {
...
var Zy = Object.defineProperty, Go = Object.getOwnPropertySymbols, e1 = Object.prototype.hasOwnProperty, t1 = Object.prototype.propertyIsEnumerable, Yo = (t, e, r) => e in t ? Zy(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, Jo = (t, e) => {
  for (var r in e || (e = {}))
    e1.call(e, r) && Yo(t, r, e[r]);
  if (Go)
    for (var r of Go(e))
...
class tn extends rl {
  constructor(e) {
    super(e), this.protocol = mc, this.version = ry, this.name = en, this.events = new Lt.EventEmitter(), this.initialized = !1, this.on = (i, s) => this.events.on(i, s), this.once = (i, s) => this.events.once(i, s), this.off = (i, s) => this.events.off(i, s), this.removeListener = (i, s) => this.events.removeListener(i, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || _c;
    const r = typeof (e == null ? void 0 : e.logger) < "u" && typeof (e == null ? void 0 : e.logger) != "string" ? e.logger : me.pino(me.getDefaultLoggerOptions({ level: (e == null ? void 0 : e.logger) || iy.logger }));
    this.logger = me.generateChildLogger(r, this.name), this.heartbeat = new Tr.HeartBeat(), this.crypto = new Ty(this, this.logger, e == null ? void 0 : e.keychain), this.history = new Jy(this, this.logger), this.expirer = new Qy(this, this.logger), this.storage = e != null && e.storage ? e.storage : new jh(Jo(Jo({}, sy), e == null ? void 0 : e.storageOptions)), this.relayer = new Vy({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Yy(this, this.logger), this.verify = new Xy(this.projectId || "", this.logger);
  }
  static async init(e) {
    const r = new tn(e);
    await r.initialize();
    const i = await r.crypto.getClientId();
    return await r.storage.setItem(vy, i), r;
  }
  get context() {
    return me.getLoggerContext(this.logger);
  }
...
const r1 = tn, Ec = "wc", Dc = 2, Sc = "client", rn = `${Ec}@${Dc}:${Sc}:`, ls = { name: Sc, logger: "error", controller: !1, relayUrl: "wss://relay.walletconnect.com" }, Qo = "WALLETCONNECT_DEEPLINK_CHOICE", i1 = "proposal", s1 = "Proposal expired", n1 = "session", Di = X.SEVEN_DAYS, o1 = "engine", Gr = { wc_sessionPropose: { req: { ttl: X.FIVE_MINUTES, prompt: !0, tag: 1100 }, res: { ttl: X.FIVE_MINUTES, prompt: !1, tag: 1101 } }, wc_sessionSettle: { req: { ttl: X.FIVE_MINUTES, prompt: !1, tag: 1102 }, res: { ttl: X.FIVE_MINUTES, prompt: !1, tag: 1103 } }, wc_sessionUpdate: { req: { ttl: X.ONE_DAY, prompt: !1, tag: 1104 }, res: { ttl: X.ONE_DAY, prompt: !1, tag: 1105 } }, wc_sessionExtend: { req: { ttl: X.ONE_DAY, prompt: !1, tag: 1106 }, res: { ttl: X.ONE_DAY, prompt: !1, tag: 1107 } }, wc_sessionRequest: { req: { ttl: X.FIVE_MINUTES, prompt: !0, tag: 1108 }, res: { ttl: X.FIVE_MINUTES, prompt: !1, tag: 1109 } }, wc_sessionEvent: { req: { ttl: X.FIVE_MINUTES, prompt: !0, tag: 1110 }, res: { ttl: X.FIVE_MINUTES, prompt: !1, tag: 1111 } }, wc_sessionDelete: { req: { ttl: X.ONE_DAY, prompt: !1, tag: 1112 }, res: { ttl: X.ONE_DAY, prompt: !1, tag: 1113 } }, wc_sessionPing: { req: { ttl: X.THIRTY_SECONDS, prompt: !1, tag: 1114 }, res: { ttl: X.THIRTY_SECONDS, prompt: !1, tag: 1115 } } }, fs = { min: X.FIVE_MINUTES, max: X.SEVEN_DAYS }, Wt = { idle: "IDLE", active: "ACTIVE" }, a1 = "request", c1 = ["wc_sessionPropose", "wc_sessionRequest", "wc_authRequest"];
var u1 = Object.defineProperty, h1 = Object.defineProperties, l1 = Object.getOwnPropertyDescriptors, Xo = Object.getOwnPropertySymbols, f1 = Object.prototype.hasOwnProperty, d1 = Object.prototype.propertyIsEnumerable, Zo = (t, e, r) => e in t ? u1(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, bt = (t, e) => {
  for (var r in e || (e = {}))
    f1.call(e, r) && Zo(t, r, e[r]);
  if (Xo)
    for (var r of Xo(e))
...
class p1 extends fl {
  constructor(e) {
    super(e), this.name = o1, this.events = new ga(), this.initialized = !1, this.ignoredPayloadTypes = [_r], this.requestQueue = { state: Wt.idle, queue: [] }, this.sessionRequestQueue = { state: Wt.idle, queue: [] }, this.requestQueueDelay = X.ONE_SECOND, this.init = async () => {
      ...
      const E = await this.client.core.crypto.generateKeyPair(), _ = bt({ requiredNamespaces: n, optionalNamespaces: u, relays: h ?? [{ protocol: vc }], proposer: { publicKey: E, metadata: this.client.metadata } }, c && { sessionProperties: c }), { reject: x, resolve: R, done: L } = xr(X.FIVE_MINUTES, s1);
      ...
      return this.events.once(Be("session_request", c), ({ error: m, result: E }) => {
        ...
        gp({ id: c, topic: n, wcDeepLink: E }), m();
      }), h()]).then((m) => m[2]);
    ...
    }, this.find = (r) => (this.isInitialized(), this.client.session.getAll().filter((i) => Pp(i, r))), this.getPendingSessionRequests = () => (this.isInitialized(), this.client.pendingRequest.getAll()), this.cleanupDuplicatePairings = async (r) => {
      if (r.pairingTopic)
        try {
      ...
      if (pt(i) || await this.isValidPairingTopic(i), !Hp(c, !0)) {
      ...
      if (await this.isValidProposalId(i), !Wp(s)) {
      ...
      const c = Mp(s, "onSessionSettleRequest()");
      if (c)
      ...
      if (await this.isValidSessionTopic(i), !Gp(s)) {
...
class g1 extends ki {
  constructor(e, r) {
    super(e, r, i1, rn), this.core = e, this.logger = r;
  }
}
class y1 extends ki {
  constructor(e, r) {
    super(e, r, n1, rn), this.core = e, this.logger = r;
  }
}
class b1 extends ki {
  constructor(e, r) {
    super(e, r, a1, rn, (i) => i.id), this.core = e, this.logger = r;
  }
}
class sn extends ll {
  constructor(e) {
    ...
    }, this.name = (e == null ? void 0 : e.name) || ls.name, this.metadata = (e == null ? void 0 : e.metadata) || cp();
    ...
    this.core = (e == null ? void 0 : e.core) || new r1(e), this.logger = me.generateChildLogger(r, this.name), this.session = new y1(this.core, this.logger), this.proposal = new g1(this.core, this.logger), this.pendingRequest = new b1(this.core, this.logger), this.engine = new p1(this);
  }
  static async init(e) {
    const r = new sn(e);
...
var w1 = Object.defineProperty, m1 = Object.defineProperties, v1 = Object.getOwnPropertyDescriptors, ea = Object.getOwnPropertySymbols, _1 = Object.prototype.hasOwnProperty, E1 = Object.prototype.propertyIsEnumerable, ta = (t, e, r) => e in t ? w1(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, D1 = (t, e) => {
  for (var r in e || (e = {}))
    _1.call(e, r) && ta(t, r, e[r]);
  if (ea)
    for (var r of ea(e))
      E1.call(e, r) && ta(t, r, e[r]);
  return t;
}, S1 = (t, e) => m1(t, v1(e)), nn = (t, e, r) => {
  if (!e.has(t))
...
pr = /* @__PURE__ */ new WeakMap(), Or = /* @__PURE__ */ new WeakMap(), Jr = /* @__PURE__ */ new WeakMap(), et = /* @__PURE__ */ new WeakMap(), Rs = /* @__PURE__ */ new WeakSet(), Ic = function() {
  ...
  return new sh(S1(D1({}, t), { projectId: e }));
...
const xc = [
  ...
  "importSharedState",
  "requestSignature"
], on = ["aleo:1"], Oc = ["chainChanged", "accountSelected", "accountSynced"], x1 = "f0aaeffe71b636da453fce042d79d723", O1 = {
  standaloneChains: on,
  enableExplorer: !1,
  enableAccountView: !0,
  enableNetworkView: !0,
...
const ia = (t) => t.length < 5 * 2 ? t : `${t.slice(0, 5 + 5)}...${t.slice(
  t.length - 5,
  t.length
)}`, J1 = () => {
  ...
  "debug"
], sa = Fu.version, T1 = localStorage.getItem("puzzle-sdk-version");
sa !== T1 && (N1.forEach((t) => {
  localStorage.removeItem(t);
}), localStorage.setItem("puzzle-sdk-version", sa));
export {
  eb as A,
  tb as B,
  rb as C,
