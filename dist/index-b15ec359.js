...
const th = "@puzzlehq/sdk", rh = "Puzzle SDK", nh = "0.1.36", ih = "Your portal to privacy", sh = "./dist/puzzle.cjs.js", oh = "./dist/puzzle.es.js", ah = "./dist/puzzle.umd.js", ch = "./dist/types/src/index.d.ts", uh = {
  ".": {
...
let Bh = class {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-9e3c91e9.js");
