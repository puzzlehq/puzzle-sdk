...
function Il() {
  ...
  function u(a, l, f) {
    var h, b = {}, E = null, m = null;
    f !== void 0 && (E = "" + f), l.key !== void 0 && (E = "" + l.key), l.ref !== void 0 && (m = l.ref);
    for (h in l)
      i.call(l, h) && !s.hasOwnProperty(h) && (b[h] = l[h]);
    if (a && a.defaultProps)
      for (h in l = a.defaultProps, l)
        b[h] === void 0 && (b[h] = l[h]);
    return { $$typeof: t, type: a, key: E, ref: m, props: b, _owner: n.current };
  }
...
function xl() {
  return bo || (bo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function U(v) {
      return !!(typeof v == "string" || typeof v == "function" || v === i || v === s || p || v === n || v === f || v === h || o || v === m || g || _ || d || typeof v == "object" && v !== null && (v.$$typeof === E || v.$$typeof === b || v.$$typeof === u || v.$$typeof === a || v.$$typeof === l || // This needs to include all possible module reference object
    ...
    var w = Object.assign, T = 0, G, V, z, k, j, W, oe;
    function H() {
    }
...
` + _e[Ke].replace(" at new ", " at ");
    ...
    function ce(v) {
      if (pe(v))
        return S("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", ge(v)), ue(v);
    }
    ...
    var Mt = function(v, M, J, se, Ae, Se, Oe) {
      var _e = {
    ...
    function Me(v, M) {
      {
        ...
        Ve[J] = !0;
        var se = "";
        v && v._owner && v._owner !== ft.current && (se = " It was passed a child from " + q(v._owner.type) + "."), jt(v), S('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', J, se), jt(null);
      }
    }
    function Qe(v, M) {
      {
    ...
    function rt(v) {
      {
        for (var M = Object.keys(v.props), J = 0; J < M.length; J++) {
          ...
          if (se !== "children" && se !== "key") {
            jt(v), S("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", se), jt(null);
            break;
          }
        }
    ...
    function Ze(v, M, J, se, Ae, Se) {
      {
        ...
        if (!Oe) {
          ...
          ht ? _e += ht : _e += Fe();
          var Ke;
          v === null ? Ke = "null" : de(v) ? Ke = "array" : v !== void 0 && v.$$typeof === t ? (Ke = "<" + (q(v.type) || "Unknown") + " />", _e = " Did you accidentally export a JSX literal instead of a component?") : Ke = typeof v, S("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Ke, _e);
        }
        var Ye = Qt(v, M, J, Ae, Se);
        if (Ye == null)
          return Ye;
        if (Oe) {
          var nt = M.children;
...
const Rl = Symbol(), vo = Object.getPrototypeOf, Yn = /* @__PURE__ */ new WeakMap(), Al = (e) => e && (Yn.has(e) ? Yn.get(e) : vo(e) === Object.prototype || vo(e) === Array.prototype), Tl = (e) => Al(e) && e[Rl] || null, mo = (e, t = !0) => {
  ...
  if (b)
    return b;
  let E = l[0];
  const m = /* @__PURE__ */ new Set(), D = ($, F = ++l[0]) => {
    E !== F && (E = F, m.forEach((q) => q($, F)));
  };
  let x = l[1];
  const N = ($ = ++l[1]) => (x !== $ && !m.size && (x = $, S.forEach(([F]) => {
    const q = F[1]($);
    q > E && (E = q);
  })), E), B = ($) => (F, q) => {
    const w = [...F];
    w[1] = [$, ...w[1]], D(w, q);
  }, S = /* @__PURE__ */ new Map(), I = ($, F) => {
    if (m.size) {
      const q = F[3](B($));
      S.set($, [F, q]);
    } else
  ...
  }, _ = ($) => (m.add($), m.size === 1 && S.forEach(([q, w], T) => {
    const G = q[3](B(T));
    S.set(T, [q, G]);
  }), () => {
    m.delete($), m.size === 0 && S.forEach(([q, w], T) => {
      w && (w(), S.set(T, [q]));
    });
    ...
    if (w instanceof Promise)
      w.then((V) => {
        w.status = "fulfilled", w.value = V, D(["resolve", [q], V]);
      }).catch((V) => {
        w.status = "rejected", w.reason = V, D(["reject", [q], V]);
      });
    else {
      !gr.has(w) && r(w) && (G = f(w));
...
let Yl = class {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-065c9e63.js");
...
function pf(e, t, r) {
  ...
  function b(E, m) {
    E(m), s.shift(), s.length && a(s[0][0], s[0][1]);
  }
}
function gf(e) {
  var t, r;
...
function kf() {
  ...
  function t(r, i, n) {
    ...
    if (h === 0)
      return r;
    for (var b = "", E = 1 - u, m = -1, D = r && r.length || 0, x = 0; x < D; ) {
      if (r.charCodeAt(x) === 37 && x + 1 < D) {
        switch (m = m > -1 ? m : 0, r.charCodeAt(x + 1)) {
          ...
          case 102:
            if (E >= h || i[E] == null)
              break;
            m < x && (b += r.slice(m, x)), b += Number(i[E]), m = x + 2, x++;
            break;
          case 105:
            if (E >= h || i[E] == null)
              break;
            m < x && (b += r.slice(m, x)), b += Math.floor(Number(i[E])), m = x + 2, x++;
            break;
          case 79:
          case 111:
          case 106:
          ...
          case 115:
            if (E >= h)
              break;
            m < x && (b += r.slice(m, x)), b += String(i[E]), m = x + 2, x++;
            break;
          case 37:
            m < x && (b += r.slice(m, x)), b += "%", m = x + 2, x++, E--;
            break;
        }
        ++E;
      }
...
function Wf() {
  ...
  function n(d) {
    ...
    w.log || (w.log = N), Object.defineProperty(w, "levelVal", {
      get: G
    ...
    w.levels = n.levels, w.level = q, w.setMaxListeners = w.getMaxListeners = w.emit = w.addListener = w.on = w.prependListener = w.once = w.prependOnceListener = w.removeListener = w.removeAllListeners = w.listeners = w.listenerCount = w.eventNames = w.write = w.flush = N, w.serializers = L, w._serialize = U, w._stdErrSerialize = $, w.child = k, o && (w._logEvent = b());
    function G() {
    ...
    function z(j) {
      ...
      this._level = j, s(T, w, "error", "log"), s(T, w, "fatal", "error"), s(T, w, "warn", "error"), s(T, w, "info", "log"), s(T, w, "debug", "log"), s(T, w, "trace", "log");
    }
    function k(j, W) {
      if (!j)
  ...
  }, n.stdSerializers = r, n.stdTimeFunctions = Object.assign({}, { nullTime: B, epochTime: S, unixTime: I, isoTime: g });
  function s(d, o, p, L) {
...
(function(e) {
  ...
  function a(f, h = u, b = e.defaultRandomSource) {
    ...
    for (; f > 0; ) {
      ...
      for (let N = 0; N < x.length && f > 0; N++) {
        const B = x[N];
        B < D && (E += h.charAt(B % m), f--);
      }
      (0, i.wipe)(x);
    }
    return E;
...
(function(e) {
  ...
  var i = (
    ...
    function() {
      ...
      return a.prototype._initState = function() {
        ...
        if (!this._finished) {
          var f = this._bytesHashed, h = this._bufferLength, b = f / 536870912 | 0, E = f << 3, m = f % 128 < 112 ? 128 : 256;
          this._buffer[h] = 128;
          for (var D = h + 1; D < m - 8; D++)
            this._buffer[D] = 0;
          t.writeUint32BE(b, this._buffer, m - 8), t.writeUint32BE(E, this._buffer, m - 4), s(this._tempHi, this._tempLo, this._stateHi, this._stateLo, this._buffer, 0, m), this._finished = !0;
        }
  ...
  function s(a, l, f, h, b, E, m) {
    for (var D = f[0], x = f[1], N = f[2], B = f[3], S = f[4], I = f[5], g = f[6], _ = f[7], d = h[0], o = h[1], p = h[2], L = h[3], U = h[4], $ = h[5], F = h[6], q = h[7], w, T, G, V, z, k, j, W; m >= 128; ) {
      for (var oe = 0; oe < 16; oe++) {
        var H = 8 * oe + E;
        a[oe] = t.readUint32BE(b, H), l[oe] = t.readUint32BE(b, H + 4);
      }
      for (var oe = 0; oe < 80; oe++) {
        var ie = D, Z = x, re = N, P = B, C = S, R = I, c = g, O = _, Y = d, Q = o, be = p, ve = L, he = U, Ie = $, Be = F, Le = q;
        if (w = _, T = q, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = (S >>> 14 | U << 32 - 14) ^ (S >>> 18 | U << 32 - 18) ^ (U >>> 41 - 32 | S << 32 - (41 - 32)), T = (U >>> 14 | S << 32 - 14) ^ (U >>> 18 | S << 32 - 18) ^ (S >>> 41 - 32 | U << 32 - (41 - 32)), z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, w = S & I ^ ~S & g, T = U & $ ^ ~U & F, z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, w = n[oe * 2], T = n[oe * 2 + 1], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, w = a[oe % 16], T = l[oe % 16], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, G = j & 65535 | W << 16, V = z & 65535 | k << 16, w = G, T = V, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = (D >>> 28 | d << 32 - 28) ^ (d >>> 34 - 32 | D << 32 - (34 - 32)) ^ (d >>> 39 - 32 | D << 32 - (39 - 32)), T = (d >>> 28 | D << 32 - 28) ^ (D >>> 34 - 32 | d << 32 - (34 - 32)) ^ (D >>> 39 - 32 | d << 32 - (39 - 32)), z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, w = D & x ^ D & N ^ x & N, T = d & o ^ d & p ^ o & p, z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, O = j & 65535 | W << 16, Le = z & 65535 | k << 16, w = P, T = ve, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = G, T = V, z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, P = j & 65535 | W << 16, ve = z & 65535 | k << 16, x = ie, N = Z, B = re, S = P, I = C, g = R, _ = c, D = O, o = Y, p = Q, L = be, U = ve, $ = he, F = Ie, q = Be, d = Le, oe % 16 === 15)
          for (var H = 0; H < 16; H++)
            w = a[H], T = l[H], z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = a[(H + 9) % 16], T = l[(H + 9) % 16], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, G = a[(H + 1) % 16], V = l[(H + 1) % 16], w = (G >>> 1 | V << 32 - 1) ^ (G >>> 8 | V << 32 - 8) ^ G >>> 7, T = (V >>> 1 | G << 32 - 1) ^ (V >>> 8 | G << 32 - 8) ^ (V >>> 7 | G << 32 - 7), z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, G = a[(H + 14) % 16], V = l[(H + 14) % 16], w = (G >>> 19 | V << 32 - 19) ^ (V >>> 61 - 32 | G << 32 - (61 - 32)) ^ G >>> 6, T = (V >>> 19 | G << 32 - 19) ^ (G >>> 61 - 32 | V << 32 - (61 - 32)) ^ (V >>> 6 | G << 32 - 6), z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, a[H] = j & 65535 | W << 16, l[H] = z & 65535 | k << 16;
      }
      w = D, T = d, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = f[0], T = h[0], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, f[0] = D = j & 65535 | W << 16, h[0] = d = z & 65535 | k << 16, w = x, T = o, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = f[1], T = h[1], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, f[1] = x = j & 65535 | W << 16, h[1] = o = z & 65535 | k << 16, w = N, T = p, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = f[2], T = h[2], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, f[2] = N = j & 65535 | W << 16, h[2] = p = z & 65535 | k << 16, w = B, T = L, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = f[3], T = h[3], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, f[3] = B = j & 65535 | W << 16, h[3] = L = z & 65535 | k << 16, w = S, T = U, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = f[4], T = h[4], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, f[4] = S = j & 65535 | W << 16, h[4] = U = z & 65535 | k << 16, w = I, T = $, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = f[5], T = h[5], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, f[5] = I = j & 65535 | W << 16, h[5] = $ = z & 65535 | k << 16, w = g, T = F, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = f[6], T = h[6], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, f[6] = g = j & 65535 | W << 16, h[6] = F = z & 65535 | k << 16, w = _, T = q, z = T & 65535, k = T >>> 16, j = w & 65535, W = w >>> 16, w = f[7], T = h[7], z += T & 65535, k += T >>> 16, j += w & 65535, W += w >>> 16, k += z >>> 16, j += k >>> 16, W += j >>> 16, f[7] = _ = j & 65535 | W << 16, h[7] = q = z & 65535 | k << 16, E += 128, m -= 128;
    }
    return E;
  }
  function u(a) {
...
(function(e) {
  ...
  function D(P) {
    ...
    for (let R = 0; R < 16; R++) {
      let c = P[R] + C + 65535;
      C = Math.floor(c / 65536), P[R] = c - C * 65536;
    }
    P[0] += C - 1 + 37 * (C - 1);
  }
  function x(P, C, R) {
  ...
  function $(P, C) {
    ...
    d(R, P[1], P[0]), d(Ie, C[1], C[0]), o(R, R, Ie), _(c, P[0], P[1]), _(Ie, C[0], C[1]), o(c, c, Ie), o(O, P[3], C[3]), o(O, O, f), o(Y, P[2], C[2]), _(Y, Y, Y), d(Q, c, R), d(be, Y, O), _(ve, Y, O), _(he, c, R), o(P[0], Q, be), o(P[1], he, ve), o(P[2], ve, be), o(P[3], Q, he);
  }
  function F(P, C, R) {
    for (let c = 0; c < 4; c++)
      x(P[c], C[c], R);
  ...
  function q(P, C) {
    const R = n(), c = n(), O = n();
    L(O, C[2]), o(R, C[0], O), o(c, C[1], O), N(P, c), P[31] ^= I(R) << 7;
  }
  function w(P, C, R) {
    m(P[0], u), m(P[1], a), m(P[2], a), m(P[3], u);
    for (let c = 255; c >= 0; --c) {
      const O = R[c / 8 | 0] >> (c & 7) & 1;
      F(P, C, O), $(C, P), $(P, P), F(P, C, O);
    }
  }
  function T(P, C) {
    const R = [n(), n(), n(), n()];
    m(R[0], h), m(R[1], b), m(R[2], a), o(R[3], h, b), w(P, R, C);
  }
  function G(P) {
  ...
  function V(P) {
    const C = (0, t.randomBytes)(32, P), R = G(C);
    return (0, i.wipe)(C), R;
  }
  e.generateKeyPair = V;
  function z(P) {
  ...
  function oe(P, C) {
    const R = new Float64Array(64), c = [n(), n(), n(), n()], O = (0, r.hash)(P.subarray(0, 32));
    ...
    for (let he = 0; he < 32; he++)
      for (let Ie = 0; Ie < 32; Ie++)
        R[he + Ie] += ve[he] * O[Ie];
    return j(Y.subarray(32), R), Y;
  }
  e.sign = oe;
  function H(P, C) {
    const R = n(), c = n(), O = n(), Y = n(), Q = n(), be = n(), ve = n();
    return m(P[2], a), g(P[1], C), p(O, P[1]), o(Y, O, l), d(O, O, P[2]), _(Y, P[2], Y), p(Q, Y), p(be, Q), o(ve, be, Q), o(R, ve, O), o(R, R, Y), U(R, R), o(R, R, O), o(R, R, Y), o(R, R, Y), o(P[0], R, Y), p(c, P[0]), o(c, c, Y), S(c, O) && o(P[0], P[0], E), p(c, P[0]), o(c, c, Y), S(c, O) ? -1 : (I(P[0]) === C[31] >> 7 && d(P[0], u, P[0]), o(P[3], P[0], P[1]), 0);
  }
  function ie(P, C, R) {
    ...
    if (H(Y, P))
      return !1;
    const Q = new r.SHA512();
    Q.update(R.subarray(0, 32)), Q.update(P), Q.update(C);
    const be = Q.digest();
    return W(be), w(O, Y, be), T(Y, R.subarray(32)), $(O, Y), q(c, O), !B(R, c);
  }
  e.verify = ie;
  function Z(P) {
    let C = [n(), n(), n(), n()];
...
function Gh(e, t) {
  ...
  function b(D) {
    ...
    if (D.length === 0)
      return "";
    for (var x = 0, N = 0, B = 0, S = D.length; B !== S && D[B] === 0; )
      B++, x++;
    for (var I = (S - B) * h + 1 >>> 0, g = new Uint8Array(I); B !== S; ) {
      for (var _ = D[B], d = 0, o = I - 1; (_ !== 0 || d < N) && o !== -1; o--, d++)
  ...
  function E(D) {
    ...
    var x = 0;
    if (D[x] !== " ") {
      for (var N = 0, B = 0; D[x] === l; )
        N++, x++;
      for (var S = (D.length - x) * f + 1 >>> 0, I = new Uint8Array(S); D[x]; ) {
        var g = r[D.charCodeAt(x)];
        if (g === 255)
          return;
        for (var _ = 0, d = S - 1; (g !== 0 || _ < B) && d !== -1; d--, _++)
...
function Yd(e, t, r) {
  for (var i = 1634760805, n = 857760878, s = 2036477234, u = 1797285236, a = r[3] << 24 | r[2] << 16 | r[1] << 8 | r[0], l = r[7] << 24 | r[6] << 16 | r[5] << 8 | r[4], f = r[11] << 24 | r[10] << 16 | r[9] << 8 | r[8], h = r[15] << 24 | r[14] << 16 | r[13] << 8 | r[12], b = r[19] << 24 | r[18] << 16 | r[17] << 8 | r[16], E = r[23] << 24 | r[22] << 16 | r[21] << 8 | r[20], m = r[27] << 24 | r[26] << 16 | r[25] << 8 | r[24], D = r[31] << 24 | r[30] << 16 | r[29] << 8 | r[28], x = t[3] << 24 | t[2] << 16 | t[1] << 8 | t[0], N = t[7] << 24 | t[6] << 16 | t[5] << 8 | t[4], B = t[11] << 24 | t[10] << 16 | t[9] << 8 | t[8], S = t[15] << 24 | t[14] << 16 | t[13] << 8 | t[12], I = i, g = n, _ = s, d = u, o = a, p = l, L = f, U = h, $ = b, F = E, q = m, w = D, T = x, G = N, V = B, z = S, k = 0; k < Gd; k += 2)
  ...
  mt.writeUint32LE(I + i | 0, e, 0), mt.writeUint32LE(g + n | 0, e, 4), mt.writeUint32LE(_ + s | 0, e, 8), mt.writeUint32LE(d + u | 0, e, 12), mt.writeUint32LE(o + a | 0, e, 16), mt.writeUint32LE(p + l | 0, e, 20), mt.writeUint32LE(L + f | 0, e, 24), mt.writeUint32LE(U + h | 0, e, 28), mt.writeUint32LE($ + b | 0, e, 32), mt.writeUint32LE(F + E | 0, e, 36), mt.writeUint32LE(q + m | 0, e, 40), mt.writeUint32LE(w + D | 0, e, 44), mt.writeUint32LE(T + x | 0, e, 48), mt.writeUint32LE(G + N | 0, e, 52), mt.writeUint32LE(V + B | 0, e, 56), mt.writeUint32LE(z + S | 0, e, 60);
}
  ...
  var i = (
    ...
    function() {
      ...
      return u.prototype._blocks = function(a, l, f) {
        for (var h = this._fin ? 0 : 2048, b = this._h[0], E = this._h[1], m = this._h[2], D = this._h[3], x = this._h[4], N = this._h[5], B = this._h[6], S = this._h[7], I = this._h[8], g = this._h[9], _ = this._r[0], d = this._r[1], o = this._r[2], p = this._r[3], L = this._r[4], U = this._r[5], $ = this._r[6], F = this._r[7], q = this._r[8], w = this._r[9]; f >= 16; ) {
          var T = a[l + 0] | a[l + 1] << 8;
          b += T & 8191;
          var G = a[l + 2] | a[l + 3] << 8;
          E += (T >>> 13 | G << 3) & 8191;
          ...
          var H = 0, ie = H;
          ie += b * _, ie += E * (5 * w), ie += m * (5 * q), ie += D * (5 * F), ie += x * (5 * $), H = ie >>> 13, ie &= 8191, ie += N * (5 * U), ie += B * (5 * L), ie += S * (5 * p), ie += I * (5 * o), ie += g * (5 * d), H += ie >>> 13, ie &= 8191;
          var Z = H;
          Z += b * d, Z += E * _, Z += m * (5 * w), Z += D * (5 * q), Z += x * (5 * F), H = Z >>> 13, Z &= 8191, Z += N * (5 * $), Z += B * (5 * U), Z += S * (5 * L), Z += I * (5 * p), Z += g * (5 * o), H += Z >>> 13, Z &= 8191;
          var re = H;
          re += b * o, re += E * d, re += m * _, re += D * (5 * w), re += x * (5 * q), H = re >>> 13, re &= 8191, re += N * (5 * F), re += B * (5 * $), re += S * (5 * U), re += I * (5 * L), re += g * (5 * p), H += re >>> 13, re &= 8191;
          var P = H;
          P += b * p, P += E * o, P += m * d, P += D * _, P += x * (5 * w), H = P >>> 13, P &= 8191, P += N * (5 * q), P += B * (5 * F), P += S * (5 * $), P += I * (5 * U), P += g * (5 * L), H += P >>> 13, P &= 8191;
          var C = H;
          C += b * L, C += E * p, C += m * o, C += D * d, C += x * _, H = C >>> 13, C &= 8191, C += N * (5 * w), C += B * (5 * q), C += S * (5 * F), C += I * (5 * $), C += g * (5 * U), H += C >>> 13, C &= 8191;
          var R = H;
          R += b * U, R += E * L, R += m * p, R += D * o, R += x * d, H = R >>> 13, R &= 8191, R += N * _, R += B * (5 * w), R += S * (5 * q), R += I * (5 * F), R += g * (5 * $), H += R >>> 13, R &= 8191;
          var c = H;
          c += b * $, c += E * U, c += m * L, c += D * p, c += x * o, H = c >>> 13, c &= 8191, c += N * d, c += B * _, c += S * (5 * w), c += I * (5 * q), c += g * (5 * F), H += c >>> 13, c &= 8191;
          var O = H;
          O += b * F, O += E * $, O += m * U, O += D * L, O += x * p, H = O >>> 13, O &= 8191, O += N * o, O += B * d, O += S * _, O += I * (5 * w), O += g * (5 * q), H += O >>> 13, O &= 8191;
          var Y = H;
          Y += b * q, Y += E * F, Y += m * $, Y += D * U, Y += x * L, H = Y >>> 13, Y &= 8191, Y += N * p, Y += B * o, Y += S * d, Y += I * _, Y += g * (5 * w), H += Y >>> 13, Y &= 8191;
          var Q = H;
          Q += b * w, Q += E * q, Q += m * F, Q += D * $, Q += x * U, H = Q >>> 13, Q &= 8191, Q += N * L, Q += B * p, Q += S * o, Q += I * d, Q += g * _, H += Q >>> 13, Q &= 8191, H = (H << 2) + H | 0, H = H + ie | 0, ie = H & 8191, H = H >>> 13, Z += H, b = ie, E = Z, m = re, D = P, x = C, N = R, B = c, S = O, I = Y, g = Q, l += 16, f -= 16;
        }
        this._h[0] = b, this._h[1] = E, this._h[2] = m, this._h[3] = D, this._h[4] = x, this._h[5] = N, this._h[6] = B, this._h[7] = S, this._h[8] = I, this._h[9] = g;
      }, u.prototype.finish = function(a, l) {
        l === void 0 && (l = 0);
        var f = new Uint16Array(10), h, b, E, m;
        if (this._leftover) {
        ...
        for (f[9] -= 8192, b = (h ^ 1) - 1, m = 0; m < 10; m++)
          f[m] &= b;
        for (b = ~b, m = 0; m < 10; m++)
          this._h[m] = this._h[m] & b | f[m];
        for (this._h[0] = (this._h[0] | this._h[1] << 13) & 65535, this._h[1] = (this._h[1] >>> 3 | this._h[2] << 10) & 65535, this._h[2] = (this._h[2] >>> 6 | this._h[3] << 7) & 65535, this._h[3] = (this._h[3] >>> 9 | this._h[4] << 4) & 65535, this._h[4] = (this._h[4] >>> 12 | this._h[5] << 1 | this._h[6] << 14) & 65535, this._h[5] = (this._h[6] >>> 2 | this._h[7] << 11) & 65535, this._h[6] = (this._h[7] >>> 5 | this._h[8] << 8) & 65535, this._h[7] = (this._h[8] >>> 8 | this._h[9] << 5) & 65535, E = this._h[0] + this._pad[0], this._h[0] = E & 65535, m = 1; m < 8; m++)
          E = (this._h[m] + this._pad[m] | 0) + (E >>> 16) | 0, this._h[m] = E & 65535;
  ...
  var u = new Uint8Array(16), a = (
    ...
    function() {
      ...
      return l.prototype.seal = function(f, h, b, E) {
        ...
        var x = h.length + this.tagLength, N;
        if (E) {
          if (E.length !== x)
          ...
          N = new Uint8Array(x);
        return t.streamXOR(this._key, m, h, N, 4), this._authenticate(N.subarray(N.length - this.tagLength, N.length), D, N.subarray(0, N.length - this.tagLength), b), i.wipe(m), N;
        ...
        if (E) {
          ...
          B = new Uint8Array(N);
        return t.streamXOR(this._key, m, h.subarray(0, h.length - this.tagLength), B, 4), i.wipe(m), B;
      }, l.prototype.clean = function() {
        return i.wipe(this._key), this;
      }, l.prototype._authenticate = function(f, h, b, E) {
        var m = new r.Poly1305(h);
        E && (m.update(E), E.length % 16 > 0 && m.update(u.subarray(E.length % 16))), m.update(b), b.length % 16 > 0 && m.update(u.subarray(b.length % 16));
        var D = new Uint8Array(8);
        E && n.writeUint64LE(E.length, D), m.update(D), n.writeUint64LE(b.length, D), m.update(D);
        for (var x = m.digest(), N = 0; N < x.length; N++)
          f[N] = x[N];
        m.clean(), i.wipe(x), i.wipe(D);
      }, l;
    }()
  );
...
(function(e) {
  ...
  var i = (
    ...
    function() {
      ...
      return a.prototype._initState = function() {
        ...
        if (!this._finished) {
          var f = this._bytesHashed, h = this._bufferLength, b = f / 536870912 | 0, E = f << 3, m = f % 64 < 56 ? 64 : 128;
          this._buffer[h] = 128;
          for (var D = h + 1; D < m - 8; D++)
            this._buffer[D] = 0;
          t.writeUint32BE(b, this._buffer, m - 8), t.writeUint32BE(E, this._buffer, m - 4), s(this._temp, this._state, this._buffer, 0, m), this._finished = !0;
        }
  ...
  function s(a, l, f, h, b) {
    for (; b >= 64; ) {
      for (var E = l[0], m = l[1], D = l[2], x = l[3], N = l[4], B = l[5], S = l[6], I = l[7], g = 0; g < 16; g++) {
        var _ = h + g * 4;
      ...
      for (var g = 0; g < 64; g++) {
        var o = (((N >>> 6 | N << 26) ^ (N >>> 11 | N << 21) ^ (N >>> 25 | N << 7)) + (N & B ^ ~N & S) | 0) + (I + (n[g] + a[g] | 0) | 0) | 0, p = ((E >>> 2 | E << 32 - 2) ^ (E >>> 13 | E << 32 - 13) ^ (E >>> 22 | E << 32 - 22)) + (E & m ^ E & D ^ m & D) | 0;
        I = S, S = B, B = N, N = x + o | 0, x = D, D = m, m = E, E = o + p | 0;
      }
      l[0] += E, l[1] += m, l[2] += D, l[3] += x, l[4] += N, l[5] += B, l[6] += S, l[7] += I, h += 64, b -= 64;
    }
    return h;
  }
  function u(a) {
...
(function(e) {
  ...
  function E(g, _, d) {
    let o, p, L = 0, U = 0, $ = 0, F = 0, q = 0, w = 0, T = 0, G = 0, V = 0, z = 0, k = 0, j = 0, W = 0, oe = 0, H = 0, ie = 0, Z = 0, re = 0, P = 0, C = 0, R = 0, c = 0, O = 0, Y = 0, Q = 0, be = 0, ve = 0, he = 0, Ie = 0, Be = 0, Le = 0, De = d[0], we = d[1], de = d[2], ge = d[3], pe = d[4], ue = d[5], ce = d[6], ne = d[7], ye = d[8], me = d[9], ae = d[10], Ee = d[11], xe = d[12], Ce = d[13], Pe = d[14], Re = d[15];
    o = _[0], L += o * De, U += o * we, $ += o * de, F += o * ge, q += o * pe, w += o * ue, T += o * ce, G += o * ne, V += o * ye, z += o * me, k += o * ae, j += o * Ee, W += o * xe, oe += o * Ce, H += o * Pe, ie += o * Re, o = _[1], U += o * De, $ += o * we, F += o * de, q += o * ge, w += o * pe, T += o * ue, G += o * ce, V += o * ne, z += o * ye, k += o * me, j += o * ae, W += o * Ee, oe += o * xe, H += o * Ce, ie += o * Pe, Z += o * Re, o = _[2], $ += o * De, F += o * we, q += o * de, w += o * ge, T += o * pe, G += o * ue, V += o * ce, z += o * ne, k += o * ye, j += o * me, W += o * ae, oe += o * Ee, H += o * xe, ie += o * Ce, Z += o * Pe, re += o * Re, o = _[3], F += o * De, q += o * we, w += o * de, T += o * ge, G += o * pe, V += o * ue, z += o * ce, k += o * ne, j += o * ye, W += o * me, oe += o * ae, H += o * Ee, ie += o * xe, Z += o * Ce, re += o * Pe, P += o * Re, o = _[4], q += o * De, w += o * we, T += o * de, G += o * ge, V += o * pe, z += o * ue, k += o * ce, j += o * ne, W += o * ye, oe += o * me, H += o * ae, ie += o * Ee, Z += o * xe, re += o * Ce, P += o * Pe, C += o * Re, o = _[5], w += o * De, T += o * we, G += o * de, V += o * ge, z += o * pe, k += o * ue, j += o * ce, W += o * ne, oe += o * ye, H += o * me, ie += o * ae, Z += o * Ee, re += o * xe, P += o * Ce, C += o * Pe, R += o * Re, o = _[6], T += o * De, G += o * we, V += o * de, z += o * ge, k += o * pe, j += o * ue, W += o * ce, oe += o * ne, H += o * ye, ie += o * me, Z += o * ae, re += o * Ee, P += o * xe, C += o * Ce, R += o * Pe, c += o * Re, o = _[7], G += o * De, V += o * we, z += o * de, k += o * ge, j += o * pe, W += o * ue, oe += o * ce, H += o * ne, ie += o * ye, Z += o * me, re += o * ae, P += o * Ee, C += o * xe, R += o * Ce, c += o * Pe, O += o * Re, o = _[8], V += o * De, z += o * we, k += o * de, j += o * ge, W += o * pe, oe += o * ue, H += o * ce, ie += o * ne, Z += o * ye, re += o * me, P += o * ae, C += o * Ee, R += o * xe, c += o * Ce, O += o * Pe, Y += o * Re, o = _[9], z += o * De, k += o * we, j += o * de, W += o * ge, oe += o * pe, H += o * ue, ie += o * ce, Z += o * ne, re += o * ye, P += o * me, C += o * ae, R += o * Ee, c += o * xe, O += o * Ce, Y += o * Pe, Q += o * Re, o = _[10], k += o * De, j += o * we, W += o * de, oe += o * ge, H += o * pe, ie += o * ue, Z += o * ce, re += o * ne, P += o * ye, C += o * me, R += o * ae, c += o * Ee, O += o * xe, Y += o * Ce, Q += o * Pe, be += o * Re, o = _[11], j += o * De, W += o * we, oe += o * de, H += o * ge, ie += o * pe, Z += o * ue, re += o * ce, P += o * ne, C += o * ye, R += o * me, c += o * ae, O += o * Ee, Y += o * xe, Q += o * Ce, be += o * Pe, ve += o * Re, o = _[12], W += o * De, oe += o * we, H += o * de, ie += o * ge, Z += o * pe, re += o * ue, P += o * ce, C += o * ne, R += o * ye, c += o * me, O += o * ae, Y += o * Ee, Q += o * xe, be += o * Ce, ve += o * Pe, he += o * Re, o = _[13], oe += o * De, H += o * we, ie += o * de, Z += o * ge, re += o * pe, P += o * ue, C += o * ce, R += o * ne, c += o * ye, O += o * me, Y += o * ae, Q += o * Ee, be += o * xe, ve += o * Ce, he += o * Pe, Ie += o * Re, o = _[14], H += o * De, ie += o * we, Z += o * de, re += o * ge, P += o * pe, C += o * ue, R += o * ce, c += o * ne, O += o * ye, Y += o * me, Q += o * ae, be += o * Ee, ve += o * xe, he += o * Ce, Ie += o * Pe, Be += o * Re, o = _[15], ie += o * De, Z += o * we, re += o * de, P += o * ge, C += o * pe, R += o * ue, c += o * ce, O += o * ne, Y += o * ye, Q += o * me, be += o * ae, ve += o * Ee, he += o * xe, Ie += o * Ce, Be += o * Pe, Le += o * Re, L += 38 * Z, U += 38 * re, $ += 38 * P, F += 38 * C, q += 38 * R, w += 38 * c, T += 38 * O, G += 38 * Y, V += 38 * Q, z += 38 * be, k += 38 * ve, j += 38 * he, W += 38 * Ie, oe += 38 * Be, H += 38 * Le, p = 1, o = L + p + 65535, p = Math.floor(o / 65536), L = o - p * 65536, o = U + p + 65535, p = Math.floor(o / 65536), U = o - p * 65536, o = $ + p + 65535, p = Math.floor(o / 65536), $ = o - p * 65536, o = F + p + 65535, p = Math.floor(o / 65536), F = o - p * 65536, o = q + p + 65535, p = Math.floor(o / 65536), q = o - p * 65536, o = w + p + 65535, p = Math.floor(o / 65536), w = o - p * 65536, o = T + p + 65535, p = Math.floor(o / 65536), T = o - p * 65536, o = G + p + 65535, p = Math.floor(o / 65536), G = o - p * 65536, o = V + p + 65535, p = Math.floor(o / 65536), V = o - p * 65536, o = z + p + 65535, p = Math.floor(o / 65536), z = o - p * 65536, o = k + p + 65535, p = Math.floor(o / 65536), k = o - p * 65536, o = j + p + 65535, p = Math.floor(o / 65536), j = o - p * 65536, o = W + p + 65535, p = Math.floor(o / 65536), W = o - p * 65536, o = oe + p + 65535, p = Math.floor(o / 65536), oe = o - p * 65536, o = H + p + 65535, p = Math.floor(o / 65536), H = o - p * 65536, o = ie + p + 65535, p = Math.floor(o / 65536), ie = o - p * 65536, L += p - 1 + 37 * (p - 1), p = 1, o = L + p + 65535, p = Math.floor(o / 65536), L = o - p * 65536, o = U + p + 65535, p = Math.floor(o / 65536), U = o - p * 65536, o = $ + p + 65535, p = Math.floor(o / 65536), $ = o - p * 65536, o = F + p + 65535, p = Math.floor(o / 65536), F = o - p * 65536, o = q + p + 65535, p = Math.floor(o / 65536), q = o - p * 65536, o = w + p + 65535, p = Math.floor(o / 65536), w = o - p * 65536, o = T + p + 65535, p = Math.floor(o / 65536), T = o - p * 65536, o = G + p + 65535, p = Math.floor(o / 65536), G = o - p * 65536, o = V + p + 65535, p = Math.floor(o / 65536), V = o - p * 65536, o = z + p + 65535, p = Math.floor(o / 65536), z = o - p * 65536, o = k + p + 65535, p = Math.floor(o / 65536), k = o - p * 65536, o = j + p + 65535, p = Math.floor(o / 65536), j = o - p * 65536, o = W + p + 65535, p = Math.floor(o / 65536), W = o - p * 65536, o = oe + p + 65535, p = Math.floor(o / 65536), oe = o - p * 65536, o = H + p + 65535, p = Math.floor(o / 65536), H = o - p * 65536, o = ie + p + 65535, p = Math.floor(o / 65536), ie = o - p * 65536, L += p - 1 + 37 * (p - 1), g[0] = L, g[1] = U, g[2] = $, g[3] = F, g[4] = q, g[5] = w, g[6] = T, g[7] = G, g[8] = V, g[9] = z, g[10] = k, g[11] = j, g[12] = W, g[13] = oe, g[14] = H, g[15] = ie;
  }
  function m(g, _) {
    E(g, _, _);
  }
  ...
  function x(g, _) {
    ...
    for (let V = 254; V >= 0; --V) {
      const z = d[V >>> 3] >>> (V & 7) & 1;
      a(p, L, z), a(U, $, z), h(F, p, U), b(p, p, U), h(U, L, $), b(L, L, $), m($, F), m(q, p), E(p, U, p), E(U, L, F), h(F, p, U), b(p, p, U), m(L, p), b(U, $, q), E(p, U, s), h(p, p, $), E(U, U, p), E(p, $, q), E($, L, o), m(L, F), a(p, L, z), a(U, $, z);
    }
    for (let V = 0; V < 16; V++)
  ...
  function S(g) {
    const _ = (0, t.randomBytes)(32, g), d = B(_);
    return (0, r.wipe)(_), d;
  }
  e.generateKeyPair = S;
  function I(g, _, d = !1) {
...
function Tp() {
  ...
  function r() {
    ...
    for (let m = 0; m < b.length; m++) {
      const D = b[m], x = D.getAttribute("rel");
  ...
  function i(...b) {
    ...
    for (let m = 0; m < E.length; m++) {
      const D = E[m], x = ["itemprop", "property", "name"].map((N) => D.getAttribute(N)).filter((N) => N ? b.includes(N) : !1);
      if (x.length && x) {
...
(function(e) {
  const t = Cp, r = Lp, i = Up, n = $p, s = (S) => S == null, u = Symbol("encodeFragmentIdentifier");
  function a(S) {
    switch (S.arrayFormat) {
      case "index":
        return (I) => (g, _) => {
          const d = g.length;
          return _ === void 0 || S.skipNull && _ === null || S.skipEmptyString && _ === "" ? g : _ === null ? [...g, [h(I, S), "[", d, "]"].join("")] : [
            ...g,
            [h(I, S), "[", h(d, S), "]=", h(_, S)].join("")
          ];
        };
      case "bracket":
        return (I) => (g, _) => _ === void 0 || S.skipNull && _ === null || S.skipEmptyString && _ === "" ? g : _ === null ? [...g, [h(I, S), "[]"].join("")] : [...g, [h(I, S), "[]=", h(_, S)].join("")];
      case "colon-list-separator":
        return (I) => (g, _) => _ === void 0 || S.skipNull && _ === null || S.skipEmptyString && _ === "" ? g : _ === null ? [...g, [h(I, S), ":list="].join("")] : [...g, [h(I, S), ":list=", h(_, S)].join("")];
      case "comma":
      case "separator":
      case "bracket-separator": {
        const I = S.arrayFormat === "bracket-separator" ? "[]=" : "=";
        return (g) => (_, d) => d === void 0 || S.skipNull && d === null || S.skipEmptyString && d === "" ? _ : (d = d === null ? "" : d, _.length === 0 ? [[h(g, S), I, h(d, S)].join("")] : [[_, h(d, S)].join(S.arrayFormatSeparator)]);
      }
      default:
        return (I) => (g, _) => _ === void 0 || S.skipNull && _ === null || S.skipEmptyString && _ === "" ? g : _ === null ? [...g, h(I, S)] : [...g, [h(I, S), "=", h(_, S)].join("")];
    }
  }
  function l(S) {
    let I;
    switch (S.arrayFormat) {
      ...
      case "separator":
        return (g, _, d) => {
          const o = typeof _ == "string" && _.includes(S.arrayFormatSeparator), p = typeof _ == "string" && !o && b(_, S).includes(S.arrayFormatSeparator);
          _ = p ? b(_, S) : _;
          const L = o || p ? _.split(S.arrayFormatSeparator).map((U) => b(U, S)) : _ === null ? _ : b(_, S);
          d[g] = L;
        };
      case "bracket-separator":
        return (g, _, d) => {
          ...
          const p = _ === null ? [] : _.split(S.arrayFormatSeparator).map((L) => b(L, S));
          if (d[g] === void 0) {
            d[g] = p;
            return;
          }
  ...
  function h(S, I) {
    return I.encode ? I.strict ? t(S) : encodeURIComponent(S) : S;
  }
  function b(S, I) {
    return I.decode ? r(S) : S;
  }
  function E(S) {
    return Array.isArray(S) ? S.sort() : typeof S == "object" ? E(Object.keys(S)).sort((I, g) => Number(I) - Number(g)).map((I) => S[I]) : S;
  }
  function m(S) {
    const I = S.indexOf("#");
    return I !== -1 && (S = S.slice(0, I)), S;
  }
  function D(S) {
    let I = "";
    const g = S.indexOf("#");
    return g !== -1 && (I = S.slice(g)), I;
  }
  function x(S) {
    S = m(S);
    const I = S.indexOf("?");
  ...
  function N(S, I) {
    return I.parseNumbers && !Number.isNaN(Number(S)) && typeof S == "string" && S.trim() !== "" ? S = Number(S) : I.parseBooleans && S !== null && (S.toLowerCase() === "true" || S.toLowerCase() === "false") && (S = S.toLowerCase() === "true"), S;
  }
  function B(S, I) {
    I = Object.assign({
      decode: !0,
  ...
  e.extract = x, e.parse = B, e.stringify = (S, I) => {
    if (!S)
      return "";
    I = Object.assign({
      encode: !0,
    ...
    const g = (p) => I.skipNull && s(S[p]) || I.skipEmptyString && S[p] === "", _ = a(I), d = {};
    ...
    const g = m(S.url).split("?")[0] || "", _ = e.extract(S.url), d = e.parse(_, { sort: !1 }), o = Object.assign(d, S.query);
    let p = e.stringify(o, I);
    p && (p = `?${p}`);
    let L = D(S.url);
    return S.fragmentIdentifier && (L = `#${I[u] ? h(S.fragmentIdentifier, I) : S.fragmentIdentifier}`), `${g}${p}${L}`;
  }, e.pick = (S, I, g) => {
    g = Object.assign({
      parseFragmentIdentifier: !0,
      [u]: !1
    }, g);
    const { url: _, query: d, fragmentIdentifier: o } = e.parseUrl(S, g);
...
function by(e, t) {
  ...
  return { encode: b, decodeUnsafe: E, decode: m };
}
var vy = by, my = vy;
const wu = (e) => {
  if (e instanceof Uint8Array && e.constructor.name === "Uint8Array")
...
class yb {
  constructor(t, r, i) {
    this.core = t, this.logger = r, this.name = K0, this.initialized = !1, this.init = async () => {
      ...
      const a = cu(u), l = Rs(s);
      if (pa(a)) {
        const E = a.senderPublicKey, m = a.receiverPublicKey;
        n = await this.generateSharedKey(E, m);
      }
...
class t1 extends nh {
  constructor(t) {
    super(t), this.name = Hb, this.events = new xc(), this.initialized = !1, this.ignoredPayloadTypes = [Fr], this.requestQueue = { state: _i.idle, requests: [] }, this.requestQueueDelay = te.ONE_SECOND, this.init = async () => {
      ...
      const E = await this.client.core.crypto.generateKeyPair(), m = zt({ requiredNamespaces: s, optionalNamespaces: u, relays: l ?? [{ protocol: Nu }], proposer: { publicKey: E, metadata: this.client.metadata } }, a && { sessionProperties: a }), { reject: D, resolve: x, done: N } = Kr(te.FIVE_MINUTES, kb);
      ...
      const B = await this.sendRequest(f, "wc_sessionPropose", m), S = Ht(te.FIVE_MINUTES);
      return await this.setProposal(B, zt({ id: B, expiry: S }, m)), { uri: h, approval: N };
      ...
      const E = await this.client.core.crypto.generateKeyPair(), m = f.publicKey, D = await this.client.core.crypto.generateSharedKey(E, m);
      ...
      const N = Mn(zt({}, x), { topic: D, pairingTopic: l, acknowledged: !1, self: x.controller, peer: { publicKey: f.publicKey, metadata: f.metadata }, controller: E });
      return await this.client.session.set(D, N), await this.setExpiry(D, Ht(ki)), { topic: D, acknowledged: () => new Promise((B) => setTimeout(() => B(this.client.session.get(D)), 500)) };
    }, this.reject = async (r) => {
      ...
      this.events.once(st("session_request", a), ({ error: E, result: m }) => {
        E ? h(E) : f(m);
      ...
      try {
        ...
        const { relay: u, controller: a, expiry: l, namespaces: f, requiredNamespaces: h, optionalNamespaces: b, sessionProperties: E, pairingTopic: m } = i.params, D = zt({ topic: r, relay: u, expiry: l, namespaces: f, acknowledged: !0, pairingTopic: m, requiredNamespaces: h, optionalNamespaces: b, controller: a.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: a.publicKey, metadata: a.metadata } }, E && { sessionProperties: E });
...
function P1() {
  ...
  function a(b, E) {
    var m = E(), D = i({ inst: { value: m, getSnapshot: E } }), x = D[0].inst, N = D[1];
    return s(function() {
      x.value = m, x.getSnapshot = E, l(x) && N({ inst: x });
    }, [b, m, E]), n(function() {
      return l(x) && N({ inst: x }), b(function() {
        l(x) && N({ inst: x });
      });
    }, [b]), u(m), m;
  }
...
function N1() {
  return sc || (sc = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(I, g, _) {
      ...
      return l(function() {
        L.value = d, L.getSnapshot = g, m(L) && U({
          inst: L
        });
      }, [I, d, g]), a(function() {
        m(L) && U({
    ...
    var x = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", N = !x, B = N ? D : E, S = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : B;
...
function L1() {
  ...
  return jn.useSyncExternalStoreWithSelector = function(f, h, b, E, m) {
    var D = s(null);
    if (D.current === null) {
    ...
    D = a(function() {
      function B(d) {
        if (!S) {
          if (S = !0, I = d, d = E(d), m !== void 0 && x.hasValue) {
            var o = x.value;
            if (m(o, d))
              return g = o;
          }
        ...
        if (o = g, i(I, d))
          return o;
        var p = E(d);
        return m !== void 0 && m(o, p) ? o : (I = d, g = p);
      }
      var S = !1, I, g, _ = b === void 0 ? null : b;
      return [function() {
        return B(h());
...
function U1() {
  return cc || (cc = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var i = typeof Object.is == "function" ? Object.is : r, n = t.useSyncExternalStore, s = e.useRef, u = e.useEffect, a = e.useMemo, l = e.useDebugValue;
    function f(h, b, E, m, D) {
      var x = s(null), N;
      x.current === null ? (N = {
        hasValue: !1,
        value: null
      }, x.current = N) : N = x.current;
      var B = a(function() {
    ...
    this.g = yc, this.D = !0, this.produce = function(n, s, u) {
      if (typeof n == "function" && typeof s != "function") {
        ...
        return function(x) {
          var N = this;
          x === void 0 && (x = a);
          for (var B = arguments.length, S = Array(B > 1 ? B - 1 : 0), I = 1; I < B; I++)
            S[I - 1] = arguments[I];
          return l.produce(x, function(g) {
            var _;
            return (_ = s).call.apply(_, [N, g].concat(S));
          });
        };
      }
      var f;
...
const ev = (e) => (t, r, i) => (i.setState = (n, s, ...u) => {
  ...
  return Js(({ params: b, topic: E }) => {
    if (b.event.name === "accountSelected" && e && e.topic === E) {
      const D = b.event.data, x = b.chainId.split(":")[0], N = b.chainId.split(":")[1];
      n({
        network: x,
        chainId: N,
        address: D
    ...
    if (f)
      ...
      const b = l && l.type === "GET_SELECTED_ACCOUNT_RES" ? l : void 0, E = l && l.type === "GET_SELECTED_ACCOUNT_RES" ? l.data.error : void 0, m = b == null ? void 0 : b.data.account;
      m && n(m), u(E);
    }
  }, [l, f]), {
    account: t,
  ...
  const e = Mr(), [t, r] = jr((m) => [
    m.chainId,
    m.account
  ]), [i, n] = Lt(0), [s, u] = Lt(!1), [a, l] = Lt(void 0), { request: f, data: h, error: b, loading: E } = ri({
    topic: e == null ? void 0 : e.topic,
    chainId: t ?? "aleo:1",
    request: {
      id: 1,
  ...
  return Js(({ id: m, params: D, topic: x }) => {
    D.event.name === "accountSynced" && e && e.topic === x && (console.log("in useBalance"), console.log(D.event), f(), u(!0));
  }), St(() => {
    e && (f(), u(!0), console.log("sending balance request in useBalance!"));
  }, [e, r]), St(() => {
    if (b)
      n(0), l(b.message), u(!1);
    else if (h) {
      const m = h && h.type === "GET_BALANCE_RES" ? h : void 0, D = h && h.type === "GET_BALANCE_REJ" ? h.data.error : void 0, x = (m == null ? void 0 : m.data.balance) ?? 0;
      n(x), l(D), u(!1);
    }
  ...
  }), u = n ? n.message : i && i.type === "EXECUTE_REJ" ? i.data.error : void 0, a = i && i.type === "EXECUTE_RES" ? i : void 0, l = a == null ? void 0 : a.data.transactionId, f = a == null ? void 0 : a.data.outputPrivate, h = a == null ? void 0 : a.data.outputPublic, b = a == null ? void 0 : a.data.outputRecords, E = a == null ? void 0 : a.data.outputConstant;
  return { execute: () => {
    e && (r(), console.log("sent execute request"));
  }, transactionId: l, outputConstant: E, outputPrivate: f, outputRecords: b, outputPublic: h, error: u, loading: s };
}, Cv = () => {
  const [e, t] = Lt({
    loading: !0
  });
  ...
  const t = Mr(), [r, i] = jr((D) => [
    D.chainId,
    D.account
  ]), [n, s] = Lt([]), [u, a] = Lt(void 0), [l, f] = Lt(!1), { request: h, data: b, error: E, loading: m } = ri({
    topic: t == null ? void 0 : t.topic,
    chainId: r ?? "aleo:1",
    request: {
      id: 1,
  ...
  return Js(({ id: D, params: x, topic: N }) => {
    x.event.name === "accountSynced" && t && t.topic === N && (console.log("in useRecords :( i am getting called way too much"), console.log(x.event), h(), f(!0));
  }), St(() => {
    t && i && (h(), f(!0), console.log("sending records request in useRecords!"));
  }, [t, i]), St(() => {
    console.log("session changed!"), console.log(t);
  }, [t]), St(() => {
    if (E)
      s([]), a(E.message), f(!1);
    else if (b) {
      const D = b, x = D.type === "GET_RECORDS_REJ" ? D.data.error : void 0, N = D.type === "GET_RECORDS_RES" ? D.data.records : [];
      s(N), a(x), f(!1);
    }
  }, [b, E]), { records: n, error: u, loading: l };
}, Nv = (e) => {
  const t = Mr(), [r] = jr((a) => [
    a.chainId
  ]), { request: i, data: n, error: s, loading: u } = ri({
