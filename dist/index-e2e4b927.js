...
const ud = "@puzzlehq/sdk", ld = "Puzzle SDK", hd = "0.1.45", dd = "Your portal to privacy", fd = "./dist/puzzle.cjs.js", pd = "./dist/puzzle.es.js", gd = "./dist/puzzle.umd.js", yd = "./dist/types/src/index.d.ts", md = {
  ".": {
...
let Yd = class {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-12c45a6a.js");
