import Xr, { memo as ml, useEffect as Rt, useState as qt, useDebugValue as _l } from "react";
...
function El() {
  return ho || (ho = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(m) {
      {
        for (var $ = arguments.length, J = new Array($ > 1 ? $ - 1 : 0), se = 1; se < $; se++)
          J[se - 1] = arguments[se];
        O("error", m, J);
      }
    }
    function O(m, $, J) {
      {
        var se = M.ReactDebugCurrentFrame, Ce = se.getStackAddendum();
        Ce !== "" && ($ += "%s", J = J.concat([Ce]));
        var Se = J.map(function(Oe) {
          return String(Oe);
        });
        Se.unshift("Warning: " + $), Function.prototype.apply.call(console[m], console, Se);
      }
    }
    var g = !1, w = !1, h = !1, o = !1, p = !1, R;
    R = Symbol.for("react.module.reference");
    function N(m) {
      return !!(typeof m == "string" || typeof m == "function" || m === i || m === s || p || m === n || m === f || m === d || o || m === _ || g || w || h || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === b || m.$$typeof === u || m.$$typeof === a || m.$$typeof === l || // This needs to include all possible module reference object
    ...
    function Y(m) {
      ...
      if (typeof m == "object")
        switch (m.$$typeof) {
          ...
          case v: {
            var Ce = m, Se = Ce._payload, Oe = Ce._init;
            try {
              return Y(Oe(Se));
            } catch {
              return null;
    ...
    var re = M.ReactCurrentDispatcher, L;
    function P(m, $, J) {
      {
        if (L === void 0)
          try {
...
` + _e[qe].replace(" at new ", " at ");
        ...
        I = !1, re.current = Se, Q(), Error.prepareStackTrace = Ce;
      }
      var fr = m ? m.displayName || m.name : "", Li = fr ? P(fr) : "";
      return typeof m == "function" && c.set(m, Li), Li;
    }
    function Z(m, $, J) {
      return G(m, !1);
    }
      ...
      if (typeof m == "object")
        switch (m.$$typeof) {
          ...
          case b:
            return ve(m.type, $, J);
          case v: {
            var se = m, Ce = se._payload, Se = se._init;
            try {
              return ve(Se(Ce), $, J);
            } catch {
            }
    ...
    var he = Object.prototype.hasOwnProperty, xe = {}, Be = M.ReactDebugCurrentFrame;
    function Le(m) {
      if (m) {
        var $ = m._owner, J = ve(m.type, m._source, $ ? $.type : null);
        Be.setExtraStackFrame(J);
      } else
        Be.setExtraStackFrame(null);
    }
    function De(m, $, J, se, Ce) {
      {
        ...
        for (var Oe in m)
          if (Se(m, Oe)) {
            ...
            try {
              ...
              _e = m[Oe]($, Oe, se, J, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (qe) {
              _e = qe;
            }
    ...
    function Pe(m, $) {
      if (typeof m.ref == "string" && ne.current && $ && ne.current.stateNode !== $) {
    ...
    function Ae(m, $) {
      {
        var J = function() {
          me || (me = !0, E("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", $));
        };
    ...
    function Tt(m, $) {
      {
        var J = function() {
          ae || (ae = !0, E("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", $));
        };
    ...
    var $t = function(m, $, J, se, Ce, Se, Oe) {
      var _e = {
    ...
    function Zt(m, $, J, se, Ce) {
      {
        var Se, Oe = {}, _e = null, ft = null;
        J !== void 0 && (ce(J), _e = "" + J), Te($) && (ce($.key), _e = "" + $.key), Ie($) && (ft = $.ref, Pe($, Ce));
        for (Se in $)
          he.call($, Se) && !ye.hasOwnProperty(Se) && (Oe[Se] = $[Se]);
        if (m && m.defaultProps) {
        ...
        return $t(m, _e, ft, Ce, se, ne.current, Oe);
      }
    }
    var lt = M.ReactCurrentOwner, Qt = M.ReactDebugCurrentFrame;
    function Mt(m) {
      if (m) {
        var $ = m._owner, J = ve(m.type, m._source, $ ? $.type : null);
    ...
    function Me(m, $) {
      {
        ...
        Ve[J] = !0;
        var se = "";
        m && m._owner && m._owner !== lt.current && (se = " It was passed a child from " + Y(m._owner.type) + "."), Mt(m), E('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', J, se), Mt(null);
      }
    }
    function Xe(m, $) {
      {
        ...
        if (de(m))
          ...
          if (typeof Ce == "function" && Ce !== m.entries)
            for (var Se = Ce.call(m), Oe; !(Oe = Se.next()).done; )
              ze(Oe.value) && Me(Oe.value, $);
        }
      }
    }
    function et(m) {
    ...
    function Ze(m, $, J, se, Ce, Se) {
      {
        ...
        if (!Oe) {
          ...
          ft ? _e += ft : _e += $e();
          var qe;
          m === null ? qe = "null" : de(m) ? qe = "array" : m !== void 0 && m.$$typeof === t ? (qe = "<" + (Y(m.type) || "Unknown") + " />", _e = " Did you accidentally export a JSX literal instead of a component?") : qe = typeof m, E("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", qe, _e);
        }
        var Ge = Zt(m, $, J, Ce, Se);
        if (Ge == null)
          return Ge;
...
const Sl = Symbol(), po = Object.getPrototypeOf, Gn = /* @__PURE__ */ new WeakMap(), Dl = (e) => e && (Gn.has(e) ? Gn.get(e) : po(e) === Object.prototype || po(e) === Array.prototype), Ol = (e) => Dl(e) && e[Sl] || null, go = (e, t = !0) => {
  ...
  const v = n.get(f);
  if ((v == null ? void 0 : v[0]) === d)
    return v[1];
  const _ = Array.isArray(f) ? [] : Object.create(Object.getPrototypeOf(f));
  return go(_, !0), n.set(f, [d, _]), Reflect.ownKeys(f).forEach((D) => {
    if (Object.getOwnPropertyDescriptor(_, D))
      return;
    const A = Reflect.get(f, D), U = {
      value: A,
      enumerable: !0,
  ...
  if (d)
    return d;
  let b = a[0];
  const v = /* @__PURE__ */ new Set(), _ = (R, N = ++a[0]) => {
    b !== N && (b = N, v.forEach((F) => F(R, N)));
  };
  let D = a[1];
  const A = (R = ++a[1]) => (D !== R && !v.size && (D = R, M.forEach(([N]) => {
    const F = N[1](R);
    F > b && (b = F);
  })), b), U = (R) => (N, F) => {
    const K = [...N];
    K[1] = [R, ...K[1]], _(K, F);
  }, M = /* @__PURE__ */ new Map(), E = (R, N) => {
    if (v.size) {
      const F = N[3](U(R));
      M.set(R, [N, F]);
    } else
    ...
    var N;
    const F = M.get(R);
    F && (M.delete(R), (N = F[1]) == null || N.call(F));
  }, g = (R) => (v.add(R), v.size === 1 && M.forEach(([F, K], Y) => {
    const x = F[3](U(Y));
    M.set(Y, [F, x]);
  }), () => {
    v.delete(R), v.size === 0 && M.forEach(([F, K], Y) => {
      K && (K(), M.set(Y, [F]));
    });
    ...
    set(R, N, F, K) {
      ...
      if (F instanceof Promise)
        F.then((H) => {
          F.status = "fulfilled", F.value = H, _(["resolve", [N], H]);
        }).catch((H) => {
          F.status = "rejected", F.reason = H, _(["reject", [N], H]);
        });
      else {
        !gr.has(F) && r(F) && (T = l(F));
      ...
      return Reflect.set(R, N, T, K), _(["set", [N], F, x]), !0;
    }
  });
  u.set(f, o);
  const p = [
...
let Bl = class {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-33e78407.js");
...
function sf(e, t, r) {
  ...
  function l(v) {
    v.value instanceof Oi ? Promise.resolve(v.value.v).then(f, d) : b(s[0][2], v);
  }
  function f(v) {
    a("next", v);
  }
...
function Ff() {
  ...
  function t(r, i, n) {
    ...
    if (d === 0)
      return r;
    for (var b = "", v = 1 - u, _ = -1, D = r && r.length || 0, A = 0; A < D; ) {
      if (r.charCodeAt(A) === 37 && A + 1 < D) {
        switch (_ = _ > -1 ? _ : 0, r.charCodeAt(A + 1)) {
          case 100:
          case 102:
            if (v >= d || i[v] == null)
              break;
            _ < A && (b += r.slice(_, A)), b += Number(i[v]), _ = A + 2, A++;
            break;
          case 105:
            if (v >= d || i[v] == null)
              break;
            _ < A && (b += r.slice(_, A)), b += Math.floor(Number(i[v])), _ = A + 2, A++;
            break;
          case 79:
          case 111:
          case 106:
          ...
          case 115:
            if (v >= d)
              break;
            _ < A && (b += r.slice(_, A)), b += String(i[v]), _ = A + 2, A++;
            break;
          case 37:
            _ < A && (b += r.slice(_, A)), b += "%", _ = A + 2, A++, v--;
            break;
        }
        ++v;
      }
...
function $f() {
  ...
  }, n.stdSerializers = r, n.stdTimeFunctions = Object.assign({}, { nullTime: M, epochTime: E, unixTime: O, isoTime: g });
  function s(h, o, p, R) {
  ...
  function _(h) {
    return typeof h.timestamp == "function" ? h.timestamp : h.timestamp === !1 ? M : E;
  }
  function D() {
    return {};
  }
...
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  function t(a, l) {
    var f = a >>> 16 & 65535, d = a & 65535, b = l >>> 16 & 65535, v = l & 65535;
    return d * v + (f * v + d * b << 16 >>> 0) | 0;
  }
  e.mul = Math.imul || t;
  function r(a, l) {
    return a + l | 0;
...
(function(e) {
  ...
  function a(f, d = u, b = e.defaultRandomSource) {
    ...
    let v = "";
    const _ = d.length, D = 256 - 256 % _;
    for (; f > 0; ) {
      const A = n(Math.ceil(f * 256 / D), b);
      for (let U = 0; U < A.length && f > 0; U++) {
        const M = A[U];
        M < D && (v += d.charAt(M % _), f--);
      }
      (0, i.wipe)(A);
    }
    return v;
  ...
  function l(f, d = u, b = e.defaultRandomSource) {
    const v = Math.ceil(f / (Math.log(d.length) / Math.LN2));
    return a(v, d, b);
  }
...
(function(e) {
  ...
  var i = (
    ...
    function() {
      ...
      return a.prototype._initState = function() {
        ...
        if (!this._finished) {
          var f = this._bytesHashed, d = this._bufferLength, b = f / 536870912 | 0, v = f << 3, _ = f % 128 < 112 ? 128 : 256;
          this._buffer[d] = 128;
          for (var D = d + 1; D < _ - 8; D++)
            this._buffer[D] = 0;
  ...
  function s(a, l, f, d, b, v, _) {
    for (var D = f[0], A = f[1], U = f[2], M = f[3], E = f[4], O = f[5], g = f[6], w = f[7], h = d[0], o = d[1], p = d[2], R = d[3], N = d[4], F = d[5], K = d[6], Y = d[7], x, T, H, q, B, V, j, W; _ >= 128; ) {
      ...
      x = D, T = h, B = T & 65535, V = T >>> 16, j = x & 65535, W = x >>> 16, x = f[0], T = d[0], B += T & 65535, V += T >>> 16, j += x & 65535, W += x >>> 16, V += B >>> 16, j += V >>> 16, W += j >>> 16, f[0] = D = j & 65535 | W << 16, d[0] = h = B & 65535 | V << 16, x = A, T = o, B = T & 65535, V = T >>> 16, j = x & 65535, W = x >>> 16, x = f[1], T = d[1], B += T & 65535, V += T >>> 16, j += x & 65535, W += x >>> 16, V += B >>> 16, j += V >>> 16, W += j >>> 16, f[1] = A = j & 65535 | W << 16, d[1] = o = B & 65535 | V << 16, x = U, T = p, B = T & 65535, V = T >>> 16, j = x & 65535, W = x >>> 16, x = f[2], T = d[2], B += T & 65535, V += T >>> 16, j += x & 65535, W += x >>> 16, V += B >>> 16, j += V >>> 16, W += j >>> 16, f[2] = U = j & 65535 | W << 16, d[2] = p = B & 65535 | V << 16, x = M, T = R, B = T & 65535, V = T >>> 16, j = x & 65535, W = x >>> 16, x = f[3], T = d[3], B += T & 65535, V += T >>> 16, j += x & 65535, W += x >>> 16, V += B >>> 16, j += V >>> 16, W += j >>> 16, f[3] = M = j & 65535 | W << 16, d[3] = R = B & 65535 | V << 16, x = E, T = N, B = T & 65535, V = T >>> 16, j = x & 65535, W = x >>> 16, x = f[4], T = d[4], B += T & 65535, V += T >>> 16, j += x & 65535, W += x >>> 16, V += B >>> 16, j += V >>> 16, W += j >>> 16, f[4] = E = j & 65535 | W << 16, d[4] = N = B & 65535 | V << 16, x = O, T = F, B = T & 65535, V = T >>> 16, j = x & 65535, W = x >>> 16, x = f[5], T = d[5], B += T & 65535, V += T >>> 16, j += x & 65535, W += x >>> 16, V += B >>> 16, j += V >>> 16, W += j >>> 16, f[5] = O = j & 65535 | W << 16, d[5] = F = B & 65535 | V << 16, x = g, T = K, B = T & 65535, V = T >>> 16, j = x & 65535, W = x >>> 16, x = f[6], T = d[6], B += T & 65535, V += T >>> 16, j += x & 65535, W += x >>> 16, V += B >>> 16, j += V >>> 16, W += j >>> 16, f[6] = g = j & 65535 | W << 16, d[6] = K = B & 65535 | V << 16, x = w, T = Y, B = T & 65535, V = T >>> 16, j = x & 65535, W = x >>> 16, x = f[7], T = d[7], B += T & 65535, V += T >>> 16, j += x & 65535, W += x >>> 16, V += B >>> 16, j += V >>> 16, W += j >>> 16, f[7] = w = j & 65535 | W << 16, d[7] = Y = B & 65535 | V << 16, v += 128, _ -= 128;
    }
    return v;
  }
  function u(a) {
...
(function(e) {
  ...
  function D(L) {
    ...
    for (let I = 0; I < 16; I++) {
      let c = L[I] + P + 65535;
      P = Math.floor(c / 65536), L[I] = c - P * 65536;
    }
    L[0] += P - 1 + 37 * (P - 1);
  }
  function A(L, P, I) {
  ...
  function U(L, P) {
    ...
    for (let S = 0; S < 2; S++) {
      I[0] = c[0] - 65517;
      for (let Z = 1; Z < 15; Z++)
        I[Z] = c[Z] - 65535 - (I[Z - 1] >> 16 & 1), I[Z - 1] &= 65535;
      I[15] = c[15] - 32767 - (I[14] >> 16 & 1);
      const G = I[15] >> 16 & 1;
      I[14] &= 65535, A(c, I, 1 - G);
    }
    for (let S = 0; S < 16; S++)
  ...
  function o(L, P, I) {
    let c, S, G = 0, Z = 0, be = 0, ve = 0, he = 0, xe = 0, Be = 0, Le = 0, De = 0, we = 0, de = 0, ge = 0, pe = 0, ue = 0, ce = 0, ne = 0, ye = 0, me = 0, ae = 0, Ee = 0, Ie = 0, Te = 0, Pe = 0, Ae = 0, Tt = 0, $t = 0, Zt = 0, lt = 0, Qt = 0, Mt = 0, lr = 0, ze = I[0], $e = I[1], We = I[2], Ve = I[3], ke = I[4], Me = I[5], Xe = I[6], et = I[7], tt = I[8], Ze = I[9], rt = I[10], Qe = I[11], He = I[12], Ue = I[13], m = I[14], $ = I[15];
    c = P[0], G += c * ze, Z += c * $e, be += c * We, ve += c * Ve, he += c * ke, xe += c * Me, Be += c * Xe, Le += c * et, De += c * tt, we += c * Ze, de += c * rt, ge += c * Qe, pe += c * He, ue += c * Ue, ce += c * m, ne += c * $, c = P[1], Z += c * ze, be += c * $e, ve += c * We, he += c * Ve, xe += c * ke, Be += c * Me, Le += c * Xe, De += c * et, we += c * tt, de += c * Ze, ge += c * rt, pe += c * Qe, ue += c * He, ce += c * Ue, ne += c * m, ye += c * $, c = P[2], be += c * ze, ve += c * $e, he += c * We, xe += c * Ve, Be += c * ke, Le += c * Me, De += c * Xe, we += c * et, de += c * tt, ge += c * Ze, pe += c * rt, ue += c * Qe, ce += c * He, ne += c * Ue, ye += c * m, me += c * $, c = P[3], ve += c * ze, he += c * $e, xe += c * We, Be += c * Ve, Le += c * ke, De += c * Me, we += c * Xe, de += c * et, ge += c * tt, pe += c * Ze, ue += c * rt, ce += c * Qe, ne += c * He, ye += c * Ue, me += c * m, ae += c * $, c = P[4], he += c * ze, xe += c * $e, Be += c * We, Le += c * Ve, De += c * ke, we += c * Me, de += c * Xe, ge += c * et, pe += c * tt, ue += c * Ze, ce += c * rt, ne += c * Qe, ye += c * He, me += c * Ue, ae += c * m, Ee += c * $, c = P[5], xe += c * ze, Be += c * $e, Le += c * We, De += c * Ve, we += c * ke, de += c * Me, ge += c * Xe, pe += c * et, ue += c * tt, ce += c * Ze, ne += c * rt, ye += c * Qe, me += c * He, ae += c * Ue, Ee += c * m, Ie += c * $, c = P[6], Be += c * ze, Le += c * $e, De += c * We, we += c * Ve, de += c * ke, ge += c * Me, pe += c * Xe, ue += c * et, ce += c * tt, ne += c * Ze, ye += c * rt, me += c * Qe, ae += c * He, Ee += c * Ue, Ie += c * m, Te += c * $, c = P[7], Le += c * ze, De += c * $e, we += c * We, de += c * Ve, ge += c * ke, pe += c * Me, ue += c * Xe, ce += c * et, ne += c * tt, ye += c * Ze, me += c * rt, ae += c * Qe, Ee += c * He, Ie += c * Ue, Te += c * m, Pe += c * $, c = P[8], De += c * ze, we += c * $e, de += c * We, ge += c * Ve, pe += c * ke, ue += c * Me, ce += c * Xe, ne += c * et, ye += c * tt, me += c * Ze, ae += c * rt, Ee += c * Qe, Ie += c * He, Te += c * Ue, Pe += c * m, Ae += c * $, c = P[9], we += c * ze, de += c * $e, ge += c * We, pe += c * Ve, ue += c * ke, ce += c * Me, ne += c * Xe, ye += c * et, me += c * tt, ae += c * Ze, Ee += c * rt, Ie += c * Qe, Te += c * He, Pe += c * Ue, Ae += c * m, Tt += c * $, c = P[10], de += c * ze, ge += c * $e, pe += c * We, ue += c * Ve, ce += c * ke, ne += c * Me, ye += c * Xe, me += c * et, ae += c * tt, Ee += c * Ze, Ie += c * rt, Te += c * Qe, Pe += c * He, Ae += c * Ue, Tt += c * m, $t += c * $, c = P[11], ge += c * ze, pe += c * $e, ue += c * We, ce += c * Ve, ne += c * ke, ye += c * Me, me += c * Xe, ae += c * et, Ee += c * tt, Ie += c * Ze, Te += c * rt, Pe += c * Qe, Ae += c * He, Tt += c * Ue, $t += c * m, Zt += c * $, c = P[12], pe += c * ze, ue += c * $e, ce += c * We, ne += c * Ve, ye += c * ke, me += c * Me, ae += c * Xe, Ee += c * et, Ie += c * tt, Te += c * Ze, Pe += c * rt, Ae += c * Qe, Tt += c * He, $t += c * Ue, Zt += c * m, lt += c * $, c = P[13], ue += c * ze, ce += c * $e, ne += c * We, ye += c * Ve, me += c * ke, ae += c * Me, Ee += c * Xe, Ie += c * et, Te += c * tt, Pe += c * Ze, Ae += c * rt, Tt += c * Qe, $t += c * He, Zt += c * Ue, lt += c * m, Qt += c * $, c = P[14], ce += c * ze, ne += c * $e, ye += c * We, me += c * Ve, ae += c * ke, Ee += c * Me, Ie += c * Xe, Te += c * et, Pe += c * tt, Ae += c * Ze, Tt += c * rt, $t += c * Qe, Zt += c * He, lt += c * Ue, Qt += c * m, Mt += c * $, c = P[15], ne += c * ze, ye += c * $e, me += c * We, ae += c * Ve, Ee += c * ke, Ie += c * Me, Te += c * Xe, Pe += c * et, Ae += c * tt, Tt += c * Ze, $t += c * rt, Zt += c * Qe, lt += c * He, Qt += c * Ue, Mt += c * m, lr += c * $, G += 38 * ye, Z += 38 * me, be += 38 * ae, ve += 38 * Ee, he += 38 * Ie, xe += 38 * Te, Be += 38 * Pe, Le += 38 * Ae, De += 38 * Tt, we += 38 * $t, de += 38 * Zt, ge += 38 * lt, pe += 38 * Qt, ue += 38 * Mt, ce += 38 * lr, S = 1, c = G + S + 65535, S = Math.floor(c / 65536), G = c - S * 65536, c = Z + S + 65535, S = Math.floor(c / 65536), Z = c - S * 65536, c = be + S + 65535, S = Math.floor(c / 65536), be = c - S * 65536, c = ve + S + 65535, S = Math.floor(c / 65536), ve = c - S * 65536, c = he + S + 65535, S = Math.floor(c / 65536), he = c - S * 65536, c = xe + S + 65535, S = Math.floor(c / 65536), xe = c - S * 65536, c = Be + S + 65535, S = Math.floor(c / 65536), Be = c - S * 65536, c = Le + S + 65535, S = Math.floor(c / 65536), Le = c - S * 65536, c = De + S + 65535, S = Math.floor(c / 65536), De = c - S * 65536, c = we + S + 65535, S = Math.floor(c / 65536), we = c - S * 65536, c = de + S + 65535, S = Math.floor(c / 65536), de = c - S * 65536, c = ge + S + 65535, S = Math.floor(c / 65536), ge = c - S * 65536, c = pe + S + 65535, S = Math.floor(c / 65536), pe = c - S * 65536, c = ue + S + 65535, S = Math.floor(c / 65536), ue = c - S * 65536, c = ce + S + 65535, S = Math.floor(c / 65536), ce = c - S * 65536, c = ne + S + 65535, S = Math.floor(c / 65536), ne = c - S * 65536, G += S - 1 + 37 * (S - 1), S = 1, c = G + S + 65535, S = Math.floor(c / 65536), G = c - S * 65536, c = Z + S + 65535, S = Math.floor(c / 65536), Z = c - S * 65536, c = be + S + 65535, S = Math.floor(c / 65536), be = c - S * 65536, c = ve + S + 65535, S = Math.floor(c / 65536), ve = c - S * 65536, c = he + S + 65535, S = Math.floor(c / 65536), he = c - S * 65536, c = xe + S + 65535, S = Math.floor(c / 65536), xe = c - S * 65536, c = Be + S + 65535, S = Math.floor(c / 65536), Be = c - S * 65536, c = Le + S + 65535, S = Math.floor(c / 65536), Le = c - S * 65536, c = De + S + 65535, S = Math.floor(c / 65536), De = c - S * 65536, c = we + S + 65535, S = Math.floor(c / 65536), we = c - S * 65536, c = de + S + 65535, S = Math.floor(c / 65536), de = c - S * 65536, c = ge + S + 65535, S = Math.floor(c / 65536), ge = c - S * 65536, c = pe + S + 65535, S = Math.floor(c / 65536), pe = c - S * 65536, c = ue + S + 65535, S = Math.floor(c / 65536), ue = c - S * 65536, c = ce + S + 65535, S = Math.floor(c / 65536), ce = c - S * 65536, c = ne + S + 65535, S = Math.floor(c / 65536), ne = c - S * 65536, G += S - 1 + 37 * (S - 1), L[0] = G, L[1] = Z, L[2] = be, L[3] = ve, L[4] = he, L[5] = xe, L[6] = Be, L[7] = Le, L[8] = De, L[9] = we, L[10] = de, L[11] = ge, L[12] = pe, L[13] = ue, L[14] = ce, L[15] = ne;
  }
  function p(L, P) {
    o(L, P, P);
  }
  ...
  function F(L, P) {
    const I = n(), c = n(), S = n(), G = n(), Z = n(), be = n(), ve = n(), he = n(), xe = n();
    h(I, L[1], L[0]), h(xe, P[1], P[0]), o(I, I, xe), w(c, L[0], L[1]), w(xe, P[0], P[1]), o(c, c, xe), o(S, L[3], P[3]), o(S, S, f), o(G, L[2], P[2]), w(G, G, G), h(Z, c, I), h(be, G, S), w(ve, G, S), w(he, c, I), o(L[0], Z, be), o(L[1], he, ve), o(L[2], ve, be), o(L[3], Z, he);
  }
  function K(L, P, I) {
    for (let c = 0; c < 4; c++)
      A(L[c], P[c], I);
  ...
  function Y(L, P) {
    const I = n(), c = n(), S = n();
    R(S, P[2]), o(I, P[0], S), o(c, P[1], S), U(L, c), L[31] ^= O(I) << 7;
  }
  function x(L, P, I) {
    _(L[0], u), _(L[1], a), _(L[2], a), _(L[3], u);
    for (let c = 255; c >= 0; --c) {
      const S = I[c / 8 | 0] >> (c & 7) & 1;
      K(L, P, S), F(P, L), F(L, L), K(L, P, S);
    }
  }
  function T(L, P) {
    const I = [n(), n(), n(), n()];
    _(I[0], d), _(I[1], b), _(I[2], a), o(I[3], d, b), x(L, I, P);
  }
  function H(L) {
  ...
  function q(L) {
    const P = (0, t.randomBytes)(32, L), I = H(P);
    return (0, i.wipe)(P), I;
  }
  e.generateKeyPair = q;
  function B(L) {
  ...
  function j(L, P) {
    let I, c, S, G;
    for (c = 63; c >= 32; --c) {
      for (I = 0, S = c - 32, G = c - 12; S < G; ++S)
        P[S] += I - 16 * P[c] * V[S - (c - 32)], I = Math.floor((P[S] + 128) / 256), P[S] -= I * 256;
      P[S] += I, P[c] = 0;
    }
    for (I = 0, S = 0; S < 32; S++)
      P[S] += I - (P[31] >> 4) * V[S], I = P[S] >> 8, P[S] &= 255;
    for (S = 0; S < 32; S++)
      P[S] -= I * V[S];
    for (c = 0; c < 32; c++)
  ...
  function oe(L, P) {
    const I = new Float64Array(64), c = [n(), n(), n(), n()], S = (0, r.hash)(L.subarray(0, 32));
    ...
    for (let he = 0; he < 32; he++)
      for (let xe = 0; xe < 32; xe++)
        I[he + xe] += ve[he] * S[xe];
    return j(G.subarray(32), I), G;
  }
  e.sign = oe;
  function k(L, P) {
    const I = n(), c = n(), S = n(), G = n(), Z = n(), be = n(), ve = n();
    return _(L[2], a), g(L[1], P), p(S, L[1]), o(G, S, l), h(S, S, L[2]), w(G, L[2], G), p(Z, G), p(be, Z), o(ve, be, Z), o(I, ve, S), o(I, I, G), N(I, I), o(I, I, S), o(I, I, G), o(I, I, G), o(L[0], I, G), p(c, L[0]), o(c, c, G), E(c, S) && o(L[0], L[0], v), p(c, L[0]), o(c, c, G), E(c, S) ? -1 : (O(L[0]) === P[31] >> 7 && h(L[0], u, L[0]), o(L[3], L[0], L[1]), 0);
  }
  function ie(L, P, I) {
    ...
    if (k(G, L))
      return !1;
    const Z = new r.SHA512();
    Z.update(I.subarray(0, 32)), Z.update(L), Z.update(P);
    const be = Z.digest();
    return W(be), x(S, G, be), T(G, I.subarray(32)), F(S, G), Y(c, S), !M(I, c);
  }
  e.verify = ie;
  function Q(L) {
    let P = [n(), n(), n(), n()];
  ...
  function re(L) {
    ...
    P[0] &= 248, P[31] &= 127, P[31] |= 64;
    const I = new Uint8Array(P.subarray(0, 32));
    return (0, i.wipe)(P), I;
  }
...
function jh(e, t) {
  ...
  function b(D) {
    ...
    if (D.length === 0)
      return "";
    for (var A = 0, U = 0, M = 0, E = D.length; M !== E && D[M] === 0; )
      M++, A++;
    for (var O = (E - M) * d + 1 >>> 0, g = new Uint8Array(O); M !== E; ) {
      for (var w = D[M], h = 0, o = O - 1; (w !== 0 || h < U) && o !== -1; o--, h++)
  ...
  function v(D) {
    ...
    var A = 0;
    if (D[A] !== " ") {
      for (var U = 0, M = 0; D[A] === l; )
        U++, A++;
      for (var E = (D.length - A) * f + 1 >>> 0, O = new Uint8Array(E); D[A]; ) {
        var g = r[D.charCodeAt(A)];
        if (g === 255)
          return;
        for (var w = 0, h = E - 1; (g !== 0 || w < M) && h !== -1; h--, w++)
...
function Xi(e) {
  return xt(Ct(Ds(e), Th), $c);
}
function qc(e) {
  const t = Ct($h, Go), r = Fh + xt(is([t, e]), Go);
...
function Fd(e) {
  return Ct([Xi(e.header), Xi(e.payload)].join(Fc), Ph);
}
function $d(e) {
  return [
    Xi(e.header),
...
var vt = le, ns = Ft, jd = 20;
function Bd(e, t, r) {
  for (var i = 1634760805, n = 857760878, s = 2036477234, u = 1797285236, a = r[3] << 24 | r[2] << 16 | r[1] << 8 | r[0], l = r[7] << 24 | r[6] << 16 | r[5] << 8 | r[4], f = r[11] << 24 | r[10] << 16 | r[9] << 8 | r[8], d = r[15] << 24 | r[14] << 16 | r[13] << 8 | r[12], b = r[19] << 24 | r[18] << 16 | r[17] << 8 | r[16], v = r[23] << 24 | r[22] << 16 | r[21] << 8 | r[20], _ = r[27] << 24 | r[26] << 16 | r[25] << 8 | r[24], D = r[31] << 24 | r[30] << 16 | r[29] << 8 | r[28], A = t[3] << 24 | t[2] << 16 | t[1] << 8 | t[0], U = t[7] << 24 | t[6] << 16 | t[5] << 8 | t[4], M = t[11] << 24 | t[10] << 16 | t[9] << 8 | t[8], E = t[15] << 24 | t[14] << 16 | t[13] << 8 | t[12], O = i, g = n, w = s, h = u, o = a, p = l, R = f, N = d, F = b, K = v, Y = _, x = D, T = A, H = U, q = M, B = E, V = 0; V < jd; V += 2)
  ...
  var i = (
    ...
    function() {
      function u(a) {
        ...
        var A = a[14] | a[15] << 8;
        this._r[8] = (D >>> 8 | A << 8) & 8191, this._r[9] = A >>> 5 & 127, this._pad[0] = a[16] | a[17] << 8, this._pad[1] = a[18] | a[19] << 8, this._pad[2] = a[20] | a[21] << 8, this._pad[3] = a[22] | a[23] << 8, this._pad[4] = a[24] | a[25] << 8, this._pad[5] = a[26] | a[27] << 8, this._pad[6] = a[28] | a[29] << 8, this._pad[7] = a[30] | a[31] << 8;
      }
      return u.prototype._blocks = function(a, l, f) {
        for (var d = this._fin ? 0 : 2048, b = this._h[0], v = this._h[1], _ = this._h[2], D = this._h[3], A = this._h[4], U = this._h[5], M = this._h[6], E = this._h[7], O = this._h[8], g = this._h[9], w = this._r[0], h = this._r[1], o = this._r[2], p = this._r[3], R = this._r[4], N = this._r[5], F = this._r[6], K = this._r[7], Y = this._r[8], x = this._r[9]; f >= 16; ) {
          var T = a[l + 0] | a[l + 1] << 8;
          b += T & 8191;
          var H = a[l + 2] | a[l + 3] << 8;
          v += (T >>> 13 | H << 3) & 8191;
          ...
          var k = 0, ie = k;
          ie += b * w, ie += v * (5 * x), ie += _ * (5 * Y), ie += D * (5 * K), ie += A * (5 * F), k = ie >>> 13, ie &= 8191, ie += U * (5 * N), ie += M * (5 * R), ie += E * (5 * p), ie += O * (5 * o), ie += g * (5 * h), k += ie >>> 13, ie &= 8191;
          var Q = k;
          Q += b * h, Q += v * w, Q += _ * (5 * x), Q += D * (5 * Y), Q += A * (5 * K), k = Q >>> 13, Q &= 8191, Q += U * (5 * F), Q += M * (5 * N), Q += E * (5 * R), Q += O * (5 * p), Q += g * (5 * o), k += Q >>> 13, Q &= 8191;
          var re = k;
          re += b * o, re += v * h, re += _ * w, re += D * (5 * x), re += A * (5 * Y), k = re >>> 13, re &= 8191, re += U * (5 * K), re += M * (5 * F), re += E * (5 * N), re += O * (5 * R), re += g * (5 * p), k += re >>> 13, re &= 8191;
          var L = k;
          L += b * p, L += v * o, L += _ * h, L += D * w, L += A * (5 * x), k = L >>> 13, L &= 8191, L += U * (5 * Y), L += M * (5 * K), L += E * (5 * F), L += O * (5 * N), L += g * (5 * R), k += L >>> 13, L &= 8191;
          var P = k;
          P += b * R, P += v * p, P += _ * o, P += D * h, P += A * w, k = P >>> 13, P &= 8191, P += U * (5 * x), P += M * (5 * Y), P += E * (5 * K), P += O * (5 * F), P += g * (5 * N), k += P >>> 13, P &= 8191;
          var I = k;
          I += b * N, I += v * R, I += _ * p, I += D * o, I += A * h, k = I >>> 13, I &= 8191, I += U * w, I += M * (5 * x), I += E * (5 * Y), I += O * (5 * K), I += g * (5 * F), k += I >>> 13, I &= 8191;
          var c = k;
          c += b * F, c += v * N, c += _ * R, c += D * p, c += A * o, k = c >>> 13, c &= 8191, c += U * h, c += M * w, c += E * (5 * x), c += O * (5 * Y), c += g * (5 * K), k += c >>> 13, c &= 8191;
          var S = k;
          S += b * K, S += v * F, S += _ * N, S += D * R, S += A * p, k = S >>> 13, S &= 8191, S += U * o, S += M * h, S += E * w, S += O * (5 * x), S += g * (5 * Y), k += S >>> 13, S &= 8191;
          var G = k;
          G += b * Y, G += v * K, G += _ * F, G += D * N, G += A * R, k = G >>> 13, G &= 8191, G += U * p, G += M * o, G += E * h, G += O * w, G += g * (5 * x), k += G >>> 13, G &= 8191;
          var Z = k;
          Z += b * x, Z += v * Y, Z += _ * K, Z += D * F, Z += A * N, k = Z >>> 13, Z &= 8191, Z += U * R, Z += M * p, Z += E * o, Z += O * h, Z += g * w, k += Z >>> 13, Z &= 8191, k = (k << 2) + k | 0, k = k + ie | 0, ie = k & 8191, k = k >>> 13, Q += k, b = ie, v = Q, _ = re, D = L, A = P, U = I, M = c, E = S, O = G, g = Z, l += 16, f -= 16;
        }
        this._h[0] = b, this._h[1] = v, this._h[2] = _, this._h[3] = D, this._h[4] = A, this._h[5] = U, this._h[6] = M, this._h[7] = E, this._h[8] = O, this._h[9] = g;
      }, u.prototype.finish = function(a, l) {
        l === void 0 && (l = 0);
        var f = new Uint16Array(10), d, b, v, _;
        if (this._leftover) {
        ...
        for (this._h[0] += d * 5, d = this._h[0] >>> 13, this._h[0] &= 8191, this._h[1] += d, d = this._h[1] >>> 13, this._h[1] &= 8191, this._h[2] += d, f[0] = this._h[0] + 5, d = f[0] >>> 13, f[0] &= 8191, _ = 1; _ < 10; _++)
          f[_] = this._h[_] + d, d = f[_] >>> 13, f[_] &= 8191;
        for (f[9] -= 8192, b = (d ^ 1) - 1, _ = 0; _ < 10; _++)
          f[_] &= b;
        for (b = ~b, _ = 0; _ < 10; _++)
...
(function(e) {
  ...
  var u = new Uint8Array(16), a = (
    ...
    function() {
      ...
      return l.prototype.seal = function(f, d, b, v) {
        if (f.length > 16)
          throw new Error("ChaCha20Poly1305: incorrect nonce length");
        var _ = new Uint8Array(16);
        _.set(f, _.length - f.length);
        var D = new Uint8Array(32);
        t.stream(this._key, _, D, 4);
        var A = d.length + this.tagLength, U;
        if (v) {
          if (v.length !== A)
          ...
          U = new Uint8Array(A);
        return t.streamXOR(this._key, _, d, U, 4), this._authenticate(U.subarray(U.length - this.tagLength, U.length), D, U.subarray(0, U.length - this.tagLength), b), i.wipe(_), U;
      }, l.prototype.open = function(f, d, b, v) {
        if (f.length > 16)
          throw new Error("ChaCha20Poly1305: incorrect nonce length");
        ...
        if (this._authenticate(A, D, d.subarray(0, d.length - this.tagLength), b), !s.equal(A, d.subarray(d.length - this.tagLength, d.length)))
          return null;
        var U = d.length - this.tagLength, M;
        if (v) {
          if (v.length !== U)
            throw new Error("ChaCha20Poly1305: incorrect destination length");
          M = v;
          ...
          M = new Uint8Array(U);
        return t.streamXOR(this._key, _, d.subarray(0, d.length - this.tagLength), M, 4), i.wipe(_), M;
      }, l.prototype.clean = function() {
        return i.wipe(this._key), this;
      }, l.prototype._authenticate = function(f, d, b, v) {
        ...
        v && n.writeUint64LE(v.length, D), _.update(D), n.writeUint64LE(b.length, D), _.update(D);
        for (var A = _.digest(), U = 0; U < A.length; U++)
          f[U] = A[U];
        _.clean(), i.wipe(A), i.wipe(D);
      }, l;
    }()
  );
...
(function(e) {
  ...
  var i = (
    ...
    function() {
      ...
      return a.prototype._initState = function() {
        ...
        if (!this._finished) {
          var f = this._bytesHashed, d = this._bufferLength, b = f / 536870912 | 0, v = f << 3, _ = f % 64 < 56 ? 64 : 128;
          this._buffer[d] = 128;
          for (var D = d + 1; D < _ - 8; D++)
            this._buffer[D] = 0;
  ...
  function s(a, l, f, d, b) {
    for (; b >= 64; ) {
      for (var v = l[0], _ = l[1], D = l[2], A = l[3], U = l[4], M = l[5], E = l[6], O = l[7], g = 0; g < 16; g++) {
        var w = d + g * 4;
      ...
      for (var g = 0; g < 64; g++) {
        var o = (((U >>> 6 | U << 26) ^ (U >>> 11 | U << 21) ^ (U >>> 25 | U << 7)) + (U & M ^ ~U & E) | 0) + (O + (n[g] + a[g] | 0) | 0) | 0, p = ((v >>> 2 | v << 32 - 2) ^ (v >>> 13 | v << 32 - 13) ^ (v >>> 22 | v << 32 - 22)) + (v & _ ^ v & D ^ _ & D) | 0;
        O = E, E = M, M = U, U = A + o | 0, A = D, D = _, _ = v, v = o + p | 0;
      }
      l[0] += v, l[1] += _, l[2] += D, l[3] += A, l[4] += U, l[5] += M, l[6] += E, l[7] += O, d += 64, b -= 64;
    }
    return d;
  }
  function u(a) {
...
(function(e) {
  ...
  function v(g, w, h) {
    let o, p, R = 0, N = 0, F = 0, K = 0, Y = 0, x = 0, T = 0, H = 0, q = 0, B = 0, V = 0, j = 0, W = 0, oe = 0, k = 0, ie = 0, Q = 0, re = 0, L = 0, P = 0, I = 0, c = 0, S = 0, G = 0, Z = 0, be = 0, ve = 0, he = 0, xe = 0, Be = 0, Le = 0, De = h[0], we = h[1], de = h[2], ge = h[3], pe = h[4], ue = h[5], ce = h[6], ne = h[7], ye = h[8], me = h[9], ae = h[10], Ee = h[11], Ie = h[12], Te = h[13], Pe = h[14], Ae = h[15];
    o = w[0], R += o * De, N += o * we, F += o * de, K += o * ge, Y += o * pe, x += o * ue, T += o * ce, H += o * ne, q += o * ye, B += o * me, V += o * ae, j += o * Ee, W += o * Ie, oe += o * Te, k += o * Pe, ie += o * Ae, o = w[1], N += o * De, F += o * we, K += o * de, Y += o * ge, x += o * pe, T += o * ue, H += o * ce, q += o * ne, B += o * ye, V += o * me, j += o * ae, W += o * Ee, oe += o * Ie, k += o * Te, ie += o * Pe, Q += o * Ae, o = w[2], F += o * De, K += o * we, Y += o * de, x += o * ge, T += o * pe, H += o * ue, q += o * ce, B += o * ne, V += o * ye, j += o * me, W += o * ae, oe += o * Ee, k += o * Ie, ie += o * Te, Q += o * Pe, re += o * Ae, o = w[3], K += o * De, Y += o * we, x += o * de, T += o * ge, H += o * pe, q += o * ue, B += o * ce, V += o * ne, j += o * ye, W += o * me, oe += o * ae, k += o * Ee, ie += o * Ie, Q += o * Te, re += o * Pe, L += o * Ae, o = w[4], Y += o * De, x += o * we, T += o * de, H += o * ge, q += o * pe, B += o * ue, V += o * ce, j += o * ne, W += o * ye, oe += o * me, k += o * ae, ie += o * Ee, Q += o * Ie, re += o * Te, L += o * Pe, P += o * Ae, o = w[5], x += o * De, T += o * we, H += o * de, q += o * ge, B += o * pe, V += o * ue, j += o * ce, W += o * ne, oe += o * ye, k += o * me, ie += o * ae, Q += o * Ee, re += o * Ie, L += o * Te, P += o * Pe, I += o * Ae, o = w[6], T += o * De, H += o * we, q += o * de, B += o * ge, V += o * pe, j += o * ue, W += o * ce, oe += o * ne, k += o * ye, ie += o * me, Q += o * ae, re += o * Ee, L += o * Ie, P += o * Te, I += o * Pe, c += o * Ae, o = w[7], H += o * De, q += o * we, B += o * de, V += o * ge, j += o * pe, W += o * ue, oe += o * ce, k += o * ne, ie += o * ye, Q += o * me, re += o * ae, L += o * Ee, P += o * Ie, I += o * Te, c += o * Pe, S += o * Ae, o = w[8], q += o * De, B += o * we, V += o * de, j += o * ge, W += o * pe, oe += o * ue, k += o * ce, ie += o * ne, Q += o * ye, re += o * me, L += o * ae, P += o * Ee, I += o * Ie, c += o * Te, S += o * Pe, G += o * Ae, o = w[9], B += o * De, V += o * we, j += o * de, W += o * ge, oe += o * pe, k += o * ue, ie += o * ce, Q += o * ne, re += o * ye, L += o * me, P += o * ae, I += o * Ee, c += o * Ie, S += o * Te, G += o * Pe, Z += o * Ae, o = w[10], V += o * De, j += o * we, W += o * de, oe += o * ge, k += o * pe, ie += o * ue, Q += o * ce, re += o * ne, L += o * ye, P += o * me, I += o * ae, c += o * Ee, S += o * Ie, G += o * Te, Z += o * Pe, be += o * Ae, o = w[11], j += o * De, W += o * we, oe += o * de, k += o * ge, ie += o * pe, Q += o * ue, re += o * ce, L += o * ne, P += o * ye, I += o * me, c += o * ae, S += o * Ee, G += o * Ie, Z += o * Te, be += o * Pe, ve += o * Ae, o = w[12], W += o * De, oe += o * we, k += o * de, ie += o * ge, Q += o * pe, re += o * ue, L += o * ce, P += o * ne, I += o * ye, c += o * me, S += o * ae, G += o * Ee, Z += o * Ie, be += o * Te, ve += o * Pe, he += o * Ae, o = w[13], oe += o * De, k += o * we, ie += o * de, Q += o * ge, re += o * pe, L += o * ue, P += o * ce, I += o * ne, c += o * ye, S += o * me, G += o * ae, Z += o * Ee, be += o * Ie, ve += o * Te, he += o * Pe, xe += o * Ae, o = w[14], k += o * De, ie += o * we, Q += o * de, re += o * ge, L += o * pe, P += o * ue, I += o * ce, c += o * ne, S += o * ye, G += o * me, Z += o * ae, be += o * Ee, ve += o * Ie, he += o * Te, xe += o * Pe, Be += o * Ae, o = w[15], ie += o * De, Q += o * we, re += o * de, L += o * ge, P += o * pe, I += o * ue, c += o * ce, S += o * ne, G += o * ye, Z += o * me, be += o * ae, ve += o * Ee, he += o * Ie, xe += o * Te, Be += o * Pe, Le += o * Ae, R += 38 * Q, N += 38 * re, F += 38 * L, K += 38 * P, Y += 38 * I, x += 38 * c, T += 38 * S, H += 38 * G, q += 38 * Z, B += 38 * be, V += 38 * ve, j += 38 * he, W += 38 * xe, oe += 38 * Be, k += 38 * Le, p = 1, o = R + p + 65535, p = Math.floor(o / 65536), R = o - p * 65536, o = N + p + 65535, p = Math.floor(o / 65536), N = o - p * 65536, o = F + p + 65535, p = Math.floor(o / 65536), F = o - p * 65536, o = K + p + 65535, p = Math.floor(o / 65536), K = o - p * 65536, o = Y + p + 65535, p = Math.floor(o / 65536), Y = o - p * 65536, o = x + p + 65535, p = Math.floor(o / 65536), x = o - p * 65536, o = T + p + 65535, p = Math.floor(o / 65536), T = o - p * 65536, o = H + p + 65535, p = Math.floor(o / 65536), H = o - p * 65536, o = q + p + 65535, p = Math.floor(o / 65536), q = o - p * 65536, o = B + p + 65535, p = Math.floor(o / 65536), B = o - p * 65536, o = V + p + 65535, p = Math.floor(o / 65536), V = o - p * 65536, o = j + p + 65535, p = Math.floor(o / 65536), j = o - p * 65536, o = W + p + 65535, p = Math.floor(o / 65536), W = o - p * 65536, o = oe + p + 65535, p = Math.floor(o / 65536), oe = o - p * 65536, o = k + p + 65535, p = Math.floor(o / 65536), k = o - p * 65536, o = ie + p + 65535, p = Math.floor(o / 65536), ie = o - p * 65536, R += p - 1 + 37 * (p - 1), p = 1, o = R + p + 65535, p = Math.floor(o / 65536), R = o - p * 65536, o = N + p + 65535, p = Math.floor(o / 65536), N = o - p * 65536, o = F + p + 65535, p = Math.floor(o / 65536), F = o - p * 65536, o = K + p + 65535, p = Math.floor(o / 65536), K = o - p * 65536, o = Y + p + 65535, p = Math.floor(o / 65536), Y = o - p * 65536, o = x + p + 65535, p = Math.floor(o / 65536), x = o - p * 65536, o = T + p + 65535, p = Math.floor(o / 65536), T = o - p * 65536, o = H + p + 65535, p = Math.floor(o / 65536), H = o - p * 65536, o = q + p + 65535, p = Math.floor(o / 65536), q = o - p * 65536, o = B + p + 65535, p = Math.floor(o / 65536), B = o - p * 65536, o = V + p + 65535, p = Math.floor(o / 65536), V = o - p * 65536, o = j + p + 65535, p = Math.floor(o / 65536), j = o - p * 65536, o = W + p + 65535, p = Math.floor(o / 65536), W = o - p * 65536, o = oe + p + 65535, p = Math.floor(o / 65536), oe = o - p * 65536, o = k + p + 65535, p = Math.floor(o / 65536), k = o - p * 65536, o = ie + p + 65535, p = Math.floor(o / 65536), ie = o - p * 65536, R += p - 1 + 37 * (p - 1), g[0] = R, g[1] = N, g[2] = F, g[3] = K, g[4] = Y, g[5] = x, g[6] = T, g[7] = H, g[8] = q, g[9] = B, g[10] = V, g[11] = j, g[12] = W, g[13] = oe, g[14] = k, g[15] = ie;
  }
  function _(g, w) {
    v(g, w, w);
  }
  ...
  function A(g, w) {
    ...
    for (let q = 254; q >= 0; --q) {
      const B = h[q >>> 3] >>> (q & 7) & 1;
      a(p, R, B), a(N, F, B), d(K, p, N), b(p, p, N), d(N, R, F), b(R, R, F), _(F, K), _(Y, p), v(p, N, p), v(N, R, K), d(K, p, N), b(p, p, N), _(R, p), b(N, F, Y), v(p, N, s), d(p, p, F), v(N, N, p), v(p, F, Y), v(F, R, o), _(R, K), a(p, R, B), a(N, F, B);
    }
    for (let q = 0; q < 16; q++)
  ...
  function E(g) {
    const w = (0, t.randomBytes)(32, g), h = M(w);
    return (0, r.wipe)(w), h;
  }
  e.generateKeyPair = E;
  function O(g, w, h = !1) {
...
function wp() {
  ...
  function r() {
    ...
    for (let _ = 0; _ < b.length; _++) {
      const D = b[_], A = D.getAttribute("rel");
  ...
  function i(...b) {
    ...
    for (let _ = 0; _ < v.length; _++) {
      const D = v[_], A = ["itemprop", "property", "name"].map((U) => D.getAttribute(U)).filter((U) => U ? b.includes(U) : !1);
      if (A.length && A) {
...
(function(e) {
  ...
  function v(E) {
    return Array.isArray(E) ? E.sort() : typeof E == "object" ? v(Object.keys(E)).sort((O, g) => Number(O) - Number(g)).map((O) => E[O]) : E;
  }
  function _(E) {
    const O = E.indexOf("#");
  ...
  function M(E, O) {
    ...
    return O.sort === !1 ? w : (O.sort === !0 ? Object.keys(w).sort() : Object.keys(w).sort(O.sort)).reduce((h, o) => {
      const p = w[o];
      return p && typeof p == "object" && !Array.isArray(p) ? h[o] = v(p) : h[o] = p, h;
    }, /* @__PURE__ */ Object.create(null));
  }
  e.extract = A, e.parse = M, e.stringify = (E, O) => {
    if (!E)
      return "";
    O = Object.assign({
      encode: !0,
    ...
    const g = _(E.url).split("?")[0] || "", w = e.extract(E.url), h = e.parse(w, { sort: !1 }), o = Object.assign(h, E.query);
...
function Rp() {
  ...
  return { privateKey: xt(e.secretKey, Ot), publicKey: xt(e.publicKey, Ot) };
}
function cs() {
...
function Tp(e, t) {
  const r = Cs.sharedKey(Ct(e, Ot), Ct(t, Ot)), i = new Xd(pn.SHA256, r).expand(Ns);
  return xt(i, Ot);
}
function Pp(e) {
  const t = pn.hash(Ct(e, Ot));
  return xt(t, Ot);
}
function Hr(e) {
  const t = pn.hash(Ct(e, Ps));
  return xt(t, Ot);
}
function Np(e) {
  return Ct(`${e}`, eu);
...
function Ti(e) {
  return Number(xt(e, eu));
}
function Lp(e) {
  const t = Np(typeof e.type < "u" ? e.type : tu);
  if (Ti(t) === $r && typeof e.senderPublicKey > "u")
    throw new Error("Missing sender public key for type 1 envelope");
  const r = typeof e.senderPublicKey < "u" ? Ct(e.senderPublicKey, Ot) : void 0, i = typeof e.iv < "u" ? Ct(e.iv, Ot) : Qr.randomBytes(as), n = new Is.ChaCha20Poly1305(Ct(e.symKey, Ot)).seal(i, Ct(e.message, Ps));
  return Fp({ type: t, sealed: n, iv: i, senderPublicKey: r });
}
function Up(e) {
  const t = new Is.ChaCha20Poly1305(Ct(e.symKey, Ot)), { sealed: r, iv: i } = Zi(e.encoded), n = t.open(i, r);
  if (n === null)
...
function Fp(e) {
  if (Ti(e.type) === $r) {
    if (typeof e.senderPublicKey > "u")
      throw new Error("Missing sender public key for type 1 envelope");
    return xt(is([e.type, e.senderPublicKey, e.iv, e.sealed]), os);
  }
  return xt(is([e.type, e.iv, e.sealed]), os);
}
function Zi(e) {
  const t = Ct(e, os), r = t.slice(Cp, aa), i = aa;
  if (Ti(r) === $r) {
...
function $p(e, t) {
  const r = Zi(e);
  return ru({ type: Ti(r.type), senderPublicKey: typeof r.senderPublicKey < "u" ? xt(r.senderPublicKey, Ot) : void 0, receiverPublicKey: t == null ? void 0 : t.receiverPublicKey });
}
function ru(e) {
...
(function(e, t) {
  ...
  Ue.prototype.clear = m, Ue.prototype.delete = $, Ue.prototype.get = J, Ue.prototype.has = se, Ue.prototype.set = Ce;
  function Se(y) {
    var C = -1, z = y == null ? 0 : y.length;
    for (this.clear(); ++C < z; ) {
      var ee = y[C];
  ...
  function ni(y) {
    return y == null ? y === void 0 ? R : M : lt && lt in Object(y) ? ol(y) : hl(y);
  }
  function to(y) {
    return si(y) && ni(y) == a;
  }
  ...
  function el(y, C, z, ee, je, fe) {
    ...
    if (!(z & n)) {
      var jt = Pt && ae.call(y, "__wrapped__"), Bt = kt && ae.call(C, "__wrapped__");
      if (jt || Bt) {
        var pr = jt ? y.value() : y, or = Bt ? C.value() : C;
  ...
  function io(y, C, z, ee, je, fe) {
    ...
    for (fe.set(y, C), fe.set(C, y); ++Pt < ot; ) {
      var jt = y[Pt], Bt = C[Pt];
      if (ee)
        var pr = Ye ? ee(Bt, jt, Pt, C, y, fe) : ee(jt, Bt, Pt, y, C, fe);
      if (pr !== void 0) {
        if (pr)
          continue;
        kt = !1;
      ...
      if (yt) {
        if (!xe(C, function(or, Er) {
          if (!De(yt, Er) && (jt === or || je(jt, or, z, ee, fe)))
            return yt.push(Er);
        })) {
          kt = !1;
          break;
        }
      } else if (!(jt === Bt || je(jt, Bt, z, ee, fe))) {
        kt = !1;
        break;
      }
    }
  ...
  function sl(y, C, z, ee, je, fe) {
    ...
    if (Bt && !pr) {
      ...
      ji != Bi && "constructor" in y && "constructor" in C && !(typeof ji == "function" && ji instanceof ji && typeof Bi == "function" && Bi instanceof Bi) && (Bt = !1);
    }
    return fe.delete(y), fe.delete(C), Bt;
  }
  function no(y) {
    return Qu(y, yl, al);
  }
  ...
  (ze && dr(new ze(new ArrayBuffer(1))) != K || $e && dr(new $e()) != A || We && dr(We.resolve()) != O || Ve && dr(new Ve()) != h || ke && dr(new ke()) != N) && (dr = function(y) {
  ...
  var dl = to(function() {
    ...
    return si(y) && ae.call(y, "callee") && !$t.call(y, "callee");
  }, Mi = Array.isArray;
  function pl(y) {
...
class a1 {
  constructor(t, r, i) {
    this.core = t, this.logger = r, this.name = U0, this.initialized = !1, this.init = async () => {
      ...
      const s = Zi(n);
      return s.senderPublicKey ? xt(s.senderPublicKey, Ot) : void 0;
...
class u1 extends Vf {
  constructor(t, r) {
    super(t, r), this.relayer = t, this.logger = r, this.events = new Xt.EventEmitter(), this.name = V0, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = te.toMiliseconds(te.TEN_SECONDS), this.queueTimeout = te.toMiliseconds(te.FIVE_SECONDS), this.needsTransportRestart = !1, this.publish = async (i, n, s) => {
      ...
      try {
        const u = (s == null ? void 0 : s.ttl) || z0, a = us(s), l = (s == null ? void 0 : s.prompt) || !1, f = (s == null ? void 0 : s.tag) || 0, d = (s == null ? void 0 : s.id) || js().toString(), b = { topic: i, message: n, opts: { ttl: u, relay: a, prompt: l, tag: f, id: d } }, v = setTimeout(() => this.queue.set(d, b), this.queueTimeout);
        try {
          await await Qi(this.rpcPublish(i, n, u, a, l, f, d), this.publishTimeout), clearTimeout(v), this.relayer.events.emit(Je.publish, b);
        } catch {
  ...
  rpcPublish(t, r, i, n, s, u, a) {
    var l, f, d, b;
    const v = { method: Hi(n.protocol).publish, params: { topic: t, message: r, ttl: i, prompt: s, tag: u }, id: a };
    return Dt((l = v.params) == null ? void 0 : l.prompt) && ((f = v.params) == null || delete f.prompt), Dt((d = v.params) == null ? void 0 : d.tag) && ((b = v.params) == null || delete b.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: v }), this.relayer.request(v);
  }
  onPublish(t) {
    this.queue.delete(t);
  }
...
var z1 = Object.defineProperty, V1 = Object.defineProperties, q1 = Object.getOwnPropertyDescriptors, qa = Object.getOwnPropertySymbols, K1 = Object.prototype.hasOwnProperty, W1 = Object.prototype.propertyIsEnumerable, Ka = (e, t, r) => t in e ? z1(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, zt = (e, t) => {
  for (var r in t || (t = {}))
...
class k1 extends Yf {
  constructor(t) {
    super(t), this.name = M1, this.events = new wc(), this.initialized = !1, this.ignoredPayloadTypes = [$r], this.init = async () => {
      ...
      this.isInitialized();
      const i = $n(zt({}, r), { requiredNamespaces: r.requiredNamespaces || {}, optionalNamespaces: r.optionalNamespaces || {} });
      ...
      const v = await this.client.core.crypto.generateKeyPair(), _ = zt({ requiredNamespaces: s, optionalNamespaces: u, relays: l ?? [{ protocol: Iu }], proposer: { publicKey: v, metadata: this.client.metadata } }, a && { sessionProperties: a }), { reject: D, resolve: A, done: U } = Kr(te.FIVE_MINUTES, F1);
      if (this.events.once(nt("session_connect"), async ({ error: O, session: g }) => {
        if (O)
          D(O);
        else if (g) {
          g.self.publicKey = v;
          const w = $n(zt({}, g), { requiredNamespaces: g.requiredNamespaces, optionalNamespaces: g.optionalNamespaces });
          await this.client.session.set(g.topic, w), await this.setExpiry(g.topic, g.expiry), f && await this.client.core.pairing.updateMetadata({ topic: f, metadata: g.peer.metadata }), A(w);
        }
      }), !f) {
        const { message: O } = X("NO_MATCHING_KEY", `connect() pairing topic: ${f}`);
        throw new Error(O);
      }
      const M = await this.sendRequest(f, "wc_sessionPropose", _), E = Ht(te.FIVE_MINUTES);
      return await this.setProposal(M, zt({ id: M, expiry: E }, _)), { uri: d, approval: U };
      ...
      const v = await this.client.core.crypto.generateKeyPair(), _ = f.publicKey, D = await this.client.core.crypto.generateSharedKey(v, _);
      l && i && (await this.client.core.pairing.updateMetadata({ topic: l, metadata: f.metadata }), await this.sendResult(i, l, { relay: { protocol: n ?? "irn" }, responderPublicKey: v }), await this.client.proposal.delete(i, ct("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: l }));
      const A = zt({ relay: { protocol: n ?? "irn" }, namespaces: s, requiredNamespaces: d, optionalNamespaces: b, pairingTopic: l, controller: { publicKey: v, metadata: this.client.metadata }, expiry: Ht(Ki) }, u && { sessionProperties: u });
      await this.client.core.relayer.subscribe(D), await this.sendRequest(D, "wc_sessionSettle", A);
      const U = $n(zt({}, A), { topic: D, pairingTopic: l, acknowledged: !1, self: A.controller, peer: { publicKey: f.publicKey, metadata: f.metadata }, controller: v });
      return await this.client.session.set(D, U), await this.setExpiry(D, Ht(Ki)), { topic: D, acknowledged: () => new Promise((M) => setTimeout(() => M(this.client.session.get(D)), 500)) };
    }, this.reject = async (r) => {
      ...
      this.events.once(nt("session_request", a), ({ error: v, result: _ }) => {
        v ? d(v) : f(_);
      ...
      try {
        ...
        const { relay: u, controller: a, expiry: l, namespaces: f, requiredNamespaces: d, optionalNamespaces: b, sessionProperties: v, pairingTopic: _ } = i.params, D = zt({ topic: r, relay: u, expiry: l, namespaces: f, acknowledged: !0, pairingTopic: _, requiredNamespaces: d, optionalNamespaces: b, controller: a.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: a.publicKey, metadata: a.metadata } }, v && { sessionProperties: v });
      ...
      const { id: n, params: s } = i;
      try {
        this.isValidRequest(zt({ topic: r }, s)), await this.setPendingSessionRequest({ id: n, topic: r, params: s });
...
}, rn = (e, t, r, i) => (Ws(e, t, "write to private field"), i ? i.call(e, r) : t.set(e, r), r), mt = (e, t, r) => (Ws(e, t, "access private method"), r), Tr, Wr, _i, At, hs, Lu, _t, Et, ds, Ha;
let nb = class {
  constructor(t) {
    Cr(this, hs), Cr(this, _t), Cr(this, ds), Cr(this, Tr, void 0), Cr(this, Wr, void 0), Cr(this, _i, void 0), Cr(this, At, void 0), rn(this, Tr, t), rn(this, Wr, mt(this, hs, Lu).call(this)), mt(this, _t, Et).call(this);
  }
  async connect(t) {
    const {
  ...
  async disconnect(t) {
    await mt(this, _t, Et).call(this), await st(this, At).disconnect(t);
  }
  async request(t) {
    return await mt(this, _t, Et).call(this), await st(this, At).request(t);
  }
  async getSessions() {
    return await mt(this, _t, Et).call(this), st(this, At).session.getAll();
  }
  async getSession() {
    return await mt(this, _t, Et).call(this), st(this, At).session.getAll().at(-1);
  }
  async onSessionEvent(t) {
    await mt(this, _t, Et).call(this), st(this, At).on("session_event", t);
  }
  async offSessionEvent(t) {
    await mt(this, _t, Et).call(this);
  }
  async onSessionUpdate(t) {
    await mt(this, _t, Et).call(this), st(this, At).on("session_update", t);
  }
  async offSessionUpdate(t) {
    await mt(this, _t, Et).call(this);
  }
  async onSessionDelete(t) {
    await mt(this, _t, Et).call(this), st(this, At).on("session_delete", t);
  }
  async offSessionDelete(t) {
    await mt(this, _t, Et).call(this);
  }
  async onSessionExpire(t) {
    await mt(this, _t, Et).call(this), st(this, At).on("session_expire", t);
  }
  async offSessionExpire(t) {
    await mt(this, _t, Et).call(this);
  }
};
Tr = /* @__PURE__ */ new WeakMap(), Wr = /* @__PURE__ */ new WeakMap(), _i = /* @__PURE__ */ new WeakMap(), At = /* @__PURE__ */ new WeakMap(), hs = /* @__PURE__ */ new WeakSet(), Lu = function() {
  const {
    modalOptions: e,
    projectId: t
  } = st(this, Tr);
  ...
  return st(this, At) ? !0 : (!st(this, _i) && typeof window < "u" && rn(this, _i, mt(this, ds, Ha).call(this)), st(this, _i));
}, ds = /* @__PURE__ */ new WeakSet(), Ha = async function() {
  rn(this, At, await J1.init({
    metadata: st(this, Tr).metadata,
    projectId: st(this, Tr).projectId,
    relayUrl: st(this, Tr).relayUrl
  }));
  const e = await st(this, At).core.crypto.getClientId();
  try {
...
const cb = ml(ab);
function Fu() {
  const [e, t] = qt(void 0), [r, i] = qt(void 0), [n, s] = qt(!1);
  return {
    data: e,
    error: r,
    loading: n,
...
const mb = [
  ...
  "aleo_executeProgram",
  "aleo_getRecords"
], Hs = ["aleo:1"], ps = ["chainChanged", "accountsChanged", "balanceChanged", "recordsChanged"], _b = "2133b10d21f9fcf851eb9ef8f057acea", Ja = "https://walletconnect.puzzle.online/", wb = {
  ...
  const r = /* @__PURE__ */ new Set(), i = (l, f) => {
    ...
    if (!Object.is(d, t)) {
      const b = t;
      t = f ?? typeof d != "object" ? d : Object.assign({}, t, d), r.forEach((v) => v(t, b));
    }
...
function Sb() {
  ...
  function a(b, v) {
    var _ = v(), D = i({ inst: { value: _, getSnapshot: v } }), A = D[0].inst, U = D[1];
    return s(function() {
      A.value = _, A.getSnapshot = v, l(A) && U({ inst: A });
    }, [b, _, v]), n(function() {
      return l(A) && U({ inst: A }), b(function() {
        l(A) && U({ inst: A });
      });
    }, [b]), u(_), _;
  }
...
function Db() {
  return Qa || (Qa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function v(O, g, w) {
      ...
      return l(function() {
        R.value = h, R.getSnapshot = g, _(R) && N({
          inst: R
        });
      }, [O, h, g]), a(function() {
        _(R) && N({
    ...
    var A = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", U = !A, M = U ? D : v, E = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : M;
...
function Ob() {
  ...
  return Mn.useSyncExternalStoreWithSelector = function(f, d, b, v, _) {
    var D = s(null);
    if (D.current === null) {
    ...
    D = a(function() {
      function M(h) {
        if (!E) {
          if (E = !0, O = h, h = v(h), _ !== void 0 && A.hasValue) {
            var o = A.value;
            if (_(o, h))
              return g = o;
          }
        ...
        if (o = g, i(O, h))
          return o;
        var p = v(h);
        return _ !== void 0 && _(o, p) ? o : (O = h, g = p);
      }
...
function xb() {
  return rc || (rc = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var i = typeof Object.is == "function" ? Object.is : r, n = t.useSyncExternalStore, s = e.useRef, u = e.useEffect, a = e.useMemo, l = e.useDebugValue;
    function f(d, b, v, _, D) {
      var A = s(null), U;
      A.current === null ? (U = {
        hasValue: !1,
        value: null
      }, A.current = U) : U = A.current;
      var M = a(function() {
        ...
        }, R = v === void 0 ? null : v, N = function() {
          return p(b());
        }, F = R === null ? void 0 : function() {
          return p(R());
        };
        return [N, F];
      }, [b, v, _, D]), E = M[0], O = M[1], g = n(d, E, O);
      return u(function() {
...
function qn(e, t) {
  ...
  return t.h.g || sr("ES5").S(t, e, i), i ? (r[Lt].P && (nn(t), dt(4)), Nr(e) && (e = sn(t, e), t.l || on(t, e)), t.u && sr("Patches").M(r[Lt].t, e, t.u, t.s)) : e = sn(t, r, []), nn(t), t.u && t.v(t.u, t.s), e !== Vu ? e : void 0;
}
function sn(e, t, r) {
  if (Zs(t))
    return t;
...
function ms(e, t, r) {
  var i = Gs(t) ? sr("MapSet").F(t, r) : Ys(t) ? sr("MapSet").T(t, r) : e.g ? function(n, s) {
    ...
    u && (l = [a], f = Ei);
    var d = Proxy.revocable(l, f), b = d.revoke, v = d.proxy;
...
var uc, Jr, Qs = typeof Symbol < "u" && typeof Symbol("x") == "symbol", $b = typeof Map < "u", Mb = typeof Set < "u", lc = typeof Proxy < "u" && Proxy.revocable !== void 0 && typeof Reflect < "u", Vu = Qs ? Symbol.for("immer-nothing") : ((uc = {})["immer-nothing"] = !0, uc), fc = Qs ? Symbol.for("immer-draftable") : "__$immer_draftable", Lt = Qs ? Symbol.for("immer-state") : "__$immer_state", jb = { 0: "Illegal state", 1: "Immer drafts cannot have computed properties", 2: "This object has been frozen and should not be mutated", 3: function(e) {
  ...
  if (!e.P) {
    var n = Kn(Rr(e), t), s = n == null ? void 0 : n[Lt];
    if (s && s.t === r)
    ...
    this.g = lc, this.D = !0, this.produce = function(n, s, u) {
      if (typeof n == "function" && typeof s != "function") {
        ...
        return function(A) {
          var U = this;
          A === void 0 && (A = a);
          for (var M = arguments.length, E = Array(M > 1 ? M - 1 : 0), O = 1; O < M; O++)
            E[O - 1] = arguments[O];
          return l.produce(A, function(g) {
            var w;
      ...
      if (typeof s != "function" && dt(6), u !== void 0 && typeof u != "function" && dt(7), Nr(n)) {
        var d = sc(i), b = ms(i, n, void 0), v = !0;
        try {
          f = s(b), v = !1;
        } finally {
          v ? nn(d) : bs(d);
        }
        return typeof Promise < "u" && f instanceof Promise ? f.then(function(A) {
          return Vn(d, u), qn(A, d);
        }, function(A) {
          throw nn(d), A;
        }) : (Vn(d, u), qn(f, d));
      }
      ...
      if (typeof n == "function")
        return function(f) {
          for (var d = arguments.length, b = Array(d > 1 ? d - 1 : 0), v = 1; v < d; v++)
            b[v - 1] = arguments[v];
...
const Wb = (e) => (t, r, i) => (i.setState = (n, s, ...u) => {
  ...
  const e = Mr(), [t, r, i, n] = jr((b) => [
    ...
    b.chainId,
    b.setAccount
  ]), [s, u] = qt(void 0), { request: a, data: l, error: f, loading: d } = ri({
  ...
  return ks(({ params: b }) => {
    if (b.event.name === "accountsChanged") {
      const _ = b.event.data[0], D = b.chainId.split(":")[0], A = b.chainId.split(":")[1];
      n({
        network: D,
        chainId: A,
        address: _
  ...
  const e = Mr(), [t] = jr((v) => [
    v.chainId
  ]), [r, i] = qt(0), [n, s] = qt(!1), [u, a] = qt(void 0), { request: l, data: f, error: d, loading: b } = ri({
    topic: e == null ? void 0 : e.topic,
    chainId: t ?? "aleo:1",
    request: {
      id: 1,
  ...
  return ks(({ id: v, params: _, topic: D }) => {
    if (_.event.name === "balanceChanged") {
      const U = Number(_.event.data);
      i(U), a(void 0), s(!1);
    }
  }), Rt(() => {
    e && (l(), s(!0));
    ...
    if (d)
      ...
      const v = f && f.type === "GET_BALANCE_RES" ? f : void 0, _ = f && f.type === "GET_BALANCE_REJ" ? f.data.error : void 0, D = (v == null ? void 0 : v.data.balance) ?? 0;
      i(D), a(_), s(!1);
    }
  }, [f, d]), { loading: n, balance: r, error: u };
}, mv = () => {
  const { connect: e, data: t, error: r, loading: i } = ub({
    requiredNamespaces: {
      aleo: {
        methods: ju,
        chains: Hs,
  ...
  }), u = n ? n.message : i && i.type === "EXECUTE_REJ" ? i.data.error : void 0, a = i && i.type === "EXECUTE_RES" ? i : void 0, l = a == null ? void 0 : a.data.transactionId;
  return { execute: () => {
    e && (r(), console.log("sent execute request"));
  }, transactionId: l, error: u, loading: s };
}, Ev = () => {
  const [e, t] = qt({
    loading: !0
  });
  ...
  const e = Mr(), [t] = jr((v) => [
    v.chainId
  ]), [r, i] = qt([]), [n, s] = qt(void 0), [u, a] = qt(!1), { request: l, data: f, error: d, loading: b } = ri({
    topic: e == null ? void 0 : e.topic,
    chainId: t ?? "aleo:1",
    request: {
      id: 1,
  ...
  return ks(({ id: v, params: _, topic: D }) => {
    ...
    if (d)
      ...
      const v = f, _ = v.type === "GET_RECORDS_REJ" ? v.data.error : void 0, D = v.type === "GET_RECORDS_RES" ? v.data.records : [];
      i(D), s(_), a(!1);
    }
  }, [f, d]), { records: r, error: n, loading: u };
}, Dv = (e) => {
  const t = Mr(), [r] = jr((a) => [
    a.chainId
  ]), { request: i, data: n, error: s, loading: u } = ri({
