...
const Fu = "@puzzlehq/sdk", Mu = "Puzzle SDK", $u = "0.1.29", ju = "Your portal to privacy", qu = "./dist/puzzle.umd.js", zu = "./dist/puzzle.es.js", Bu = "./dist/types/src/index.d.ts", Ku = {
  ".": {
...
let El = class {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-5c566140.js");
