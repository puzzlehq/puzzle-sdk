...
let Yl = class {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-8943bc75.js");
...
const ev = (e) => (t, r, i) => (i.setState = (n, s, ...u) => {
  ...
  return gt(() => {
    ...
    if (b)
      ...
      const O = h && h.type === "GET_BALANCE_RES" ? h : void 0, x = h && h.type === "GET_BALANCE_REJ" ? h.data.error : void 0, C = (O == null ? void 0 : O.data.balance) ?? 0;
      n(C), l(x), u(!1);
    }
  }, [h, b]), gt(() => {
    r === void 0 && n(0);
